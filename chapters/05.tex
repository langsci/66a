...
\z
Pichi has the three lexical ordinal numerals fɔ́s ‘first’ \REF{ex:key:253}, sɛkɔ́n/sɛ́kɔn ‘second’ \REF{ex:key:254}, and lás ‘last’ \REF{ex:key:255}. The first two occur as attributive prenominal modifiers like other property items, while lás ‘last’ preferably occurs in quantifier compounds {\fff}: 
...
When ɔ́l appears immediately before the noun, it is most often found to modify generic noun{\fff}s like tín ‘thing’, tɛ́n ‘time’, pɔ́sin ‘person’, mán ‘human being’, plés ‘place’, sáy ‘side; place’, and stáyl ‘manner’, as in the two following sentences (cf. \sectref{sec:5.4.3}. for a complete listing):
...
The relative or partitive{\fff} quantifiers sɔn ‘some’, bɔkú ‘much’, plɛ́nte ‘plenty’, and smɔ́l ‘few; a bit’ may quantify over count and mass nouns alike. NPs featuring one of these forms may be compared to an implicit standard of comparison as are smɔ́l ‘few; a bit’ in \REF{ex:key:273} and sɔn ‘some’ in \REF{ex:key:274}: 
...
Likewise, only independent personal pronouns occur under focus in cleft constructions {\fff}involving the focus markers na ‘foc’ \REF{ex:key:281}, and nóto ‘neg.foc’. The example also shows the use of independent pronouns (i.e. dɛ́n ‘3pl.indp’) as regular object pronouns (save the clitic =an for 3sg.obj):
