...
\ea%166
    \label{ex:key:166}
    \gll Mék    e    bít    yú,    mék    e    dú  yú    di  \textstylePichiexamplebold{dú} e    wánt,  mék    e    hála,  (...)\\
...
\ea%167
    \label{ex:key:167}
    \gll Porque  a    bin  pás  na  \textstylePichiexamplebold{Camerún}    fɔ́s.\\
...
\ea%168
    \label{ex:key:168}
    \gll Na  di  \textstylePichiexamplebold{sén}    \textstylePichiexamplebold{Jorge}  wé    a    sabí    nɔ́?\\
\textsc{foc}\textstylePichiexamplenumberZchnZchn{} \textsc{def} \textstylePichiexamplenumberZchnZchn{  same} \textsc{name}\textstylePichiexamplenumberZchnZchn{} \textsc{sub}    \textsc{1sg.sbj} \textstylePichiexamplenumberZchnZchn{  know}  \textstylePichiexamplenumberZchnZchn{right}\\

\glt ‘It is the same Jorge that I know, right?’ [nn07fn 227]
\z

The definite article di is employed in contexts, in which a noun is specific, identifiable, and familiar to discourse participants either through its presence in the immediate physical surrounding (e.g. maíz ‘maize’) \REF{ex:key:169}, or through situational inference (e.g. mɔ́nin mɔ́nin tɛ́n ‘early in the morning’) \REF{ex:key:170}:


\ea%169
    \label{ex:key:169}
    \gll Yu  ték    di  \textstylePichiexamplebold{maíz}  yu  hól=an.\\
...
The associative use of the article is exemplified in \REF{ex:key:171}. The referent \textit{leche} ‘milk’ has been established earlier on in discourse. The Spanish noun \textit{a}\textit{nimal} ‘animal’ is therefore definite by association with the antecedent \textit{leche}:


\ea%171
    \label{ex:key:171}
    \gll Es  que,    e    fáyn    wé  yu  nó  sabí    sé 
\textstylePichiexamplebold{e}    kɔmɔ́t    fɔ  \textstylePichiexamplebold{di} \textstylePichiexamplebold{animal}.\\
...
\ea%173
    \label{ex:key:173}
    \gll Yu  nó  fít,  porque  yu  mamá  nó  go  hébul    pé  \textstylePichiexamplebold{ɔ́l}
\textstylePichiexamplebold{di}  \textstylePichiexamplebold{wók}    \textstylePichiexamplebold{wé}  dán  mán    dɔ́n  dú  fɔ  yú\\
...
\ea%175
    \label{ex:key:175}
    \gll A    wánt  mék    yu  dú  mí    \textstylePichiexamplebold{sɔn} \textstylePichiexamplebold{    fébɔ},
...
\ea%176
    \label{ex:key:176}
    \gll Na  sé,    na  layk  sé    di  mán  de  mék    yú    \textstylePichiexamplebold{wán} \textstylePichiexamplebold{   fébɔ}.\\
...
\ea%177
    \label{ex:key:177}
    \gll Yu  sabí    sé    \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{motó}  fɔ  wán  mún    na  cincuenta  dólar,
...
\ea%178
    \label{ex:key:178}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{ɔnkúl}  \textstylePichiexamplebold{directo},  fɔ  mi    mamá  in    papá
in    fámbul  pát.\\
...
\ea%179
    \label{ex:key:179}
    \gll E    dé    complicado,  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{tín}    \textstylePichiexamplebold{dat}.\\
...
\ea%180
    \label{ex:key:180}
    \gll \'{A}fta    wi  kán  mít    layk    \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{seis}    \textstylePichiexamplebold{años}  después.\\
then  \textsc{1pl}  real  meet  like    one    six    year.\textsc{pl}  afterwards\\

\glt ‘Then we met again some six years later.’ [fr03ft 191]
\z

With\textit{} plural count nouns, indefiniteness is signalled through the presence of \textit{sɔn} alone \REF{ex:key:181} or the absence of a definiteness expression altogether (cf. \sectref{sec:5.1.4}). Mass nouns may only be modified by \textit{sɔn} for indefiniteness, or they occur devoid of any determiner \REF{ex:key:182}: 
...
\ea%182
    \label{ex:key:182}
    \gll \textstylePichiexamplebold{Blɔ́d}  de  kɔmɔ́t    na  in    nós,    e    de  kɔmɔ́t
na  in    mɔ́t.\\
...
Furthermore, \textit{wán}, but not \textit{sɔn}, may occur with \textsc{NPs} that are within the scope of negation, even if only with an emphatic meaning \REF{ex:key:183}. In the absence of emphasis, \textsc{NPs} do not usually appear with a marker of indefiniteness in negative clauses \REF{ex:key:184} (cf. \sectref{sec:7.2.2} for details): 


\ea%183
    \label{ex:key:183}
    \gll Sóté    a    \textstylePichiexamplebold{nó}  tɔ́k  \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{wɔ́d}.\\
...
In both \REF{ex:key:185} and \REF{ex:key:186}, \textit{wán} and \textit{sɔn} refer to a preceding \textsc{NP} \textit{televisión} ‘TV set’. When referring to a plural noun, \textit{sɔn} may optionally be followed by the pluraliser \textit{dɛn} ‘\textsc{pl}’ \REF{ex:key:187}: \is{anaphora}
...
\ea%188
    \label{ex:key:188}
    \gll \textstylePichiexamplebold{Sɔn}   in    sísta    (...)\\
...
\ea%191
    \label{ex:key:191}
    \gll Wán    dé  \textstylePichiexamplebold{sɔn} \textstylePichiexamplebold{   pɔ́sin}  bin  kán    sé,    e    de
tɔ́k  sé    yu  dɔ́n  gí  wán    golpe  \textstylePichiexamplebold{sɔn} \textstylePichiexamplebold{    sáy}.\\
...
\ea%193
    \label{ex:key:193}
    \gll ɔ́l  \textstylePichiexamplebold{dán}  pikín  \textstylePichiexamplebold{dɛn}  na  dán  mán    in    yón.\\
...
\ea%196
    \label{ex:key:196}
    \gll \textstylePichiexamplebold{Dís}  nóto  Manolete.\\
...
\ea%197
    \label{ex:key:197}
    \gll \textstylePichiexamplebold{Dát} nó  go  dú  ó!\\
that  \textsc{neg}  \textsc{pot}  do  \textsc{sp}\\

\glt ‘That really won’t do.’ [nn07fn 216]
\z

\textit{Dís} and \textit{dat}, but never \textit{dí} and \textit{dá}\textit{\textup{/}}\textit{dán}, also occur in sentence-final position in a presentative construction of the type presented in \REF{ex:key:198} and \REF{ex:key:199}, where the demonstratives are anaphoric to an antecedent focused \textsc{NP} (cf. \sectref{sec:7.4.4})\textsc{:} \is{anaphora}


\ea%198
    \label{ex:key:198}
    \gll Sé    \textstylePichiexamplebold{na} ín    \textstylePichiexamplebold{dís},  \textstylePichiexamplebold{na} yu  húman  \textstylePichiexamplebold{dís},  yu  wánt
ɔ  yu  nó  wánt,  \textstylePichiexamplebold{na} in    \textstylePichiexamplebold{dís}. \\
...
\ea%199
    \label{ex:key:199}
    \gll \textstylePichiexamplebold{Na} in    vida    \textstylePichiexamplebold{dát}.\\
...
\ea%200
    \label{ex:key:200}
    \gll Lúk=an,    di  dé  wé  \textstylePichiexamplebold{dís} \textstylePichiexamplebold{ Paquita}  in    papá
...
\textstylePichiexamplebold{prima}  ó,  Cristina.\\
...
\textstylePichiexamplebold{dé,}    yu  fít  ték    medio  fɔ  dán    sén    glas  (...)\\
...
\textstylePichiexamplebold{dán}    \textstylePichiexamplebold{motó}\textstylePichiexamplespaceZchn{} \textstylePichiexamplebold{dé}.\\
...
The demonstrative pronouns also serve to express discourse-pragmatic deixis. I reiterate example \REF{ex:key:202} above in \REF{ex:key:206} below in context. In the excerpt, speaker (dj) explains how to cook corn porridge. The interjection ɛhɛ́ ‘exactly’ confirms the interruptive question posed in \REF{ex:key:206a}. The topical dán wán dé in (b) is therefore anaphoric to the process explained just beforehand in the same sentence. 


The anaphoric function of the distal demonstrative pronoun is frequently made use of in order to refer to preceding \textsc{NPs}, phrases, and entire sentences. \textit{Dán sén glás} ‘that very glass’ represents \REF{ex:key:202} an additional means of referent tracking via the use of the focus and emphasis\is{emphasis} marker \textit{sén} ‘same; very’: \is{anaphora}
...
\ex{
\gll Ɛhɛ́,    wán    glas    watá  aparte,  yu  pút=an    ínsay,  \textstylePichiexamplebold{dán}  \textstylePichiexamplebold{wán}
  \textstylePichiexamplebold{dé}    yu  fít  ték    medio  fɔ  dán  sén    glas  (...)\\
...
\ea%207
    \label{ex:key:207}
    \gll Yu  nó  fít  jɔ́s  trowé    di  tín  \textstylePichiexamplebold{  dɛn}  na  strít    só.\\
...
\textsc{NPs} featuring a cardinal numeral \is{cardinal numerals}can also optionally be marked for plural number \REF{ex:key:211}, although in the majority of instances, speakers prefer not to use the pluraliser together with a numeral \REF{ex:key:212}: 
...
\ea%213
    \label{ex:key:213}
    \gll Yu  wánt  báy  cuaderno,    bolí  \textstylePichiexamplebold{ɔ́l}  \textstylePichiexamplebold{dán}  \textstylePichiexamplebold{tín}    \textstylePichiexamplebold{dɛn}
na  wet    dólar.\\
...
\ea%214
    \label{ex:key:214}
    \gll \textstylePichiexamplebold{Bɔkú}  \textstylePichiexamplebold{ motó} \textstylePichiexamplebold{  dɛn} dé    yá    só,    (...)\\
...
\ea%217
    \label{ex:key:217}
    \gll ɔ́l  Ghána  \textstylePichiexamplebold{bɔ́y-s}  \textstylePichiexamplebold{dɛn},    wé  dɛn  dé  (...)\\
...
\ea%218
    \label{ex:key:218}
    \gll \MakeUppercase{A}   dɔ́n    explica  \textstylePichiexamplebold{Boyé}  \textstylePichiexamplebold{dɛn},    sé    na  só
...
\ea%219
    \label{ex:key:219}
    \gll \textstylePichiexamplebold{Di}  \textstylePichiexamplebold{húman}  wé  \textstylePichiexamplebold{dɛn}  fáyn    mɔ́    na  {América Latina}
húman  dɛn.\\
...
\ea%222
    \label{ex:key:222}
    \gll Na  \textstylePichiexamplebold{mán}  in    suerte.\\
...
\ea%224
 \label{ex:key:224}
 \gll  \textstylePichiexamplebold{Chɔ́p}  dé    na  hós,    \textstylePichiexamplebold{pamáyn}   dé     (…)\\
...
\ea%225
    \label{ex:key:225}
    \gll Yu  fɔ  trowé  di  \textstylePichiexamplebold{watá}  yá    só.\\
...
\ea%226
    \label{ex:key:226}
    \gll \textstylePichiexamplebold{Brís}  de  bló.\\
air  \textsc{ipfv}  blow\\
...
\ea%227
    \label{ex:key:227}
    \gll \textstylePichiexamplebold{Mán}  \textstylePichiexamplebold{dɛn}  nó  de  bísin  fɔ  mék    fám    mɔ́.\\
...
Example \REF{ex:key:229} illustrates how generic meaning arises through the interplay of \textsc{NP} marking (the bare NP \textit{tidé pikín} ‘children of today’), impersonal use of \textsc{2sg}, and the habitual\is{habitual aspect} reading of the potential modality marker \textit{go}: 
...
Bare nouns are also encountered in many idiomatic verb-object collocations involving count nouns such as mék fám ‘to farm’, gɛ́t bɛlɛ́ ‘to be pregnant’, or fála húman ‘to womanise’. Such noun phrases are also characterised by genericity by virtue of their non-specific reference. They equally reflect a general tendency to omit indefiniteness and number marking with non-specific objects[FFF9?] \REF{ex:key:230}: [FFF9?]


\ea%230
    \label{ex:key:230}
    \gll \MakeUppercase{A}   ralla    ín    \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{rallador}.\\
...
\ea%232
    \label{ex:key:232}
    \gll Yu  pút  \textstylePichiexamplebold{ɔ́da}    \textstylePichiexamplebold{nyú}    wán    ínsay,  dán    wán    sé
mék    e    nó  smɛ́l.\\
...
Secondly, the following more “basic” semantic types of property items have the strongest likelihood of occurring as prenominal modifiers to head nouns: dimension (e.g. bíg ‘(be) big’ in \REF{ex:key:231} and smɔ́l ‘(be) small), age (e.g. ól ‘(be) old’, cf. \REF{ex:key:232}), value (e.g. bád ‘(be) bad’, bɛ́ta ‘(be) very good’, fáyn ‘(be) fine; beautiful’, trú ‘(be) true’, and (s)trɔ́n ‘be strong; profound (cf. \REF{ex:key:233}), colour (e.g. blák ‘(be) black’, wáyt ‘(be) white’, and rɛ́d ‘(be) red’):
...
\ea%234
    \label{ex:key:234}
    \gll Dán  \textstylePichiexamplebold{wáyt}  tín    wé  e    dé    na  in    yáy.\\
...
\ea%235
    \label{ex:key:235}
    \gll Na  wán    \textstylePichiexamplebold{mán} wé  e    \textstylePichiexamplebold{lɔ́s}.\\
...
\ea%236
    \label{ex:key:236}
    \gll Wán    dé  {wán  dé}  dís  húman  go  tɔ́n  \textstylePichiexamplebold{kres-húman}.\\
...
\ea%237
    \label{ex:key:237}
    \gll Wán    \textstylePichiexamplebold{glás}    \textstylePichiexamplebold{watá}.\\
one    glass  water\\
...
\ea%238
    \label{ex:key:238}
    \gll Pero    chico  na  yu  pikín  \textstylePichiexamplebold{in}    láyf.\\
...
\ea%239
    \label{ex:key:239}
    \gll (...)  wáyt  pípul  \textstylePichiexamplebold{dɛn}  wáyf.\\
...
\ea[*]{%240
    \label{ex:key:240}
    \gll Na  \textstylePichiexamplebold{yú}    \textstylePichiexamplebold{in}    hós.\\
  \textsc{foc}  \textsc{2sg.indp}  \textsc{3sg.poss}  house\\
\glt *It’s your house. [ne07fn 231]
}
\z
...
\ea%241
    \label{ex:key:241}
    \gll Na  dé    a    kán  sabí    \textbf{mi}    mamá  \textstylePichiexamplebold{in}    papá
\textstylePichiexamplebold{in}    fámbul. \\
...
\ea%242
    \label{ex:key:242}
    \gll \'{A}fta    Miguel  Ángel  wé  na  di  lás  pikín  \textstylePichiexamplebold{fɔ} mi    antí.\\
...
\ea%245
    \label{ex:key:245}
    \gll Dán  casa    verde,  dán  casa    \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{madera}  (...)\\
that  house  green  that  house  \textsc{prep}  wood\\

\glt ‘That green house, that wooden house (...)’ [hi03cb 037]
\z

The \textit{fɔ}{}-construction is also used to express part–whole relations in the idiomatic expression \textit{pát fɔ} ‘part of’ \REF{ex:key:246} or a partitive\is{partitive} construction involving the determiner \textit{sɔn} ‘some’ \REF{ex:key:247}: 


\ea%246
    \label{ex:key:246}
    \gll Gɔ́bna    de  gí  yu  \textstylePichiexamplebold{pát}  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{mɔní}.\\
...
\ea%247
    \label{ex:key:247}
    \gll \textstylePichiexamplebold{Sɔn}    \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{watá}  dé    yét.\\
...
\ea%248
    \label{ex:key:248}
    \gll \'{A}fta    Miguel  Ángel  wé  na  di  \textstylePichiexamplebold{lás}  \textstylePichiexamplebold{pikín}  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{mi}    \textstylePichiexamplebold{antí}.\\
then  \textsc{name}  \textsc{name}  \textsc{sub}  \textsc{foc}  \textsc{def}  last  child  \textsc{prep}  \textsc{1sg.poss}  aunt\\

\glt ‘Then, there is Miguel Ángel who is the last child of my aunt.’ \textstylePichiexamplenumberZchnZchn{[fr03ft 143]}
\z

A second factor that contributes to the use of the \textit{fɔ}{}-construction is animacy. The resumptive pronoun\is{resumptive pronouns} in the dislocated possessive construction is typically coreferential with an animate, usually human possessor. Therefore, an inanimate possessor is best expressed through the \textit{fɔ}{}-construction: \is{animacy}


\ea%249
    \label{ex:key:249}
    \gll Na  wán  prensa  internacional    \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{ministro}  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{Gabón}
...
\ea%251
    \label{ex:key:251}
    \gll Ɛf  yu  de  ték  \textstylePichiexamplebold{trí},    treinta  mil.\\
...
\z
Pichi has the three lexical ordinal numerals fɔ́s ‘first’ \REF{ex:key:253}, sɛkɔ́n/sɛ́kɔn ‘second’ \REF{ex:key:254}, and lás ‘last’ \REF{ex:key:255}. The first two occur as attributive prenominal modifiers like other property items, while lás ‘last’ preferably occurs in quantifier compounds [FFF9?]: 


\ea%253
    \label{ex:key:253}
    \gll Na  di  \textstylePichiexamplebold{fɔ́s}  tín  (…)\\
...
\ea%254
    \label{ex:key:254}
    \gll E    gó  blánt  wet    di  \textstylePichiexamplebold{sɛkɔ́n}  papá.\\
...
\ea%255
    \label{ex:key:255}
    \gll Mí    na  di  \textstylePichiexamplebold{las-mán}\textstylePichiexamplebold{\textmd{.}}\\
...
The numeral wán has a number of functions that are derived from its cardinality sense. We have seen that it functions as an indefinite deteminer and a pronominal or nominal substitute (cf. \REF{ex:key:194}–\REF{ex:key:195}). The adverbialising suffix –wán ‘adv’ is also etymologically related to the cardinal numeral wán (cf. also \sectref{sec:5.2.1} and \sectref{sec:5.4.4}). The numeral wán also expresses adverbial meanings such as ‘alone; single-handedly’ with an emphatic[FFF9?] nuance, as in \REF{ex:key:257}. When used in this way, wán may modify a head noun post-nominally like a postnominal modifier, such as the focus particle sɛ́f ‘self; emp’. However, wán does not modify full nouns by itself. It rather appears after an independent (emphatic) personal pronoun that is coreferential with the full noun in question \REF{ex:key:258} (cf. also \REF{ex:key:289}–\REF{ex:key:290}):
...
\end{tabularx}
\end{table}
The quantifier \textit{ɔ́l} ‘all’\textit{} occurs with count and mass nouns alike. \textit{ɔ́l} is encountered in a pre- \REF{ex:key:259}, and postnominal position \REF{ex:key:260}, yet without any effect on its quantificational properties:


\ea%259
    \label{ex:key:259}
    \gll (...)  yu  de  bák      \textstylePichiexamplebold{ɔ́l  di  mɔní}  (...)\\
...
\ea%260
    \label{ex:key:260}
    \gll \textstylePichiexamplebold{Di} \textstylePichiexamplebold{  pikín} \textstylePichiexamplebold{  ɔ́l}  sé    na  mi    yón   bikɔs
a    dɔ́n  pé  mɔní.\\
...
When ɔ́l appears immediately before the noun, it is most often found to modify generic noun[FFF9?]s like tín ‘thing’, tɛ́n ‘time’, pɔ́sin ‘person’, mán ‘human being’, plés ‘place’, sáy ‘side; place’, and stáyl ‘manner’, as in the two following sentences (cf. \sectref{sec:5.4.3}. for a complete listing):
...
\ea%262
    \label{ex:key:262}
    \gll Porque  na  mí    mí    de  prepara  \textstylePichiexamplebold{ɔ́l  } \textstylePichiexamplebold{tín}.\\
...
Rather than seeing syntagmas like\textit{ ɔ́l mán} ‘everybody’ and \textit{ɔ́l tín} \textit{\textup{‘everything’} }above as belonging to a word class\is{word classes} termed “indefinite pronouns”, they are best seen as ordinary NPs involving a quantifer and a generic noun, which may function as equivalents of nominal and adverbial indefinite pronouns in other languages. This analysis is supported by the fact that the generic nouns involved retain their full distributional potential as ordinary nouns; there are no signs of specialisation or grammaticalisation (cf. \citealt{Haspelmath1994}:182–183).
...
\ea%264
    \label{ex:key:264}
    \gll ‘\textstylePichiexamplebold{ɔ́l}  \textstylePichiexamplebold{tidé}    e    bin  de  kɔ́l  mí’,    e    kɔ́l  mí
wán    tɛ́n    dásɔl.\\
...
\ea%265
    \label{ex:key:265}
    \gll \textstylePichiexamplebold{ɔ́l} \textstylePichiexamplebold{  hía}    pák  polvo.\\
all  here    pack  dust\\
...
\ea%267
    ...
    \gll Di  \textstylePichiexamplebold{ónli} \textstylePichiexamplebold{   lángwech}  wé  dɛn  de  tɔ́k  fáyn    fáyn,  (…).\\
...
\glt   ‘The only language that they speak really well (…).’ [au07se 265]
    ...
    \gll \textstylePichiexamplebold{\'{O}nli}    dɛn  wánt  hía    Panyá.\\
...
\ea%268
    ...
    \gll A    bin  bríng  wán  bláy  só,    \textstylePichiexamplebold{sósó    } \textstylePichiexamplebold{jakató}.\\
...
\ea%269
    \label{ex:key:269}
    \gll \textstylePichiexamplebold{Dásɔl} \textstylePichiexamplebold{ wán}     \textstylePichiexamplebold{smɔ́l},  wán    glas,    yu  fúlɔp=an.\\
...
The quantifier ɛ́ni ‘every’ quantifies over sets. It therefore has a distributive meaning and can only occur with singular count nouns \REF{ex:key:271}:
...
The quantifier grén ‘only; exactly’ (< grén ‘grain’) only occurs in fixed collocations as a measure word with a preceding cardinal numeral, and followed by a count noun. Like ɛ́ni ‘every’, grén therefore quantifies over sets. The resulting quantifier compound[FFF9?] functions as an attributive quantifier to the following noun pikín:


\ea%272
    \label{ex:key:272}
    \gll Na  yu  \textstylePichiexamplebold{wan-grén} pikín.\\
\textsc{foc}  \textsc{2sg}  one.\textsc{cpd}{}-grain  child\\

\glt ‘That’s your one and only [single] child.’ [ge07fn 015]
\z

The relative or partitive[FFF9?] quantifiers sɔn ‘some’, bɔkú ‘much’, plɛ́nte ‘plenty’, and smɔ́l ‘few; a bit’ may quantify over count and mass nouns alike. NPs featuring one of these forms may be compared to an implicit standard of comparison as are smɔ́l ‘few; a bit’ in \REF{ex:key:273} and sɔn ‘some’ in \REF{ex:key:274}: 


\ea%273
    \label{ex:key:273}
    \gll \MakeUppercase{A}   kin  wánt  kɔ́f    dɛn  de  trowé  \textstylePichiexamplebold{smɔ́l} \textstylePichiexamplebold{ mélk},
...
\ea%274
    \label{ex:key:274}
    \gll \textstylePichiexamplebold{Sɔn} \textstylePichiexamplebold{   fés}  dɛn  dé    wé  a    sabí    nɔ́.\\
...
\ea%276
    \label{ex:key:276}
    \gll \textstylePichiexamplebold{Nó}  nátín  \textstylePichiexamplebold{nó}  dé    pantáp=an.\\
\textsc{neg}  nothing  \textsc{neg}  \textsc{be.loc}  on=\textsc{3sg.obj}\\

\glt ‘Nothing is on it [the table].’ [li07pe 011]
\z

Some of the quantifiers covered can function as pronominals, as exemplified with \textit{ɔ́l}\textit{\textsuperscript{} }\textit{\textup{‘all’} }in \REF{ex:key:277} (cf. \tabref{tab:key:5.5} for a complete overview). However, a quantifier phrase featuring a generic noun (e.g. \textit{ɔ́l tín} ‘all thing’ = ‘everything’) is usually preferred: 
...
Four features are distinguished in the use of personal pronouns: person, number, syntactic (in)dependence, and case (cf. \tabref{tab:key:5.6} below). The majority of “dependent pronouns” (with the exception of \textit{mi} ‘\textsc{1sg.poss}’ and \textit{in} ‘\textsc{3sg.poss}’) employed for subject case are also used for the expression of possessive case. Where the “possessive” column has no entry, the corresponding “subject” form is used. At the same time, the “object” column is separated from the other dependent pronouns by a line, because none of the forms in the “subject” and “possessive”\is{possessive pronouns} columns are simultaneously employed as object pronouns. 


At the same time, there is an overlap in forms for the expression of object case. The “object” and “object \& emphatic” columns are not separated by a line, beause all forms in the latter column are employed as object pronouns and emphatic pronouns at the same time. However, the \textsc{3sg} pronouns \textit{=an} and \textit{ín} are suppletive allomorphs. The choice of either of the two forms is phonologically conditioned (cf. \sectref{sec:3.2.5}). One of these forms, i.e. the clitic =an ‘\textsc{3sg.obj’,} is the only dependent object pronoun of Pichi\is{dependent object pronoun}. \is{cliticisation}
...
\end{tabularx}
\end{table}
Dependent subject pronouns always occur in finite clauses together with verbs. They may only be separated from the verb by TMA markers, the negator, and preverbal adverbs. Only independent\is{independent pronouns} personal pronouns \is{emphatic pronouns}may be focused \REF{ex:key:278}, topicalised, modified by postposed elements, and conjoined by the coordinators \textit{àn} ‘and’ or \textit{ɔ̀} ‘or’ \REF{ex:key:279}:
...
ɔ  di  pikín  \textstylePichiexamplebold{ɔ} \textstylePichiexamplebold{ ín}    sénwe,  e    kán  rɔ́n.\\
...
Likewise, only independent personal pronouns occur under focus in cleft constructions [FFF9?]involving the focus markers na ‘foc’ \REF{ex:key:281}, and nóto ‘neg.foc’. The example also shows the use of independent pronouns (i.e. dɛ́n ‘3pl.indp’) as regular object pronouns (save the clitic =an for 3sg.obj):
...
\ea%282
    \label{ex:key:282}
    \gll Lɛk  náw    só,    \textstylePichiexamplebold{mí} \textstylePichiexamplebold{\textmd{[}}\textstylePichiexamplebold{wé} a    nó  máred,
ɛf  a    bɔ́n      pikín]?\\
...
\ea%283
    \label{ex:key:283}
    \gll \textstylePichiexamplebold{Yú},    kán    yá!\\
...
\ea%284
    \label{ex:key:284}
    \gll Dɛn  tíf    \textstylePichiexamplebold{mí}    ordenador.\\
\textsc{3pl}  steal  \textsc{1sg.indp}  computer\\

\glt ‘They stole a computer from me.’ [ge07fn 169]
\z

Conversely, \REF{ex:key:285} is a single object construction. The low-toned ponoun \textit{mi} is a possessive pronoun to the noun \textit{ordenador} ‘computer’ which functions as a patient \textsc{NP} to the verb \textit{tíf} ‘steal’:


\ea%285
    \label{ex:key:285}
    \gll Dɛn  tíf    \textstylePichiexamplebold{mi}    ordenador.\\
\textsc{3pl}  steal  \textsc{1sg.poss}  computer\\

\glt ‘They stole my computer.’ [ge07fn 170]
\z

The form =an ‘\textsc{3sg.obj}’ is exclusively employed to express object case. It functions as a pronominal object to verbs, prepositions, and locative nouns\is{locative nouns}. It is a clitic that forms a single phonological word with the immediately preceding verb, preposition or locative noun\is{cliticisation}. The pronoun \textit{=an} is sometimes employed indiscriminately for singular or plural reference. In such cases, it may be considered to function as a kind of transitivity or verbal agreement marker. In \REF{ex:key:286}, \textit{=an} is coreferential with the plural-referring pronominal \textit{ɔ́l}: 
...
\ea%287
    \label{ex:key:287}
    \gll Pero    \textstylePichiexamplebold{dís}  \textstylePichiexamplebold{ una} baf-rúm.\\
...
dɔ́n  sí  \textstylePichiexamplebold{yu} \textstylePichiexamplebold{ yón}.\\
...
\ea%289
    \label{ex:key:289}
    \gll Ɛf  yu  bin  dé    \textstylePichiexamplebold{yú} \textstylePichiexamplebold{   wán}   yu  nó  bin  fɔ    tɔ́k  só.\\
...
\ea%291
    \label{ex:key:291}
    \gll Na  \textstylePichiexamplebold{ín} \textstylePichiexamplebold{   dásɔl}  dán  húman  dɔ́n  de  wók    fɔ.\\
...
Sentence \REF{ex:key:292} provides an example of modification by a noun. The country name \textit{Camerún} ‘Cameroon’ modifies the personal pronoun \textit{una} ‘2\textsc{pl}’ by apposition. The modifier noun does not take the pluraliser\is{pluraliser} \textit{dɛn} ‘\textsc{pl}’:
...
\ea%294
    \label{ex:key:294}
    \gll Dɛn  go  reúne,  \textstylePichiexamplebold{dɛn-tú}      \textstylePichiexamplebold{dɛn}  go  kɔ́l  di  bɔ́y  (...)\\
...
\ea%295
    \label{ex:key:295}
    \gll Yu  sí,  \textstylePichiexamplebold{dɛn}{}-\textbf{ɔl}{}-\textstylePichiexamplebold{tú}     júmp  fɔ  bɔ́t    di  bɔ́l.\\
...
\ea%296
    \label{ex:key:296}
    \gll Lɛk  sé    dɛn  de    hía    \textstylePichiexamplebold{wi-ɔl-tú}    \textstylePichiexamplebold{wi}  de  tɔ́k  yét.\\
...
In Pichi, the functional equivalents of indefinite pronouns are phrases involving generic nouns preceded by the quantifier[FFF9?] and indefinite determiner sɔn ‘some; a’ as well as the quantifier[FFF9?]s ɔ́l ‘all’, ɛ́ni ‘every’, and nó ‘neg’. The following table provides an overview of ‘some’ and ‘every’ indefinites involving the generic nouns pɔ́sin ‘person’, mán ‘man; person’, tín ‘thing’, sáy ‘side; place’, (káyn) stáyl ‘(kind of) style’, tɛ́n ‘time’, and áwa ‘hour; time’. Some examples for their use are provided in \REF{ex:key:190}–\REF{ex:key:191} above as well as \REF{ex:key:261}–\REF{ex:key:263} above. 


An extensive treatment of ‘no’ and ‘any’ forms, hence negative phrases with the functions of negative indefinites is provided in \sectref{sec:7.2.3}:\is{generic nouns}
...
A few characteristics of the NPs in \tabref{tab:key:5.8} are worthy of note. Firstly, Pichi makes no difference between “some” indefinites used in affirmative and realis modality declarative sentences and “free-choice” indefinites (\citealt{Haspelmath1997}:48–52) of the “any” type.
...
The pronominals sɛ́f ‘self’, yón ‘own’, [FFF9?]and nátin‘nothing’ occur in the syntactic positions of nouns. At the same time, they are characterised by a preference for specific environments or show distributional restrictions. The anaphoric pronominals sɛ́f ‘self’ and yón ‘own’ are employed to form independent reflexive[FFF9?] and possessive pronouns and do not co-occur with determiners either. Instead, they are usually preceded by possessive pronouns. The negative indefinite pronoun nátin‘nothing’ only occurs in negative clauses. 


There is a transition from these more specialised pronominals characterised by restrictions to pronominals like káyn ‘kind’ and wán ‘one’, which favour specific environments, to generic nouns like mán ‘man; person’, sáy ‘place’, stáyl ‘manner’, and tɛ́n ‘time’, which behave like other common nouns but fulfil important functions in the grammatical system of Pichi. For example, káyn ‘kind’ and wán ‘one’ may co-occur with a determiner or a prenominal modifier. Káyn appears as a head noun in question words and as a generic noun[FFF9?] in the modifier or modified position of certain conventionalised collocations (e.g. na wán káyn tín ‘foc one kind thing’ = ‘that’s really something’). 
