...
\ea%514
    \label{ex:key:514}
    \gll A    sé    ‘nó  gí=an    \textstylePichiexamplebold{leche},  gí=an    \textstylePichiexamplebold{wɔtá’}.\\
...
\ea%515
    \label{ex:key:515}
    \gll Di  chía    blák,  di  \textstylePichiexamplebold{chía},  \textstylePichiexamplebold{e}    blák.\\
\textsc{def}  chair  be.black  \textsc{def}  chair  \textsc{3sg.sbj}  be.black\\

\glt ‘The chair is black, the chair (it) is black.’ [dj05ae 121]
\z

Pronoun resumption is also found with objects[FFF9?]. The following two examples illustrate the use of pronominal copying with fronted and topical object NPs. In \REF{ex:key:516}, the full NP dán mán ‘that man’ and in \REF{ex:key:517} the emphatic 3pl pronoun dɛ́n are set off from the rest of the clause by an intonation break and resumed by object pronouns: 
...
An indication that subject pronoun copying may also involve a topic–comment structure comes from examples such as \REF{ex:key:518}. This sentence features the independent, emphatic personal pronoun dɛ́n at the beginning of the clause, followed by a coreferential dependent pronoun:
...
\ea%519
    \label{ex:key:519}
    \gll \textstylePichiexamplebold{Mí}    dɔ́n  sɔ́fa.\\
...
\ea%520
    \label{ex:key:520}
    \gll A    dɔ́n  de  gládin  \textstylePichiexamplebold{sé    a    dɔ́n  gó}.\\
...
\ea%521
    \label{ex:key:521}
    \gll Di  bɔ́ks    e    \textstylePichiexamplebold{tú}  \textstylePichiexamplebold{évi}.\\
...
\ea%522
    \label{ex:key:522}
    \gll \textsc{D}i  strít    \textstylePichiexamplebold{tú}  \textstylePichiexamplebold{dé}    wɔwɔ́.\\
...
\ea%523
    \label{ex:key:523}
    \gll Djunais  dɔ́n  dríng  \textstylePichiexamplebold{smɔ́l}.\\
...
\ea%524
    \label{ex:key:524}
    \gll Mí    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{di} chíf    nɔ́.\\
\textsc{1sg.indp}  \textsc{foc}  \textsc{def}  chief  \textsc{intj}\\

\glt ‘I’m\textstylePichiglossZchn{ the boss, right.}’ [dj05ce 176]
\z


\ea%525
    \label{ex:key:525}
    \gll \textstylePichiexamplebold{Nóto}  mecánico.\\
\textsc{neg}.\textsc{foc}  mechanic\\

\glt ‘(He’s) not a mecanic.’ [dj0502e1 214]
\z

Predicate adjective clauses constitute the second type of copula clause. A small set of property-denoting verbs may also function as predicate adjectives and appear as complements \is{complements}to the locative-existential copula \textit{dé} \textsc{‘be.loc’} \textsc{\REF{ex:key:526}}. Unlike other property items, these adjectives may therefore appear in the same syntactic position as adverbials in this type of copula clause \textsc{\REF{ex:key:527}}: 


\ea%526
    \label{ex:key:526}
    \gll Tidé    di  húman  \textstylePichiexamplebold{dé}   \textstylePichiexamplebold{fáyn}.\\
...
\ea%527
    \label{ex:key:527}
    \gll E    \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{na} \textstylePichiexamplebold{grɔ́n}.\\
...
\ea%528
    \label{ex:key:528}
    \gll Nó  \textstylePichiexamplebold{láf}!\\
\textsc{neg}  laugh\\
...
\ea%529
    \label{ex:key:529}
    \gll \textstylePichiexamplebold{Una}    \textstylePichiexamplebold{púl} di  torí!\\
...
\ea%530
    \label{ex:key:530}
    \gll \textstylePichiexamplebold{Mék}   a    púl    wán    smɔ́l  torí?\\
...
\ea%533
    \label{ex:key:533}
    \gll Dɛn\textstylePichiexamplebold{  nó} de \textstylePichiexamplebold{  gí}    \textstylePichiexamplebold{nó}  nátín.\\
...
\ea%534
    \label{ex:key:534}
    \gll Láyf    \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{dé}    náw,  wɔ́l    \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{dé}.\\
...
Sentence \REF{ex:key:535} contains both an affirmative and a negative clause in the potential mood. The two subsequent examples present an affirmative clause marked for past tense\is{past tense} and its negative counterpart \REF{ex:key:537}:


\ea%535
    \label{ex:key:535}
    \gll Ho,  dán  mán    \textstylePichiexamplebold{go}  dú  vɔ́mit    tidé,    e    \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{go}  slíp.\\
...
\ea%536
    \label{ex:key:536}
    \gll E    \textstylePichiexamplebold{bin} dé  \textstylePichiexamplebold{} na  jél.\\
...
\ea%537
    \label{ex:key:537}
    \gll A    \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{bin} fít  ték    motó.\\
...
\ea%538
    \label{ex:key:538}
    \gll \textstylePichiexamplebold{Pás}    na  mákit  mɔ́!\\
...
The negation of the perfect tense-aspect is asymmetrical. While the affirmative features the marker dɔ́n ‘prf’ \REF{ex:key:541}, the negative perfect is formed with a suppletive allomorph, i.e. either of the free variants nɛ́a and nɔ́ba ‘neg.prf’ \REF{ex:key:542}: 


\ea%541
    \label{ex:key:541}
    \gll Yu  \textstylePichiexamplebold{dɔ́n}  bɔ́n      fo    pikín,  \textstylePichitranslationZchn{(...)}\\
...
\ea%544
    \label{ex:key:544}
    \gll E    \textstylePichiexamplebold{nó}  máred  \textstylePichiexamplebold{yét}?\\
\textsc{3sg.sbj}  \textsc{neg}  marry  yet\\

\glt ‘She isn’t married yet?’
\z

The two other combinations of verb negation and a clause-final adverbial are nó — mɔ́ ‘no more; not again’ and nó — sɛ́f ‘not even’. Compare the affirmative use of mɔ́ ‘more’ in \REF{ex:key:538} with \REF{ex:key:545} below. 


\ea%545
    \label{ex:key:545}
    \gll Dɛn  \textstylePichiexamplebold{nó}  go  fláy  na  Bata    \textstylePichiexamplebold{mɔ́}.\\
...
Examples \REF{ex:key:546} and \REF{ex:key:547} present the use of sɛ́f ‘self, emp’ in an affirmative and a negative clause, respectively. The negated clause acquires an emphatic negative meaning: 
...
Pragmatically neutral lexical nouns in subject position are not normally preceded by the general negator \textit{nó} ‘\textsc{neg}’ in negative clauses. The following example is a negative existential clause, in which the subject \textit{chɔ́p} ‘food’ is not preceded by the negator \textit{nó:}



\ea%548
    \label{ex:key:548}
    \gll Fíba    \textstylePichiexamplebold{nó}  sube    ín.\\
...
\ea%549
    \label{ex:key:549}
    \gll Mán    dɛn  \textstylePichiexamplebold{nó}  de  bísin  fɔ  mék    fám    mɔ́,
yu  gó  fɔ  mákit,  chɔ́p  \textstylePichiexamplebold{nó}  dé.\\
...
\ea%550
    \label{ex:key:550}
    \gll E    sé    bueno  ás  \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{dɔ́kta}  \textstylePichiexamplebold{nó}  de  kán    sí  \textstylePichitranslationZchn{(...)}\\
...
\ea%551
    \label{ex:key:551}
    \gll \textstylePichiexamplebold{Nó}  motó  \textstylePichiexamplebold{nó}  dé    wé  e    smát  lɛk  mi    yón.\\
...
Object NPs also only feature negative concord when emphasis is intended. Compare the non-emphatic negative clause in \REF{ex:key:552} with \REF{ex:key:553}, which features verb negation and negative concord. Also note the presence of the independent emphatic pronoun \textit{ín} ‘\textsc{3sg.indp}’:
...
\ea%554
    \label{ex:key:554}
    \gll Sóté    a    \textbf{nó}  tɔ́k  \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{wán}    wɔ́d.\\
until  \textsc{1sg.sbj}  \textsc{neg}  talk  \textsc{neg}  one    word\\

\glt ‘Until I didn’t say a single word (anymore).’ [ab03ay 088]
\z

Negative concord is also found in coordinate \textsc{NPs} featuring the negative coordinator pair \textit{ni — ni}, which is borrowed\is{borrowing} from Spanish \REF{ex:key:555}. Spanish employs no negative concord in this particular construction \REF{ex:key:556}: 


\ea%555
    \label{ex:key:555}
    \gll \textstylePichiexamplebold{Ni}  ín    \textstylePichiexamplebold{ni}  in    brɔ́da  dɛn  \textstylePichiexamplebold{nó}  lán.\\
...
\ea%556
    \label{ex:key:556}
    \gll \textstylePichiexamplebold{Ni}  él  \textstylePichiexamplebold{ni}  su  hermano    han    estudiado.\\
...
\ea%557
    \label{ex:key:557}
    \gll Mí    wánt  aks yú    \textstylePichiexamplebold{sɔn}    \textstylePichiexamplebold{tín}.\\
...
\ea[*]{%558
    \label{ex:key:558}
    \gll (\textbf{Nó})  \textstylePichiexamplebold{nátín}  \textstylePichiexamplebold{nó}  dé    dé.\\
...
\ea%561
    \label{ex:key:561}
    \gll Dís  sɔ́nde  *(\textbf{nó}) \textstylePichiexamplebold{  bɔ́di}   *(\textbf{nó})  dé    na  strít.\\
...
\ea%563
    \label{ex:key:563}
    \gll \textstylePichiexamplebold{Pɔ́sin}  go  entiende    bɔt  e    nó  dé    bien.\\
...
\ea%564
    \label{ex:key:564}
    \gll \textstylePichiexamplebold{ɔ́l}  \textstylePichiexamplebold{mán} kin  lúk=an,    yu  go  sí  wi  nó  go
mít    nó  bɔ́di    na  hós.\\
...
\ea%566
    \label{ex:key:566}
    \gll \MakeUppercase{A}   \textstylePichiexamplebold{nó}  de  gó  \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{sáy}.\\
...
\ea%567
    \label{ex:key:567}
    \gll \textstylePichiexamplebold{Sáy}  \textstylePichiexamplebold{nó}  dé.\\
...
\ea%568
    \label{ex:key:568}
    \gll \textstylePichiexamplebold{Sáy}  \textstylePichiexamplebold{nó}  dé    fɔ  wás    hán?\\
side  \textsc{neg}  \textsc{be.loc}  \textsc{prep}  wash  hand\\

\glt ‘Is there no place to wash (one’s) hands? [ra07fn 138]
\z

The adverbial concept ‘never’ is expressed via the phrase nó wán dé ‘neg one day’ \REF{ex:key:570}. Example \REF{ex:key:569} features the equivalent affirmative phrase ɔ́l tɛ́n ‘all time’ = ‘always’: 
...
\ea%570
    \label{ex:key:570}
    \gll E    sé    \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{wán}  \textstylePichiexamplebold{dé}  e    \textstylePichiexamplebold{nó}  go  dú=an    mɔ́.\\
...
\ea%571
    \label{ex:key:571}
    \gll Dán  banána,  a    gí=an    \textstylePichiexamplebold{sɔn}.\\
...
\textstylePichiexamplebold{nó}  teléfono,    \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{wán}.\\
...
\ea%575
    \label{ex:key:575}
    \gll \textstylePichiexamplebold{Nó}  tɔ́k  \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{wán}   wɔ́d!\\
...
\ea%576
    \label{ex:key:576}
    \gll \textstylePichiexamplebold{Nóto}  \textstylePichiexamplebold{ɔ́l}  \textstylePichiexamplebold{húman}  fít  máred.\\
...
\ea%578
    \label{ex:key:578}
    \gll \textstylePichiexamplebold{Nóto}  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{dán}    \textstylePichiexamplebold{tín}    yu  de  kráy?\\
\textsc{foc}    \textsc{prep}  that    thing  \textsc{2sg}  \textsc{ipfv}  cry\\

\glt ‘Is it not because of that that you are crying?’ [ne05fn 004]
\z

In \REF{ex:key:579}, speaker (hi) complains about the discrimination of women in wedlock, a condition she likens to slavery. In the example, speaker (hi) first negates the direct quote\textit{ e fíba} ‘it resembles’, the second \textit{nóto} negates the verbal constituent as such: 
...
\ea%580
    \label{ex:key:580}
    \gll Ɛf  \textstylePichiexamplebold{nóto}    \textstylePichiexamplebold{yu}  \textstylePichiexamplebold{bay},    dán  húman  go  bít  yú
...
Yes–no questions are characterised by the syntax of declarative clauses and do not involve obligatory question particles. Yes–no questions are therefore distinguished from declarative clauses by intonation (cf. \sectref{sec:3.4.5}):


\ea%582
    \label{ex:key:582}
    \gll Yu  wánt  de  \textstylePichiexamplebold{gó}?\\
...
\ea%584
    \label{ex:key:584}
\gll
Yu  sísta    stíl  \textstylePichiexamplebold{máred}  ɔ  e    nó  máred  \textstylePichiexamplebold{mɔ́}?\\
...
%%please move \begin{table} just above \begin{tabular
\begin{table}
\caption{Question element system\is{question words}}
\label{tab:key:7.4}
...
\ea%585
    \label{ex:key:585}
    \gll Yu  sí  \textstylePichiexamplebold{údat}  \textstylePichiexamplebold{dɛn}?\\
...
\ea%586
    \label{ex:key:586}
    \gll Yu  sí  \textstylePichiexamplebold{ús=pɔ́sin}    \textstylePichiexamplebold{dɛn}?\\
\textsc{2sg}  see  \textsc{q}=person    \textsc{pl}\\

\glt ‘Who [plural] did you see?’ [nn07fn 277]
\z

The pluralisation of ‘\textsc{who’} is likely to be a structural borrowing\is{borrowing} from Spanish, or is at least reinforced by the equivalent Spanish structure. Compare the equivalent Spanish question:


\ea%587
    \label{ex:key:587}
    \gll Quién-\textstylePichiexamplebold{es}    son?\\
...
\ea%588
    \label{ex:key:588}
    \gll Na  \textstylePichiexamplebold{údat}  \textstylePichiexamplebold{in}    \textstylePichiexamplebold{búk}    dís?\\
...
\ea%589
    \label{ex:key:589}
    \gll \textstylePichiexamplebold{\'{U}dat}  \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{wétin}  de  hambɔ́g  yú?\\
...
\ea%590
    \label{ex:key:590}
    \gll \textstylePichiexamplebold{\'{U}s=sáy}  \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{háw}    yu  de  wás?\\
\textsc{q}=side  with    how    \textsc{2sg}  \textsc{ipfv}  wash\\

\glt ‘Where and how are you washing?’ [dj05ce 182]
\z

Question elements may occur \textit{in} \textit{situ} in the original position of the questioned element, or they may be fronted. Questioned subjects naturally occur at the beginning of the clause as shown in \REF{ex:key:589}. They may also optionally be focused in cleft constructions \REF{ex:key:591}\is{cleft constructions}: 
...
Objects\is{objects} can be questioned \textit{in} \textit{situ} (e.g. \textit{údat dɛn} and \textit{ús=pɔ́sin dɛn} in \REF{ex:key:585} and \REF{ex:key:586} above) or be fronted \REF{ex:key:592}. Fronted objects may also optionally be cleft-focused \REF{ex:key:593}:
...
\ea%593
    \label{ex:key:593}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{ús=káyn}  \textstylePichiexamplebold{tín}    dɛn  \textstylePichiexamplebold{ték}    mék    dís,  digamos  dí  bɔ́tul?\\
...
\ea%594
    \label{ex:key:594}
    \gll \textstylePichiexamplebold{Wétin}  yu  wánt  sabí    \textstylePichiexamplebold{fɔ}?\\
...
\ea%596
    \label{ex:key:596}
    \gll \textstylePichiexamplebold{\'{U}s=béd}  yu  kin  slíp    \textstylePichiexamplebold{pan}?\\
\textsc{q}=bed  \textsc{2sg}  \textsc{hab}  sleep  on\\

\glt ‘Which bed do you usually sleep on?’ [ur07fn 238]
\z

All constituents that may be questioned in main clauses can also be replaced by question elements in subordinate clauses. Non-subject constituents of subordinate clauses can be questioned \textit{in} \textit{situ} \REF{ex:key:597} or be fronted \REF{ex:key:598}: 


\ea%597
    \label{ex:key:597}
    \gll Yu  tɔ́k  sé    Pancho  de  yús  \textstylePichiexamplebold{údat}  \textstylePichiexamplebold{in}    \textstylePichiexamplebold{motó}?\\
...
\ea%598
    \label{ex:key:598}
    \gll \textstylePichiexamplebold{\'{U}s=tín}  yu  tɔ́k  sé    yu  wánt  \textstylePichiexamplebold{sabí}?\\
...
\ea%599
    \label{ex:key:599}
    \gll A    go  púl=an      na  mi    yáy  \textstylePichiexamplebold{sé}    \textstylePichiexamplebold{wétin}?\\
...
\ea%600
    \label{ex:key:600}
    \gll \textstylePichiexamplebold{Wétin}  yu  wánt  \textstylePichiexamplebold{nó}?\\
...
\ea%601
    \label{ex:key:601}
    \gll Yu  wánt  \textstylePichiexamplebold{nó}    \textstylePichiexamplebold{wétin}?\\
\textsc{2sg}  want  know  what\\

\glt ‘You want to know what?’ [dj05ce 087]
\z

Example \REF{ex:key:602} illustrates the questioning of a complex object NP. The dislocated possessive construction[FFF9?] údat in motó ‘whose car’ is the object of yús ‘use’ and under focus with the focus particle na. The questioning of a possessor NP is also achieved by circumlocution with the verb gɛ́t ‘get; have’ \REF{ex:key:603}. 
...
\ea%602
    \label{ex:key:602}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{údat}  \textstylePichiexamplebold{in}    \textstylePichiexamplebold{motó}  Pancho  de  yús?\\
...
\ea%605
    \label{ex:key:605}
    \gll \textstylePichiexamplebold{\'{U}s=wán}  na  in    ném?\\
\textsc{q}=one  \textsc{foc}  \textsc{3sg.poss}  \textsc{name}\\

\glt ‘What’s his name?’ [ko03sp 061]
\z

A similar syntactic flexibility is characteristic of the objects of V2 minor (i.e. closed class) verbs in SVCs. The questioned object of pás ‘(sur)pass’ in the comparative SVC[FFF9?] in \REF{ex:key:606} and the object of kɛ́r ‘carry, take’ in the motion-direction SVC in \REF{ex:key:607} may be found in the original syntactic position:


\ea%606
    \label{ex:key:606}
    \gll E    bíg  \textstylePichiexamplebold{pás}    \textstylePichiexamplebold{údat}?\\
...
\ea%608
    \label{ex:key:608}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{údat}  dí  bɔ́y  bíg  \textstylePichiexamplebold{pás}?\\
...
At the same time, the questioning of the instrument\index{} or material\index{} objects of \textit{ték} ‘take’ in participant-introducing SVC\index{}\index{}s is characterised by some idiosyncracies. Firstly, speakers seem to prefer to front the questioned object rather than leave it in the original syntactic position between \textit{ték} ‘take’ and the following major verb (i.e. \textit{bíl} ‘build’ in the following example). Compare \REF{ex:key:610}:
...
\ea%611
    \label{ex:key:611}
    \gll Na  \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{ús=tín}  dɛn  ték  bíl    di  hós?\\
\textsc{foc}  with    \textsc{q}=thing  \textsc{3pl}  take  build  \textsc{def}  house\\

\glt ‘With what did they build the house?’ [dj07ae 479]
\z

However, fronting\is{fronting} of the patient object of the major (open class) verb in \textit{ték} SVCs is not accepted \REF{ex:key:612}. Patients are usually questioned \textit{in} \textit{situ} in their original syntactic position following the major verb \REF{ex:key:613}:


\ea[*]{%612
    \label{ex:key:612}
    \gll \'{U}s=káyn  hós    dɛn  ték  plɛ́nk  bíl?\\
  \textsc{q}=kind    house  \textsc{3pl}  take  board  build\\
\glt *Which (kind of) house did they take board to build? [dj07ae 482]
}\z


\ea%613
    \label{ex:key:613}
    \gll Dɛn  \textstylePichiexamplebold{ték}  stón    \textstylePichiexamplebold{bíl}   \textstylePichiexamplebold{ús=káyn}  \textstylePichiexamplebold{hós}?\\
...
\ea%614
    \label{ex:key:614}
    \gll \textstylePichiexamplebold{Wích}  \textstylePichiexamplebold{mán}  dɛn  bin  kíl  na  kwáta?\\
...
\ea%615
    \label{ex:key:615}
    \gll \textstylePichiexamplebold{\'{U}s=mán}  dɛn  kíl  na  kwáta?\\
\textsc{q}=man  \textsc{3pl}  kill  \textsc{loc}  quarter\\

\glt ‘Which man/who was killed in our quarter?’ [ro05de 048]
\z

One indication of the more functional status of ús= is its cliticisation in the first place (cf. \sectref{sec:2.6.3}). Secondly, in the majority of instances in the corpus, ús= combines with a limited number of generic nouns (e.g. pɔ́sin ‘person’, mán ‘man; person’, tín ‘thing’, sáy ‘side; place’, tɛ́n ‘time’) in order to form general, basic question words with meanings like who, what, where, and when. Yet, ús= is nevertheless also used with the meaning ‘which’ in order to form specific question words questioning modifiers as in the following two examples: 
...
\ea%617
    \label{ex:key:617}
    \gll \textstylePichiexamplebold{\'{U}s=nésɔn}?\\
which=nation\\
...
\gll
\textstylePichiexamplebold{\'{U}s=káyn}  súp?\\
  \textsc{q}=kind  soup\\
...
\ea%619
    \label{ex:key:619}
    \gll Sé    papá  Gɔ́d  \textstylePichiexamplebold{ús=káyn}  trɔ́bul  dís?\\
...
\ea%620
    \label{ex:key:620}
    \gll \'{A}fta    a    nó  sabí    \textstylePichiexamplebold{ús=káyn}  tín    kán  pás.\\
...
\ea%621
    \label{ex:key:621}
    \gll Yu  nó    wet    \textstylePichiexamplebold{ús=káyn}  tín    dɛn  mék    dís  tín?\\
...
\ea%623
    \label{ex:key:623}
    \gll \textstylePichiexamplebold{\'{U}s=dé}  yu  kán    yá?\\
...
\ea%624
    \label{ex:key:624}
    \gll \textstylePichiexamplebold{\'{U}s=mún}    yu  de  gó?\\
...
\ea%625
    \label{ex:key:625}
    \gll \textstylePichiexamplebold{\'{U}s=hía}  yu  bɔ́n?\\
\textsc{q}=year  \textsc{2sg}  be.born\\

\glt ‘When [in which year] were you born?’ [ro05ee 011]
\z

In the same vein, time units of the day are often questioned by the more specific bimorphemic question word ús=áwa ‘q=hour’ \REF{ex:key:626}, which may refer to units of the clock as well as periods of the day (e.g. mɔ́nin tɛ́n ‘morning’, sán tɛ́n ‘noon’, nɛ́t ‘night’):


\ea%626
    \label{ex:key:626}
    \gll \textstylePichiexamplebold{\'{U}s=áwa}  yu  rích?\\
...
\ea%627
    \label{ex:key:627}
    \gll \textstylePichiexamplebold{\'{U}s=sáy}  yu  kɔmɔ́t?\\
...
\ea%628
    \label{ex:key:628}
    \gll \textstylePichiexamplebold{\'{U}s=pát}  yu  kɔmɔ́t?\\
...
\ea%629
    \label{ex:key:629}
    \gll Na  \textstylePichiexamplebold{ús=káyn}  \textstylePichiexamplebold{stáyl}  yu  ték    kán    na  yá?\\
...
\ea%630
    \label{ex:key:630}
    \gll \textstylePichiexamplebold{\'{U}s=káyn} \textstylePichiexamplebold{stáyl} yu  rích    yá?\\
...
\ea%631
    \label{ex:key:631}
    \gll \textstylePichiexamplebold{Háw}  e    bin  só,    \textstylePichiexamplebold{háw}    e    bigín,
\textstylePichiexamplebold{háw}   e    salút  yú?\\
...
\ea%632
    \label{ex:key:632}
    \gll \textstylePichiexamplebold{Háw}  yu  sabí    sé    na  rubio?\\
...
\ea%633
    \label{ex:key:633}
    \gll \textstylePichiexamplebold{Háw}  \textstylePichiexamplebold{mɔ́ch}  dís  sɔ́t    \textstylePichiexamplebold{kɔ́s}?\\
...
\ea%634
    \label{ex:key:634}
    \gll \textstylePichiexamplebold{Háw}  \textstylePichiexamplebold{mɔ́ch}  \textstylePichiexamplebold{lɔ́n}?\\
how    much  be.long\\
...
\ea%635
    \label{ex:key:635}
    \gll \textstylePichiexamplebold{Háw}  \textstylePichiexamplebold{mɔ́ch}  dí  tín    \textstylePichiexamplebold{évi}?\\
...
\ea%636
    \label{ex:key:636}
    \gll Yu  bin  sté    \textstylePichiexamplebold{háw}    \textstylePichiexamplebold{mɔ́ch}  \textstylePichiexamplebold{dé}?\\
...
\ea%637
    \label{ex:key:637}
    \gll \textstylePichiexamplebold{Háw}  \textstylePichiexamplebold{mɔ́ch}  \textstylePichiexamplebold{wɔtá} yu  wánt?\\
...
\ea%638
    \label{ex:key:638}
    \gll \textstylePichiexamplebold{Háw}  \textstylePichiexamplebold{mɔ́ch}  \textstylePichiexamplebold{pikín}  de  gó  na  dán  skúl?\\
...
\ea%639
    \label{ex:key:639}
    \gll \textstylePichiexamplebold{Wétin}  yu  nó  de  wók    tidé?\\
...
Secondly, \textit{wétin} and \textit{ús=tín} ’what’ occur in pragmatically more neutral question phrases as the objects\is{objects} of prepositions that may mark NPs for a cause semantic role \is{}(cf. \sectref{sec:9.1.3} for details). In \REF{ex:key:642}, \textit{wétin} is the object of \textit{fɔ} \textsc{‘prep’} \textsc{(642}), in \textsc{\REF{ex:key:643},} \textit{wet} ‘with’ is followed by \textit{ús=tín} , and in \REF{ex:key:644}, the preposition \textit{fɔséka} ‘due to’ takes \textit{ús=tín} as its object. The resulting phrases all serve to question adverbials of cause. Note that these phrases can optionally appear under cleft-focus like any other question element: \index{cleft constructions}


\ea%642
    \label{ex:key:642}
    \gll \textstylePichiexamplebold{Fɔ}  \textstylePichiexamplebold{wétin}  yu  nó  de  wók    tidé?\\
\textsc{prep}\textstylePichitranslationZchn{} what\textstylePichitranslationZchn{} \textsc{2sg}\textstylePichitranslationZchn{} \textsc{neg}\textstylePichitranslationZchn{} \textsc{ipfv}\textstylePichitranslationZchn{  work  today}\\
...
\ea%643
    \label{ex:key:643}
    \gll Na  \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{ús=tín}  in    pikín  dáy,    ús=sík?\\
...
\ea%644
    \label{ex:key:644}
    \gll Na  \textstylePichiexamplebold{fɔséka}  \textstylePichiexamplebold{ús=tín  in}   pikín  dáy?\\
...
\ea%645
    \label{ex:key:645}
    \gll \textstylePichiexamplebold{Fɔséka}  in    pikín  dáy?\\
...
\ea%646
    \label{ex:key:646}
    \gll \textstylePichiexamplebold{Wétin}  \textstylePichiexamplebold{mék}    yu  nó  de  wók    tidé?\\
...
\ea%648
    \label{ex:key:648}
    \gll \textstylePichiexamplebold{Wétin}  \textstylePichiexamplebold{mék}    \textstylePichiexamplebold{sé}    yu  nó  wók    tidé?\\
...
\ea%649
    \label{ex:key:649}
    \gll \textstylePichiexamplebold{\'{U}s=tín}  \textstylePichiexamplebold{de}  \textstylePichiexamplebold{mék}    \textstylePichiexamplebold{sé}   \textstylePichiexamplebold{mék}    yu  nó  wók    tidé?\\
...
In Pichi, yɛ́(s) ‘yes’ is the central agreement interjection. Both yɛ́ and yɛ́s are employed in formal and informal registers alike. Compare the answer in \REF{ex:key:650}(b):
...
\gll
Náw    so,    yɛ́s,  a    fít  dríng=an    fáyn.\\
...
The elements nó and nɔ́ are used as free variants in order to signal disagreement. The former element is identical in form to the general negator nó. Many Pichi speakers agree or disagree with the polarity of the question. Hence agreement with the negative polarity of the question in \REF{ex:key:651} evokes the use of the agreement marker yɛ́s:
...
\ea{\label{ex:key:651a}
    \gll
So  yu  \textstylePichiexamplebold{nó}  go  chɔ́p?\\
...
\ea{
    \gll 
So  yu  \textstylePichiexamplebold{nó}  go  kán?\\
...
\gll
\textstylePichiexamplebold{Nó},  a    \textstylePichiexamplebold{nó}  go  kán.\\
...
\ea%654
    \label{ex:key:654}
    \gll Yu  de  fíl  hɔ́t  \textstylePichiexamplebold{nɔ́}?\\
...
Strong disagreement can be expressed by the focus construction \textit{nóto só} ‘\textsc{neg}.\textsc{foc} so’ = ‘that’s not how it is’. The following two sentences succeed each other in a narrative. The disagreement expressed in \REF{ex:key:656}(a) is underlined by sentence (b): 


\ea%656
    \label{ex:key:656}
\ea{
    \gll Dɛn  tɛ́l=an    sé    ‘nóto  só.’\\
  \textsc{3pl}  tell=\textsc{3sg.obj}  \textsc{quot}    \textsc{neg}.\textsc{foc}  like.that\\
...
Even stronger disagreement is expressed through the negative phrases \textit{nó wán dé} ‘never’ \REF{ex:key:657}(b) and \textit{nó wé} ‘no way’ \REF{ex:key:658}(b). The following two sentence pairs illustrate their use in signalling disagreement in response to a question:
...
\gll
\textstylePichiexamplebold{Nó}  \textstylePichiexamplebold{wán}  \textstylePichiexamplebold{dé},  nóto  mi.\\
...
\gll
\textstylePichiexamplebold{Nó}  \textstylePichiexamplebold{wé},  a    nó  go  kán.\\
...
Given the right pragmatic context, the question word\is{question words} \textit{ús=sáy} ‘\textsc{where’} may signal strong disagreement as well \REF{ex:key:659}(b). The imperative\is{imperatives} clause \textit{kɔmɔ́t dé} ‘get lost’ can be employed to express strong and abusive disagreement \REF{ex:key:660}(b):
...
\gll
\textstylePichiexamplebold{\'{U}s=sáy}?\\
  \textsc{q}=side\\
...
\gll
\textstylePichiexamplebold{Kɔmɔ́t}  \textstylePichiexamplebold{dé}!\\
  go.out  there\\
...
The answer to a content questions\is{content questions} may be given in full or truncated sentences consisting of the questioned constituent(s) as in \REF{ex:key:661}(b): 
...
The extensive use of focus structures in sentence formation is a distinctive mark of Pichi. Focus constructions have two principal pragmatic functions in the language. Firstly, they serve to present new information. For this function, I employ the term “presentational focus\is{presentational focus}” \citep{Drubig2003}. Secondly, focus constructions serve to assert previously introduced information that runs counter to the presupposition of an addressee. This function is here referred to as “contrastive focus\is{contrastive focus}” (\citealt{Chafe1976}:35ff.). Focus is realised through three distinct strategies: suprasegmental focus, particle focus, and cleft focus. The syntactic operation of clefting \textit{per} \textit{sé} renders elements under cleft focus prag. matically particularly salient. But it is difficult to determine the semantic differences between the other types of focus on the basis of the available data. Cleft focus may also be applied to verbs in so-called predicate cleft constructions (cf. \sectref{sec:7.4.5}). The language also employs various other means for emphasis\is{emphasis}, including presentatives (c.f \sectref{sec:7.4.4}).
...
Particle focus involves the elements sɛ́f ‘self; emp’, sénwe ‘emp’ and the sentence particles/interjections ɛ́n ‘intj’ and ó ‘sp’ (cf. \sectref{sec:12.2.4} for a detailed treatmen of these elements). These elements may signal focus of constituents of varying complexity including entire clauses and sentences. The following table provides an overview: [FFF9?]
...
The reflexive anaphor and emphatic particle sɛ́f ‘self; emp’ is the most frequently used form in particle focus. The following sentence presents the use of sɛ́f as a reflexive[FFF9?] anaphor (cf. \sectref{sec:9.3.5} for a detailed treatment): [FFF9?]
...
The two successively uttered sentences \REF{ex:key:663}(a) and (b) exemplify the use of sɛ́f ‘self; emp’ in signalling presentational focus[FFF9?]. In \REF{ex:key:663}(a), the speaker provides information on the topic dán mán ‘that man’. In (b), the same speaker fills in the information gap in combination with presentational focus of the entire sentence: 
...
The corpus contains a single occurrence of sɛ́f ‘self; emp’ preceded by a 3sg.poss pronoun which is coreferential with the head noun of the focused NP \REF{ex:key:664}. This structure is a dislocated possessive construction[FFF9?] in which sɛ́f functions as a nominal in the possessed noun position. In the construction, the low-toned 3sg possessive pronoun and sɛ́f together signal emphasis or focus of the preceding noun di bɔ́y ‘the boy’:
...
The construction in \REF{ex:key:664} is, however, marginal. Note the difference between \REF{ex:key:664} and the following \REF{ex:key:665}. In the latter example, sɛ́f ‘self; emp’ is used as a regular focus particle, postposed to the high-toned 3sg emphatic personal pronoun: 
...
Contrastive use of sɛ́f ‘self; emp’ is illustrated in \REF{ex:key:666}. In its function as a focus marker, sɛ́f often assumes a reading of inclusive or exhaustive listing; hence the translation of sɛ́f as ‘too; also; even’ and ‘alone; without help’. In fact, a postposed sɛ́f most appropriately renders the notion ‘too; also’ in a sentence like \REF{ex:key:667}. [FFF9?]


The following two examples also show that sɛ́f has the most flexible scope of all particles. It may signal focus of sentences \REF{ex:key:666} as well as smaller constituents, such as a personal pronoun \REF{ex:key:667}: 
...
The particle sénwe ‘emp’ is presumably a lexicalised collocation (i.e. sén.wé ‘same.way’). It is employed in the same way as sɛ́f in order to signal presentational and contrastive focus[FFF9?] \REF{ex:key:668}. The use of sénwe as a clausal focus particle is not attested. In general, sénwe occurs less frequently than sɛ́f and is found more often to focus personal pronouns than full nouns. Consider the following example, in which sénwe signals presentational focus of the personal pronoun yú ‘2sg.indp’: 


\ea%668
    \label{ex:key:668}
    \gll Dí  wán,  \textstylePichiexamplebold{yú}   \textstylePichiexamplebold{sénwe}  yu  de  gó.\\
...
\ea%669
    \label{ex:key:669}
    \gll Bata    tɔ́ng    \textstylePichiexamplebold{ó}.\\
...
\ea%670
    \label{ex:key:670}
    \gll \MakeUppercase{A}   bin  dɔ́n,    a    bin  dɔ́n    blánt  fɔ  Gabón  \textstylePichiexamplebold{ó}.\\
...
The interjection ɛ́n ‘intj’ is principally employed in sentence-final position as a channel-checking device in order to solicit the attention of an addressee (cf. also \sectref{sec:12.2.2}). Channel-checking automatically lends prominence to a preceding utterance, hence ɛ́n may function very much like other sentential focus particles \REF{ex:key:671}. 
...
Beyond that, ɛ́n may also occur in mid-sentence followed by a pause, in order to focus a single constituent. In \REF{ex:key:672}, the Spanish depictive adjective fresco ‘fresh’ is fronted and singled out for focus by ɛ́n:
...
Subordinate clauses may be focused by the same means as other, smaller sentence constituents. The relative clause[FFF9?] in \REF{ex:key:677} is under the scope of the particle sɛ́f ‘self; emp’. In \REF{ex:key:678}, the clause introduced by sé ‘quot’ is under focus by means of the sentence-final particle ó:
...
Example \REF{ex:key:680} presents clausal focus (or alternatively focus of the object NP dán ‘convence’ dé) through sɛ́f, as well as focus of the ensuing adverbial phrase na Píchi by means of sénwe: 
...
Personal pronouns can be focused through the use of the corresponding emphatic, independent form alone instead of resorting to sɛ́f or sénwe (cf. \REF{ex:key:667}–\REF{ex:key:668} above). Compare subject focus in the rhetorical question in \REF{ex:key:682}:


\ea%682
    \label{ex:key:682}
    \gll \textstylePichiexamplebold{Mí}    wánt  dán    mán?\\
\textsc{1sg.indp}  want  that    man\\

\glt ‘Do I [\textsc{emp}] want that man?’ [ro05rt 026]
\z

Clausal focus by means of sɛ́f is also regularly made use of in combination with the conditional clause linker ɛf/if in order to render concessive meaning (cf. \sectref{sec:10.7.12}).

\subsubsection{Word order and scope}

Focused constituents may appear in situ, i.e. in the same syntactic position assigned to them in focus-neutral clauses. When this is the case, focus is signalled by the presence of a particle. In \REF{ex:key:683}, the subject NP in papá ‘her father’ is highlighted via presentational focus[FFF9?] only by means of the post-posed emphatic particle sɛ́f: 
...
Focused non-subject \textsc{NPs} may also be found \textit{in} \textit{situ} together with a focus particle. Compare the focused PP \textit{fɔ} \textit{di pikín} in \REF{ex:key:684}: 
...
For example, sentence \REF{ex:key:687} features the dislocated and topical object NP di róp ‘the rope’, followed by the focus particle sɛ́f. In contrast to fronting (i.e. in question formation), the use of dislocation[FFF9?] comes along with the use of a resumptive pronoun[FFF9?] (here the 3sg.obj pronoun =an) in the original object position of the left-dislocated constituent:
...
Sentence \REF{ex:key:688} contains a left-dislocated object NP, the emphatic pronoun mí ‘1sg.indp’, which is reiterated by the coreferential object pronoun mí ‘1sg.indp’. In this example, too, focus of the dislocated topic is overtly signalled by means of the particle sɛ́f:
...
\ea%689
    \label{ex:key:689}
    \gll A    go  wás=an    wet  mi    hán    \textstylePichiexamplebold{mí} \textstylePichiexamplebold{sénwe}.\\
...
The Spanish-origin focusing device \textit{es que} ‘it is that’ is regularly employed to signal presentational focus with clauses and sentences \REF{ex:key:692}: 


\ea%692
    \label{ex:key:692}
    \gll \textstylePichiexamplebold{Es}  \textstylePichiexamplebold{que}   e    fáyn    wé  yu  nó  sabí    sé    e    kɔmɔ́t
fɔ  di  animal.  \\
...
\gll
\textstylePichiexamplebold{Na} \textstylePichiexamplenumberZchnZchn{chak-mán.}\\
...
\gll
\textstylePichiexamplebold{Na} \textstylePichiexamplenumberZchnZchn{pɔ́sin}\textstylePichiexamplebold{  wé}  de  fíl  sém.\\
...
\ea%699
    \label{ex:key:699}
    \gll (\textstylePichiexamplebold{\'{I}n})    na  \textstylePichiexamplebold{wán}   \textstylePichiexamplebold{mán}  wé  de  plé  wet    di  bɔ́l.\\
...
By comparison, the insertion of a \textsc{3sg} peronal pronoun is ungrammatical in the focus construction in \REF{ex:key:700}, since \textit{na}\textit{\textup{/}}\textit{nóto} is non-referential in these constructions. Likewise, a cleft focus construction cannot be rephrased as a presentative clause (cf. \sectref{sec:7.4.4}):
...
\ea%702
    \label{ex:key:702}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{smɔ́l}  \textstylePichiexamplebold{híl}  e    klém.\\
...
\ea%703
    \label{ex:key:703}
    \gll Wé  wi  smɔ́l,  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{sósó}    \textstylePichiexamplebold{Píchi}  wé  wi  de  tɔ́k.\\
...
\ea%705
    \label{ex:key:705}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{dé}    e    de  gó,  yu  nó    dé?\\
...
\ea%706
    \label{ex:key:706}
    \gll E    de  wáka  rɔn-sáy,    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{rɔn-sáy} e    wáka.\\
...
\ea%707
    \label{ex:key:707}
    \gll E    sé    e    kɔmɔ́t    fá,  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{fá} e    kɔmɔ́t.\\
...
Example \REF{ex:key:708} contains an instrumental\index{} prepostional phrase featuring the preposition \textit{wet} ‘with’:


\ea%708
    \label{ex:key:708}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{ús=tín}  dɛn  bíl=an?\\
...
\ea%709
    \label{ex:key:709}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{dán}  \textstylePichiexamplebold{área}  wi  sté.\\
...
\ea%710
    \label{ex:key:710}
    \gll Wé  yu  dɔ́n  de  nák,    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{sé}    yu  wánt  sɔn    tín    
e    \textstylePichiexamplebold{brók},  \textstylePichiexamplebold{mék}    e    krás,  \textstylePichiexamplebold{mék}    e    \textstylePichiexamplebold{destroza}.\\
...
\ea%711
    \label{ex:key:711}
    \gll E    de  kráy    pero  \textstylePichiexamplebold{nóto}  \textstylePichiexamplebold{sé}    e    wánt  chɔ́p.\\
...
\ea%712
    \label{ex:key:712}
    \gll \textstylePichiexamplebold{Ɛf}  \textstylePichiexamplebold{nóto}  yu  báy  dán  húman  go  bít    yú    sóté  
yu  go  gó  lɛ́f=an.\\
...
\ea%713
    \label{ex:key:713}
    \gll \textstylePichiexamplebold{Es}  \textstylePichiexamplebold{que}   está    bien    usar    el  subjuntivo.\\
...
\ea%714
    \label{ex:key:714}
    \gll Entonces    \textstylePichiexamplebold{dí}  \textstylePichiexamplebold{káyn}  \textstylePichiexamplebold{pikín},  \textstylePichiexamplebold{es}  \textstylePichiexamplebold{que}    normalmente
...
\ea%715
    \label{ex:key:715}
    \gll \textstylePichiexamplebold{Es}  \textstylePichiexamplebold{que}  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{dán}  \textstylePichiexamplebold{klém}  \textstylePichiexamplebold{wé} e    de  klém,
e    de  gó e      de  klém.\\
...
\ea%716
    \label{ex:key:716}
    \gll Bɛt  e    fíba      sé    \textstylePichiexamplebold{wán}    dé    wé  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{ín}
...
Cleft constructions of the type in \REF{ex:key:716} above, where a resumptive element is focused, serve an important function in discourse[FFF9?]. They serve as anaphors that establish reference to preceding topical material in the sentence or the paragraph. The relevant collocations involve the focus particle na ‘foc’ followed by the adverbs yá ‘here’, dé ‘there’, só ‘so; like that’, the personal pronoun ín ‘3sg.indp’, as well as complex NPs like dán tɛ́n ‘that time’ and di tín ‘the thing’. Mostly, these collocations function as resumptive adverbials of location, time, or cause, but ín ‘3sg.indp’ may also refer to preceding subjects and objects[FFF9?]. 
...
\ea%717
    \label{ex:key:717}
    \gll Na  frɔn    in    hós,    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{dé}    yu  go  ték    máred.\\
...
\ea%720
    \label{ex:key:720}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{dé}   dán,    dán  kandá,  dán  tín,    dán  membrano,
na  dé    e    kɔmɔ́t,  (…).\\
...
\ea%721
    \label{ex:key:721}
    \gll Na  di  fáyn    chɔ́p,  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{ín}   de  stáwt=an.\\
...
\textstylePichiexamplebold{na}  \textstylePichiexamplebold{ín}    e    wánt.\\
...
\ea%723
    \label{ex:key:723}
    \gll Wé  e    dɔ́n  dé    pan  di  chía,  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{ín}    e    strét.\\
...
\ea%724
    \label{ex:key:724}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{bikɔs}  in    abuelo    dɔ́n  dáy,  
\textstylePichiexamplebold{na}  \textstylePichiexamplebold{ín}    e    de  kráy.\\
...
\ea%725
    \label{ex:key:725}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{bikɔs}  dɛn  púl    di  motó,  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{tín}
\textstylePichiexamplebold{mék}    e    chakrá.\\
...
\ea%726
    \label{ex:key:726}
    \gll E    sé    \textstylePichiexamplebold{na} mán    \textstylePichiexamplebold{dís}.\\
...
\ea%727
    \label{ex:key:727}
    \gll \textstylePichiexamplebold{Na} róp    \textstylePichiexamplebold{dát}.\\
\textsc{foc}  rope  that\\
...
\ea%728
    \label{ex:key:728}
    \gll \textbf{Dí}  wán    \textstylePichiexamplebold{na} bíf.\\
...
\ea%731
    \label{ex:key:731}
    \gll Sé  papá  gɔ́d\textstylePichiexamplebold{} ús=káyn  trɔ́bul  \textstylePichiexamplebold{dís}?\\
\textsc{quot}  father  God  \textsc{q}=kind  trouble  this\\
...
Besides focus of verbs by means of clausal focus, verbs may be singled out for focus individually in a construction termed “predicate clefting” (e.g. \citealt{Koopman1984}; \citealt{LarsonLefebvre1991}) or “verb fronting\is{fronting}” \is{fronting}\citep{Muysken1978}.
...
\ea%732
    \label{ex:key:732}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{gó}  a    de  \textstylePichiexamplebold{gó}  ó.\\
...
\ea%733
    \label{ex:key:733}
    \gll Chico,  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{bíg}   e    \textstylePichiexamplebold{bíg}.\\
...
\ea[*]{%734
    \label{ex:key:734}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{bíg}  wé  e    \textstylePichiexamplebold{bíg}.\\
 \textsc{foc}  big  \textsc{sub}  \textsc{3sg.sbj}  big\\
\glt *It’s really big. [ne07fn]
}\z
...
\ea%735
    \label{ex:key:735}
    \gll Na  \textstylePichiexamplebold{krách}=an    yu  de  \textstylePichiexamplebold{skrách}.\\
...
\ea[*]{%736
    \label{ex:key:736}
    \gll Na  \textstylePichiexamplebold{lúk}  \textstylePichiexamplebold{fáyn}  yu  \textstylePichiexamplebold{lúk}.\\
 \textsc{foc}  look  fine    \textsc{2sg}  look\\
\glt *You looked really well. [ne07fn]
}\z
...
\ea%737
    \label{ex:key:737}
    \gll Na  wáka  wi  \textstylePichiexamplebold{bin}  \textstylePichiexamplebold{de} wáka  \textstylePichiexamplebold{gó}  dé.\\
...
\ea%738
    \label{ex:key:738}
    \gll Na  wáka  wi  \textstylePichiexamplebold{wáka}  \textstylePichiexamplebold{gó}  dé.\\
...
\ea%739
    \label{ex:key:739}
    \gll Na  \textstylePichiexamplebold{wáka}  e    \textstylePichiexamplebold{wánt}  \textstylePichiexamplebold{wáka}  só.\\
...
\ea%741
    \label{ex:key:741}
    \gll Na  \textstylePichiexamplebold{bɔkú}  \textstylePichiexamplebold{chɔ́p}  e    kin  \textstylePichiexamplebold{chɔ́p}.\\
...
In \REF{ex:key:742}, NP focus (i.e. dís wán sɛ́f ‘this one emp’ co-occurs with a predicate featuring the perfect marker dɔ́n and the imperfective marker de. Sentence \REF{ex:key:743} additionally features the completive aspect[FFF9?] auxiliary verb fínis ‘finish (doing something)’, which adds even more emphatic force: 
...
\ea%743
    \label{ex:key:743}
    \gll Náw    a    \textstylePichiexamplebold{dɔ́n  de  fínis}  sém  
fɔ  wɛ́r    dán    sús.\\
...
\ea%744
    \label{ex:key:744}
    \gll E    de  para    na  dán  in    yáy  \textstylePichiexamplebold{bɔkú}  \textstylePichiexamplebold{bád.}\\
...
\ea%746
    \label{ex:key:746}
    \gll Dɛn  bin  \textstylePichiexamplebold{fáyn}  wán    \textstylePichiexamplebold{fáyn}  \textstylePichiexamplebold{ó}.\\
...
\ea%748
    \label{ex:key:748}
    \gll \textstylePichiexamplebold{Dán}    \textstylePichiexamplebold{skúl},  \textstylePichiexamplebold{e}    dé    nía    bɛrin-grɔ́n,    nɔ́?\\
...
\ea%750
    \label{ex:key:750}
    \gll \textstylePichiexamplebold{Dí}  \textstylePichiexamplebold{cartón},  \textstylePichiexamplebold{e} mít=an    yá?\\
this  carton  \textsc{3sg.sbj}  meet=\textsc{3sg.obj}  here\\

\glt ‘This cardboard box, did she find it here?’ [li07pe 070]
\z

In \REF{ex:key:751}, the topical object NP ɛ́ni tín ‘everything’ is reiterated by the resumptive, coreferential object prounoun =an ‘3sg.obj’ after the verb púl ‘remove’:
...
\ea%752
    \label{ex:key:752}
    \gll \textstylePichiexamplebold{Mí},    lɛk  háw    yu  de  sí  \textstylePichiexamplebold{mí},    \textstylePichiexamplebold{a}    dɔ́n  
sí  plɛ́nte  tín.\\
...
\ea%753
    \label{ex:key:753}
    \gll \textstylePichiexamplebold{Panyá},  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{ín}    wɔ́s      mɔ́.\\
...
\ea%754
    \label{ex:key:754}
    \gll \textstylePichiexamplebold{Fɔ}  \textstylePichiexamplebold{tɔ́k}  \textstylePichiexamplebold{Píchi},  yu  nó  níd    fɔ  gó  skúl.\\
...
\textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{pút}  \textstylePichiexamplebold{nivel}. \\
...
\ea%756
    \label{ex:key:756}
    \gll \textstylePichiexamplebold{Náw}    e    tínap  na  grɔ́n.\\
...
\ea%757
    \label{ex:key:757}
    \gll ‘\textstylePichiexamplebold{Mɔ́nt’}  \textstylePichiexamplebold{náw},  \textstylePichiexamplebold{e}    dɔ́n  bí  inglés.\\
...
\ea%758
    \label{ex:key:758}
    \gll \textstylePichiexamplebold{Pikín}  \textstylePichiexamplebold{náw},  \textstylePichiexamplebold{e}  nó  hád.\\
...
\ea%759
    \label{ex:key:759}
    \gll \textstylePichiexamplebold{Sósó}  \textstylePichiexamplebold{Píchi}  \textstylePichiexamplebold{náw}    wé  wi  de  tɔ́k.\\
...
\begin{tikzpicture}
\node[rectangle,draw] (focus) {\textsc{focus}};
\node[rectangle,draw] (identity)  [right=of focus]{\textsc{identity}};
\node[rectangle,draw] (permposs)  [above=of identity]{\textsc{permanent possession}};
\node[rectangle,draw] (existence)  [right=of permposs]{\textsc{existence}};
\node[rectangle,draw] (tempposs)  [right=of existence,yshift=-5mm]{\textsc{temporary possession}};

\node[rectangle,draw] (cos)  [below=of identity,xshift=-5mm]{\textsc{change-of-state}};
\node[rectangle,draw] (location)  [below=of existence]{\textsc{location}};
\node[rectangle,draw] (xpt)  [below=of location]{\textsc{existence in place \& time}};
\node[rectangle,draw] (pac)  [right=of xpt]{\textsc{predicative adjective clause}};

\draw (focus) -- (identity);
\draw (identity) -- (cos);
\draw (identity) -- (permposs);
\draw (permposs) -- (existence);
\draw (existence) -- (location);
\draw (existence) -- (tempposs);
\draw (location) -- (tempposs);
\draw (location) -- (xpt);
\draw (location) -- (pac);
\end{tikzpicture}
...
\lsptoprule
 & \multicolumn{3}{c}{ Identity} & Location \& existence\\
...
\ea%761
    \label{ex:key:761}
    \gll Dán    tín    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{di} pasta.\\
...
\ea%762
    \label{ex:key:762}
    \gll \'{I}n    \textstylePichiexamplebold{na} kres-húman.\\
...
\ea%763
    \label{ex:key:763}
    \gll Mi    papá  \textstylePichiexamplebold{na} dɔ́kta  bɔt  mí    nó  go  \textstylePichiexamplebold{tɔ́n}  dɔ́kta.\\
...
\textstylePichiexamplebold{na} mi    mamá.\\
...
\ea%766
    \label{ex:key:766}
    \gll \textstylePichiexamplebold{Na} kasára.\\
\textsc{foc}  cassava\\
...
\ea%767
    \label{ex:key:767}
    \gll \textbf{N}\textstylePichiexamplebold{óto}  wi  Píchi.\\
...
\ea%768
    \label{ex:key:768}
    \gll In    papá  \textstylePichiexamplebold{na} chino.\\
...
\ea
	\label{ex:key:769}
	\gll
\textstylePichiexamplebold{Mí}    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{di} wan-grén  pikín.\\
...
\glt *Her mother is Russian. [dj07ae 532]
}\z

In the following two equative clauses, the presence of the \textsc{TMA} markers \textit{dɔ́n} ‘\textsc{prf}’ \REF{ex:key:771} and \textit{go} ‘\textsc{pot}’ \REF{ex:key:772} motivates the appearance of the suppletive identity copula \textit{bí} ‘\textsc{be’.} In spite of its defective distribution (cf. \REF{ex:key:770}), the copula \textit{bí} behaves much more like a copula verb than \textit{na}\textit{\textup{/}}\textit{nóto:} It may take dependent personal pronouns (e.g. in \REF{ex:key:771}) and appear with TMA marking (e.g. \REF{ex:key:771} and \REF{ex:key:772}), and it may appear in many more contexts than the \textit{na}\textit{\textup{/}}\textit{nóto}: 


\ea%771
    \label{ex:key:771}
    \gll E\textstylePichiexamplebold{}   \textstylePichiexamplebold{dɔ́n}  bí  wán    señorita.\\
...
\ea%773
    \label{ex:key:773}
    \gll Mi    ném    \textstylePichiexamplebold{bin}  \textstylePichiexamplebold{bí} Francisca  Belobe  Toichoa,    porque
mi    mamá  in    ném    \textstylePichiexamplebold{na} Belobe  Toichoa.\\
...
\ea%774
    \label{ex:key:774}
    \gll So  mí,    mi    yón     e    \textstylePichiexamplebold{kán}  \textbf{bí}  una  desgracia.\\
...
\ea%775
    \label{ex:key:775}
    \gll ‘Kɔ́t’    \textstylePichiexamplebold{fít}  bí  lɛkɛ    herida.\\
...
\ea%776
    \label{ex:key:776}
    \gll \textstylePichiexamplebold{Mék}    e    \textbf{bí}    sé    Kofí    dɔ́n    kán.\\
...
\ea%777
    \label{ex:key:777}
    \gll \textstylePichiexamplebold{Frɔn}  wé  a    \textbf{bí}  pikín  a    \textstylePichiexamplebold{bin}  wánt
...
\ea%778
    \label{ex:key:778}
    \gll E    \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{go}  \textbf{bí}  mecánico.\\
...
The copula \textit{dé} may occur in intransitive clauses without any complement. Such clauses show that \textit{dé} is semantically relatively rich and has a meaning of its own, namely ‘exist in a place’ or ‘exist in a certain manner’. Compare the question in \REF{ex:key:779}(a) and the corresponding answer in \REF{ex:key:779}(b):
...
\ea{
\gll
Ebongolo  \textstylePichiexamplebold{dé}?\\
...
\ea%781
    \label{ex:key:781}
    \gll Yu  fon    \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{nía}    \textstylePichiexamplebold{tébul}.\\
...
\ea%782
    \label{ex:key:782}
    \gll \'{A}fta    dí  wán  wé  e    \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{yandá},  e    bíg.\\
...
\ea%783
    \label{ex:key:783}
    \gll Somos  tú  dásɔl  wé  wi  \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{láyf}.\\
we.are  two  only    \textsc{sub}  \textsc{1pl}  \textsc{be.loc}  life\\

\glt ‘We are only two who are alive.’ [ab03ay 133]
\z

Sentence \REF{ex:key:784} exemplifies how dé is used to express existence in time. In contrast to locative complements, time adverbials like ívin tɛ́n ‘evening’ appear as direct complements of the copula dé when the intended meaning is ‘location[FFF9?] in time’ (cf. \sectref{sec:8.2.2} for other temporal relations): 
...
\ea%785
    \label{ex:key:785}
    \gll Wi  \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{las}    \textstylePichiexamplebold{dos}  \textstylePichiexamplebold{y}  \textstylePichiexamplebold{media}.\\
\textsc{1pl}  \textsc{be.loc}  the\textsc{.pl}  two  and  half\\

\glt ‘It’s two thirty.’ [dj05ce 056]
\z

The form \textit{dé} ‘\textsc{be.loc}’ may also be employed to attribute a relatively transient, non-time-stable property to a subject. Hence, \textit{dé} is encountered as a predicator in predicate adjective constructions involving the few adjectives that Pichi has. One of these is \textit{fáyn} ‘(be) fine’ in \REF{ex:key:786}. As explained in detail in section \sectref{sec:7.6.5}, predicate adjective constructions, rather than verbal clauses, are only chosen when the situation is perceived as non-time-stable:
...
Another manifestation of the non-time stable character of the situation predicated by dé ‘be.loc’ is given in the following three sentences. The copula dé is used when an adverbial complement designates a way of being rather than intrinsic being. Adverbial complements can be a simple manner adverb like só ‘so’ \REF{ex:key:787}, a bare NP featuring the generic noun stáyl ‘manner; style’ \REF{ex:key:788}, or a PP with the similative[FFF9?] and equative preposition lɛ́k ‘like’ \REF{ex:key:789}:


\ea%787
    \label{ex:key:787}
    \gll Na  \textstylePichiexamplebold{só}    e    \textstylePichiexamplebold{dé}.\\
...
\ea%788
    \label{ex:key:788}
    \gll E    \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{ɔ́da}    \textstylePichiexamplebold{stáyl}.\\
...
\ea%789
    \label{ex:key:789}
    \gll \MakeUppercase{A}   wánt  \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{lɛk}  Miguel  Ángel.\\
...
\ea%791
    \label{ex:key:791}
    \gll Bɔt  mí    wánt  sabí    \textstylePichiexamplebold{háw}    dán    tín    \textstylePichiexamplebold{dé}.\\
...
\ea%793
    \label{ex:key:793}
    \gll Nó  bɔ́dí    \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{dé}    na  pueblo.\\
...
\ea%797
    \label{ex:key:797}
    \gll Mék    a    gó  dú  smɔ́l  tín    a    \textstylePichiexamplebold{tɔ́n}    \textstylePichiexamplebold{bák}.\\
...
\ea%798
    \label{ex:key:798}
    \gll Dɛn-ɔ́l    dɛn  dɔ́n  \textstylePichiexamplebold{tɔ́n}    \textstylePichiexamplebold{europeos}  \textstylePichiexamplebold{dɛn}.\\
\textsc{3pl.cpd-}all  \textsc{3pl}  \textsc{prf}  turn    European.\textsc{pl}  \textsc{pl}\\

\glt ‘They have all turned into Europeans.’ [fr03ft 149]
\z

In contexts other than copula expression and causative formation, lɛ́f may be employed as a dynamic verb in transitive clauses with the meaning ‘leave (behind)’ \REF{ex:key:799}: 
...
The verb lɛ́f ‘leave; remain’ also functions as a resultative copula[FFF9?] in resultative causative constructions [FFF9?]like the following one (cf. \sectref{sec:9.4.4} for a thorough treatment)[FFF9?]: 
...
Besides the verb gɛ́t ‘get; have’ (cf. \sectref{sec:7.6.3}), a few other verbs express existence in space and time. When the inchoative-stative verb lɛ́f ‘leave; remain’ occurs in an intransitive clause featuring a comitative or locative adverbial, this verb assumes a copula function with the meaning ‘remain (behind); stay temporarily with’ \REF{ex:key:801}. 
...
\ea%802
    \label{ex:key:802}
    \gll \MakeUppercase{A}   de  trén=an    porque  e    go  \textstylePichiexamplebold{kɔmɔ́t}    pɔ́sin.\\
...
Finally, the occurrence of \textit{pás} ‘pass’ and \textit{rích} ‘arrive’ as inchoative-stative verbs in comparatives like \REF{ex:key:483} and equatives like \REF{ex:key:510} may also be seen as manifestations of a copula-like use of these otherwise dynamic verbs.\is{copula verbs} 

\subsection{Existentials}\label{sec:7.6.3}

The locative-existential copula[FFF9?] dé ‘be.loc’, as well as the verb gɛ́t ‘have; get; acquire’ both participate in existentials, i.e. constructions which predicate the general existence of an entity. Pichi existentials appear in two types of clauses with respect to number and type of participants: Transitive clauses featuring gɛ́t ‘have’ and intransitive clauses featuring dé ‘be.loc’. Some of the characteristics of these two types of existentials are given in \tabref{tab:key:7.9}:
...
Pichi has other ways of establishing the type of impersonal reference characteristic for gɛ́t-existentials besides a 3sg expletive pronoun[FFF9?]. The verb gɛ́t may also occur with an impersonal 3pl \REF{ex:key:805} or 2sg \REF{ex:key:806} pronoun in clauses that are functionally similar to existentials \REF{ex:key:804}:[FFF9?]
...
There are no restrictions on the use of gɛ́t-existentials in subordinate clauses. In sentence \REF{ex:key:807}, the existential clause appears in a relative clause introduced by wé ‘sub’: 
...
\ea%808
    \label{ex:key:808}
    \gll Bueno  aunque  dé,    \textstylePichiexamplebold{bɔkú}  \textstylePichiexamplebold{interés}  \textstylePichiexamplebold{económico}  \textstylePichiexamplebold{dé}.\\
...
\ea%809
    \label{ex:key:809}
    \gll Bueno,  \textstylePichiexamplebold{mi}    \textstylePichiexamplebold{gran-pá}    bin  \textstylePichiexamplebold{dé}.\\
...
\ea%810
    \label{ex:key:810}
    \gll Paciente  dɛn  \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{sala},  yú    dɔ́kta  la  una
yu  de  kán?\\
...
Existential clauses featuring gɛ́t are not often negated. The data contains only a single negative gɛ́t-existential clause, presented in \REF{ex:key:811}. This is probably so because the “true” existential construction featuring gɛ́t is subject to an affirmative presupposition:
...
\ea%812
    \label{ex:key:812}
    \gll \textstylePichiexamplebold{Nó}  \textstylePichiexamplebold{pát}  fɔ  wɔ́l    mɔ́    \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{dé}.\\
...
\ea%813
    \label{ex:key:813}
    \gll ‘Fam-mán’  \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{dé}.\\
farm.\textsc{cpd}{}-man  \textsc{neg}  \textsc{be.loc}\\

\glt ‘[The word] “Farm-man” doesn’t exist.’ [dj05be 016]
\z

Likewise, the corpus does not reveal any instance of a non-finite gɛ́t with an existential sense. Conversely, we once more encounter many examples of non-finite dé ‘be.loc’ with an existential reading as in \REF{ex:key:814}:
...
The same applies to TMA marking. While quite a few dé-existentials are found with overt TMA marking as in \REF{ex:key:815}, there is no such example of a gɛ́t-existential. The latter type of existential therefore appears to be prototypical in an additional sense – gɛ́t existentials typically predicate a generic situation, which is also marked as such by factative[FFF9?] tense-aspect:
...
\lsptoprule
 ...
 \midrule 
Verbal & gɛ́t ‘get; have’ & \textstyleTablePichiZchn{hól} ‘\textstyleTableEnglishZchn{keep’} & Subject & Majority\\
...
\end{tabularx}
\end{table}
The verb gɛ́t ‘get; have’ expresses permanent, time-stable possession. When gɛ́t occurs in a factative marked clause \REF{ex:key:817}, a lexicalised light verb construction \REF{ex:key:818}, an existential construction (cf. \sectref{sec:7.6.3}), or other contexts that propose a generic reading, the verb leans towards the stative meaning ‘own; be in permanent possession’: 
...
Conversely, when gɛ́t co-occurs with a TMA marker with a default or explicit perfective reading \REF{ex:key:819} or sentential aspect suggestive of telicity (i.e. the ‘when’ time clause in \REF{ex:key:820}), an inchoative interpretation of gɛ́t as ‘acquire; enter into permanent possession’ is favoured: 
...
\ea%822
    \label{ex:key:822}
    \gll Di  tín    \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{fɔr}=an,    di  tín    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{fɔ} ín.\\
...
\ea%823
    \label{ex:key:823}
    \gll \MakeUppercase{A}   fít  \textstylePichiexamplebold{hól}    dán    mɔní  \textstylePichiexamplebold{durante}  \textstylePichiexamplebold{un}  \textstylePichiexamplebold{mes}    \textstylePichiexamplebold{entero}.\\
...
Speaker (dj) summarises the difference between gɛ́t and hól in \REF{ex:key:824}. Note the difference in aspect marking with hól, gɛ́t, and dráyb ‘drive’. Imperfective[FFF9?] aspect is expressed through factative[FFF9?] marking with the inchoative-stative verbs hól and gɛ́t. Meanwhile, it is the presence of de ‘ipfv’ that signals imperfective aspect with the dynamic verb dráyb:
...
\ea%828
    \label{ex:key:828}
    \gll George,  mi    móvil  nó  \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{mi}    \textstylePichiexamplebold{hán},  
a    nó  gɛ́t  móvil  náw.\\
...
\ea%831
    \label{ex:key:831}
    \gll Di  húman  \textstylePichiexamplebold{fáyn}.\\
...
\ea%834
    \label{ex:key:834}
    \gll Di  strít    \textstylePichiexamplebold{dé}   \textstylePichiexamplebold{wɔwɔ́}.\\
...
\ea%835
    \label{ex:key:835}
    \gll Di  strít    \textstylePichiexamplebold{wɔwɔ́},  di  strít    \textstylePichiexamplebold{chakrá},      
di  strít    nó  \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{fáyn}.\\
...
\ea%836
    \label{ex:key:836}
    \gll Wé  yu  go  fɔdɔ́n  yu  \textstylePichiexamplebold{go}  \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{bád}.\\
...
Adjectives may also be employed attributively as prenominal modifiers. In this, adjectives behave no differently from other property items (cf. \sectref{sec:5.2.1}). Below, the adjective fáyn ‘be fine’ appears as a modifier of gɛ́l ‘girl’: 
...
Finally, I draw attention to the various other means of attributing properties to a noun. Speakers make use of postnominal modification through relative or quotative clause[FFF9?]s. Other ways of expressing modification are associative constructions and compounding[FFF9?]. Two strategies of modification serve as a productive means of deriving new property items next to the use of Spanish adjectives in the Pichi predicate adjective construction. A dé-copula clause with an adverbial complement [FFF9?]featuring wet ‘with’ \REF{ex:key:838}, as well as light verb constructions involving gɛ́t ‘get; have’ \REF{ex:key:839} allow the attribution of a property to a referent: 
...
di  grɔ́n    e    tú  \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{stón}.\\
...
Equally, many clause linkers are not very different in function from the linking adverbs listed in \tabref{tab:key:7.12} below (e.g. bikɔs ‘because’, adɔnkɛ́ ‘even if’). Further, modal clauses with expletive subjects (e.g. e fít bí sé ‘3sg.sbj’, can be quot’ = ‘it could be that’, and e fíba sé ‘3sg.sbj seem quot’ = ‘it seems that’) convey meanings similar to those of sentence adverbs like sɔntɛ́n ‘perhaps’ and mébi ‘maybe’.


\subsection{Adverbs}\label{sec:7.7.1}
%%please move \begin{table} just above \begin{tabular
\tabref{tab:key:7.12} below presents all monomorphemic adverbs found in the corpus and the most common conventionalised phrasal expressions with adverbial functions. The preferred or canonical syntactic positions are also indicated. The table also contains the two most common Spanish-derived adverbs \textit{pero} ‘but’ and \textit{bueno} ‘alright’. Adverbs with multiple meanings are arranged in all the corresponding “adverb type” sections (e.g. \textit{smɔ́ltɛn} ‘shortly after’ = locative adverb, \textit{smɔ́ltɛn} ‘nearly’ = modal adverb):
...
\end{tabularx}
\end{table}
Adverbs that appear at the beginning modify the sentence in its entirety – they have a wide scope. In \REF{ex:key:840}, the linking adverb adverb pero ‘but’, the modal adverb sɔntɛ́n ‘perhaps’, and the time adverb bambáy ‘gradually’ all occur sentence-initially:
...
Locative\index{} and time adverbs may also occur after the verb, in which case they have narrow scope and modify the meaning of the verb alone. In \REF{ex:key:841}, the repeated locative noun \textit{dɔ́n} ‘down’ and the locative adverb\textit{ yandá} ‘yonder’ modify the verb \textit{sidɔ́n} ‘sit; stay’: 


\ea%841
    \label{ex:key:841}
    \gll Bɔt  ín    sidɔ́n  \textstylePichiexamplebold{dɔ́n}    \textstylePichiexamplebold{dɔ́n}  \textstylePichiexamplebold{dɔ́n}  \textstylePichiexamplebold{yandá}.\\
but  \textsc{3sg.indp}  stay    down  \textsc{rep}  \textsc{rep}  yonder\\

\glt ‘But he stays far down over there.’ [ma03ni 026]
\z

The data contains diverse time adverbs. A few of these are monomorphemic, e.g. bambáy ‘gradually’ in \REF{ex:key:840} above. Others are more or less idiosyncratic phrases containing the time-denoting generic noun tɛ́n ‘time’, as in bɔkú tɛ́n ‘much time’ = ‘for a long time’ \REF{ex:key:842} or dé ‘day’, as in wán dé ‘someday’ \REF{ex:key:843}. Location[FFF9?]-in-time adverbs, like wán dé prefer the clause-initial, duration adverbs like lɔ́n tɛ́n ‘long ago’ and bɔkú tɛ́n the clause-final position: 
...
\ea%844
    \label{ex:key:844}
    \gll \MakeUppercase{A}   mɔs    gó  Alemania  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{dé}.\\
...
a    dráy=an,    \textstylePichiexamplebold{e}    \textstylePichiexamplebold{fínis}  a    áyɛn=an.\\ 
...
The two modal adverbs sɔntɛ́n ‘perhaps’ (cf. \REF{ex:key:840} above) and smɔ́ltɛn ‘nearly’ \REF{ex:key:848} and the evaluative adverb bádtɛn ‘unfortunately’ \REF{ex:key:847} are lexicalised phrases involving the generic noun tɛ́n ‘time’ as a formative element (cf. \REF{ex:key:103} above). Modal and evaluative adverbs are normally found in the initial position with scope over the entire clause: 
...
\ea%848
    \label{ex:key:848}
    \gll \textstylePichiexamplebold{Smɔ́ltɛn}   a    bin  fɔ    dáy  dé.\\
nearly    \textsc{1sg.sbj}  \textsc{pst}  \textsc{cond}    die  there\\

\glt ‘I nearly died there.’  [ed07fn 493]
\z

The adverb mébi ‘maybe’ \REF{ex:key:849} is not as common as sɔntɛ́n ‘perhaps’. Note that smɔ́ltɛn \{small.time\} has an entirely opaque sense ‘nearly’ in the example above, and a more transparent, temporal sense ‘shortly (after)’ in \REF{ex:key:850} below’
...
\ea%852
    \label{ex:key:852}
    \gll E    de  pás  \textstylePichiexamplebold{só}    lɛk  sé    e    nó  nó    mí    mɔ́.\\
...
\ea%853
    \label{ex:key:853}
    \gll Na  \textstylePichiexamplebold{só}    dɛn  go  mék    yú.\\
...
\ea%854
    \label{ex:key:854}
    \gll Frɔn    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{yá}    \textstylePichiexamplebold{só}    dɛn  kin  controla  di  húman.\\
...
\ea%856
    \label{ex:key:856}
    \gll Bɔt  dá  mɔní  de  fínis    \textstylePichiexamplebold{kwík}.\\
...
\ea%858
    \label{ex:key:858}
    \gll Náw    dɛn  de  \textstylePichiexamplebold{jís}  de  kán.\\
...
\ea%860
    \label{ex:key:860}
    \gll E    fíba    lɛk  sé    a    dɔ́n  de  \textstylePichiexamplebold{tú}  \textstylePichiexamplebold{tɔ́k}  bɔkú.\\
...
\ea%862
    \label{ex:key:862}
    \gll A    de  fíl  \textstylePichiexamplebold{tú}  \textstylePichiexamplebold{mɔ́ch}  \textstylePichiexamplebold{hɔ́t}.\\
...
\ea%863
    \label{ex:key:863}
    \gll Di  pikín  \textstylePichiexamplebold{tú}  \textstylePichiexamplebold{mɔ́ch}  \textstylePichiexamplebold{smɔlskín},  e    \textstylePichiexamplebold{dráy}  \textstylePichiexamplebold{tú}  \textstylePichiexamplebold{mɔ́ch}.\\
...
\ea%864
    \label{ex:key:864}
    \gll Dɛn  nó  de  \textstylePichiexamplebold{só}    \textstylePichiexamplebold{yús=}an    mɔ́.\\
...
\ea%867
    \label{ex:key:867}
    \gll E    de  sigue  \textstylePichiexamplebold{mɔ́}.\\
...
\ea%868
    \label{ex:key:868}
    \gll E    dé    e    nó  de  \textstylePichiexamplebold{ánsa} mí    \textbf{mɔ́}.\\
...
\ea%869
    \label{ex:key:869}
    \gll Frɔn    Rebola  bajando    e    nó  go  \textstylePichiexamplebold{dé}    \textbf{mɔ́}.\\
...
The scope of mɔ́ may also be narrower than the clause. In \REF{ex:key:871}, mɔ́ is in the postnominal position and modifies the preceding NP in a way no different from that of the focus particle sɛ́f ‘foc’ or the quantifier[FFF9?] ɔ́l ’all’. In \REF{ex:key:872}, mɔ́ modifies the adverbial áfta ‘then’: 


\ea%871
    \label{ex:key:871}
    \gll \textstylePichiexamplebold{Nó}  \textstylePichiexamplebold{pát}  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{wɔ́l}    \textstylePichiexamplebold{mɔ́}    nó  dé.\\
\textsc{neg}  part  \textsc{prep}  world  more  \textsc{neg}  \textsc{be.loc}\\
...
\ea%872
    \label{ex:key:872}
    \gll \textstylePichiexamplebold{\'{A}fta    mɔ́}   a    bin  wók    dís  sén    wók 
wé  a    de  dú. \\
...
Besides the adverbs treated so far, compounds \REF{ex:key:873} or constructions featuring generic nouns of place (i.e. sáy ‘side; place’), time (i.e. tɛ́n ‘time’ and dé ‘day’), and manner (i.e. stáyl ‘manner, style’) serve as locative[FFF9?], time \REF{ex:key:874}, and manner adverbials \REF{ex:key:875}:


\ea%873
    \label{ex:key:873}
    \gll \textstylePichiexamplebold{Wok-sáy}    a    de  híɛ    wé  dɛn  de  tɔ́k=an    bɔkú.\\
...
\ea%875
    \label{ex:key:875}
    \gll Dɛn  só  di  sɔ́t    \textstylePichiexamplebold{tú}  \textstylePichiexamplebold{stáyl}.\\
...
\ea%876
    \label{ex:key:876}
    \gll \MakeUppercase{A}   pút  di  kí  \textstylePichiexamplebold{na} pála.\\
...
\ea%878
    \label{ex:key:878}
    \gll Chico,  yu  dɔ́n  \textstylePichiexamplebold{chɔ́p}=an    \textstylePichiexamplebold{haydháyd}.\\
...
\ea%879
    \label{ex:key:879}
    \gll \'{A}s  dɛn  nɔ́ba  bin  sí  plantí,  dɛn  bin  \textstylePichiexamplebold{chɔ́p}=an    \textstylePichiexamplebold{rɔ́n-wán}.\\
...
\ea%880
    \label{ex:key:880}
    \gll Dɛn    \textstylePichiexamplebold{tíf}    di  mɔní  \textstylePichiexamplebold{síkrit}  \textstylePichiexamplebold{stáyl}.\is{noun phrase adverbials}\\
\textsc{3pl}    steal  \textsc{def}  money  secret  style\\

\glt ‘They stole the money secretly.’ [ra07ve 048]
\z

Likewise, prepositional phrases\is{prepositional phrases} introduced by \textit{fɔ} ‘\textsc{prep}’ may express manner \index{}as in the following example: 


\ea%881
    \label{ex:key:881}
    \gll A    wáka  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{fút}    wet    mi    maleta.\\
...
\ea%882
    \label{ex:key:882}
    \gll E    gó  na  wók    wé  e    \textstylePichiexamplebold{klín}.\\
...
\ea%883
    \label{ex:key:883}
    \gll Dí  pikín  kɔmɔ́t  \textstylePichiexamplebold{sé} e\textstylePichiexamplebold{    dɔtí}.\\
...
Modifications of circumstance \is{}may also be provided through nominal depictives that come in the guise of prepositional phrases\index{prepositional phrases} introduced by \textit{wet} ‘with’ \REF{ex:key:885} and \textit{lɛk} ‘like’ \REF{ex:key:886}:


\ea%885
    \label{ex:key:885}
    \gll E    pút  di  bɔ́tul  pan  di  tébul  \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{mɔ́t}    \textstylePichiexamplebold{dɔ́n}.\\
...
\ea%886
    \label{ex:key:886}
    \gll Pero    mi    mamá  kán  acepta  di  pikín  \textstylePichiexamplebold{lɛk}  \textstylePichiexamplebold{mi}
\textstylePichiexamplebold{brɔ́da}  \textstylePichiexamplebold{in}    \textstylePichiexamplebold{pikín}.\\
...
\ea%887
    \label{ex:key:887}
    \gll Mí    nó  lɛk  yú    bɔt  wi  fít  dé    \textstylePichiexamplebold{lɛk}  \textstylePichiexamplebold{kɔ́mpin}.\\
...
The similative collocation wók lɛ́k dɔ́kta functions as a nominal depictive \REF{ex:key:888} (cf. \sectref{sec:11.3} for an extensive discussion of verbal depictives in secondary predications). A similative lɛk in \REF{ex:key:889} translates as ‘around’: 


\ea%888
    \label{ex:key:888}
    \gll Di  cubana  húman  de  \textstylePichiexamplebold{wók}    \textstylePichiexamplebold{lɛk}  \textstylePichiexamplebold{dɔ́kta}  na  Malábo.\\
...
\ea%889
    \label{ex:key:889}
    \gll Yu  fít  gí  mí    \textstylePichiexamplebold{lɛk}  \textstylePichiexamplebold{dos}  \textstylePichiexamplebold{mil}      só?\\
...
\ea%891
    \label{ex:key:891}
    \gll E    dríng  di  \textstylePichiexamplebold{watá}  \textstylePichiexamplebold{kól}.\\
...
\ea%892
    \label{ex:key:892}
    \gll E    dríng  \textstylePichiexamplebold{kol-watá}.\\
...
Degree modification may also be realised on the suprasegmental level. Vowel-lengthening and extra-high pitch may indicate a larger amount of intensity, extent, or dimension of a referent, which is generally a property item or an adverbial. The only syllable of the property item \textit{kól} ‘be cold’ in \REF{ex:key:893} is pronounced with an extra-high tone and lengthened. The phonetic transcription is provided in squared brackets: 
...
in    hán    dé,    na  só    dɛn  \textstylePichiexamplebold{kó.ól}  [\textstylePichiexamplenumberZchnZchn{k\H{o}::l]}.\\
...
\ea%894
    \label{ex:key:894}
    \gll Dɛn  kéch=an    dɛn  bít=an    \textstylePichiexamplebold{sóté.e}  [s\H{o}t\H{e}::].\\
...
\textstylePichiexamplebold{fá.áwe}  [fá:we],  a    kɔmɔ́t    \textstylePichiexamplebold{fá.á}    [\textstylePichiexamplenumberZchnZchn{fá::}].’\\
...
\ea%897
    \label{ex:key:897}
    \gll A    de  \textstylePichiexamplebold{sɔ́ri}      \textstylePichiexamplebold{bád.}\\
...
\ea%898
    \label{ex:key:898}
    \gll E    \textstylePichiexamplebold{fáyn}  \textstylePichiexamplebold{bád,}      e    \textstylePichiexamplebold{fáyn}  \textstylePichiexamplebold{bád.}\\
...
\ea%899
    \label{ex:key:899}
    \gll E    \textstylePichiexamplebold{hád}    \textstylePichiexamplebold{ó}.\\
