...
\ea%900
    \label{ex:key:900}
    \gll Di  pépa  dé    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{tébul}.\\
...
Next to full nouns, locative adverbs\index{} may also function as complements to prepositions. Take note of the temporal meaning of the locative adverb \textit{dé} ‘there’ in \REF{ex:key:902}:


\ea%902
    \label{ex:key:902}
    \gll wé  in    mamá  dáy,  na  \textstylePichiexamplebold{frɔn}    \textstylePichiexamplebold{dé}    e    bigín  krés.\\
...
\ea%903
    \label{ex:key:903}
    \gll E    kán    fɔdɔ́n  \textstylePichiexamplebold{sóté}    \textstylePichiexamplebold{yá}.\\
...
\ea%904
    \label{ex:key:904}
    \gll (...)  na  di  tín    a    kán    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{yá}.\\
...
\ea%905
    \label{ex:key:905}
    \gll \textstylePichiexamplebold{Fɔ}  \textstylePichiexamplebold{yá}    \textstylePichiexamplebold{só},    pípul  fɔ  isla    dɛn  de  pé  líka.\\
...
\ea%906
    \label{ex:key:906}
    \gll Na  só    dɛn  de  mék    café    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{dí}  \textstylePichiexamplebold{sáy}.\\
...
\ea%907
    \label{ex:key:907}
    \gll E    bin  pás  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{mi}    \textstylePichiexamplebold{hós}.\\
...
\ea%910
    \label{ex:key:910}
    \gll (...)  mék    yu  tɔ́n=an,    porque  \textstylePichiexamplebold{bɔtɔ́n}  go  rós.\\
...
\ea%911
    \label{ex:key:911}
    \gll Yu  de  klém  fɔ  \textstylePichiexamplebold{rích}    \textstylePichiexamplebold{pantáp}.\\
...
\ea%912
    \label{ex:key:912}
    \gll (...)  e    \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{ɔ́p},  gó  só!\\
...
\ea%913
    \label{ex:key:913}
    \gll \textstylePichiexamplebold{Di}  \textstylePichiexamplebold{dɔ́n}    na  violeta  (...)\\
...
\ea%914
    \label{ex:key:914}
    \gll E    púl=an      \textstylePichiexamplebold{na}  \textstylePichiexamplebold{pantáp}  di  béd.\\
...
\ea%915
    \label{ex:key:915}
    \gll Na  fɔ  mék    nó  gó  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{dɔ́n}.\\
...
\ea%917
    \label{ex:key:917}
    \gll E    dé    \textstylePichiexamplebold{bifó}    di  \textstylePichiexamplebold{hós}.\\
...
\ea%918
    \label{ex:key:918}
    \gll E    dé    \textstylePichiexamplebold{bifó}    \textstylePichiexamplebold{sáy}.\\
...
However, when the ground is explicitly mentioned, most locative nouns participate in a construction that is structurally equivalent to a prepositional phrase featuring a preposition and an object complement. Compare \REF{ex:key:901} above with \REF{ex:key:920} and \REF{ex:key:921} below:


\ea%920
    \label{ex:key:920}
    \gll Di  béd  dé    \textstylePichiexamplebold{míndul}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{rúm}.\\
...
\ea%922
    \label{ex:key:922}
    \gll E    de  cruza-cruza    \textstylePichiexamplebold{bifó}    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{domɔ́t},  e    de  dú
...
\ea%923
    \label{ex:key:923}
    \gll Yu  fít  tɔ́k  sé    ‘dɛn    sidɔ́n  \textstylePichiexamplebold{nía    di  fáya}’.\\
...
\ea%924
    \label{ex:key:924}
    \gll A    sidɔ́n  \textstylePichiexamplebold{kɔ́na}    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{aeropuerto}.\\
...
\ea%925
    \label{ex:key:925}
    \gll Di  pépa  dé    \textstylePichiexamplebold{ɔntɔ́p}  \textstylePichiexamplebold{tébul}.\\
...
\ea%927
    \label{ex:key:927}
    \gll Dán  skúl    e    dé    \textstylePichiexamplebold{nía}    \textstylePichiexamplebold{bɛrin-grɔ́n},    nɔ́?\\
...
\ea%928
    \label{ex:key:928}
    \gll Pɔ́sin  dɛn  dé    \textstylePichiexamplebold{nadó}  \textstylePichiexamplebold{fɔ} di  avión.\\
person  \textsc{pl}  \textsc{be.loc}  outside  \textsc{prep}  \textsc{def}  plane\\

\glt ‘People are outside the plane.’ [dj05be 165]
\z

The expression of the ground by way of a fɔ-prepositional phrase as in \REF{ex:key:928} above is not accepted with other locative nouns, i.e. *míndul fɔ di rúm \{middle prep def room\} ‘in the middle of the room’, *bihɛ́n fɔ dís hós \{behind prep this house\} ‘behind this house’. This also holds for the locative associative constructions described further below in \REF{ex:key:930}. Compare the ungrammatical example \REF{ex:key:929}, which involves such a structure: 


\ea[*]{%929
    \label{ex:key:929}
    \gll E    dé    \textstylePichiexamplebold{bifó}    \textstylePichiexamplebold{sáy}  \textstylePichiexamplebold{fɔ} di  hós.\\
 \textsc{3sg.sbj}  \textsc{be.loc}  before  side  \textsc{prep}  \textsc{def}  house\\
\glt *She’s in front of the house. [ye07de 024]
}\z
...
\ea%930
    \label{ex:key:930}
    \gll \textstylePichiexamplebold{Dɔ́n}    \textstylePichiexamplebold{sáy}  Santa  Teresita.\\
...
\ea%931
    \label{ex:key:931}
    \gll Wi  de  dú=an    \textstylePichiexamplebold{dɔ́n}    \textstylePichiexamplebold{yá}   na  mi    kɔ́ntri.\\
...
\ea%932
    \label{ex:key:932}
    \gll E    sé    mí    nó  de  mék    e    slíp    \textstylePichiexamplebold{bɔtɔ́n  dé}.\\
...
\ea%933
    \label{ex:key:933}
    \gll E    pás    \textstylePichiexamplebold{kɔ́na}  \textstylePichiexamplebold{mí}.\\
...
\ea%935
    \label{ex:key:935}
    \gll Dɛn  \textstylePichiexamplebold{líng}    fɔ  dán  butaca.\\
...
\ea%936
    \label{ex:key:936}
    \gll E    \textstylePichiexamplebold{líng}=an    dé.\\
...
\ea%937
    \label{ex:key:937}
    \gll Di  ríba    e    \textstylePichiexamplebold{ráwn}    di  hós.\\
...
\ea%938
    \label{ex:key:938}
    \gll Di  glás    dé    \textstylePichiexamplebold{nía}.\\
...
\ea%939
    \label{ex:key:939}
    \gll Di  glás    \textstylePichiexamplebold{nía}    di  domɔ́t.\\
...
\ea%941
    \label{ex:key:941}
    \gll E    \textstylePichiexamplebold{sidɔ́n  di  pikín}  na  butaca.\\
...
\ea%942
    \label{ex:key:942}
    \gll E    \textstylePichiexamplebold{pín    di  stík}  na  grɔ́n.\\
...
\ea%943
    \label{ex:key:943}
    \gll Di  \textstylePichiexamplebold{kasára}  \textstylePichiexamplebold{tínap}  míndul  tú  stík.\\
...
\ea%944
    \label{ex:key:944}
    \gll \textstylePichiexamplebold{Di}  \textstylePichiexamplebold{mán}  \textstylePichiexamplebold{tínap}  míndul  pípul  dɛn.\\
...
\ea%945
    \label{ex:key:945}
    \gll E    \textbf{tín}\textstylePichiexamplebold{ap}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{kasára}  míndul  tú  stík.\\
...
\ea%946
    \label{ex:key:946}
    \gll \textstylePichiexamplebold{Di}  \textstylePichiexamplebold{bɔ́tul}  \textstylePichiexamplebold{slíp}   pantáp  di  tébul  bikɔs  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{bɔ́tul}  \textstylePichiexamplebold{lé}  dé.\\
...
\ea%947
    \label{ex:key:947}
    \gll E    \textstylePichiexamplebold{slíp}    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{bɔ́tul}  pantáp  di  tébul.\\
...
The verb \textit{jám} ‘make/be in contact’ denotes contact between figure and ground. The meaning of \textit{jám} contains no connotation with respect to the type of contact. Hence intransitive \textit{jám} means ‘be in contact’ in \REF{ex:key:948}. Note the use of the Spanish-derived verb \textit{para} ‘stand’ as a labile locative verb just like its Pichi equivalent \textit{tínap} ‘stand (up)’ in \REF{ex:key:945} above:
...
\ea%949
    \label{ex:key:949}
    \gll So  di  mán  kán  pás  nía  ín,    e    \textstylePichiexamplebold{jám}=an, 
...
Moreover, the verbs listed in the table differ in the way the ground is expressed as a participant in the clause. Hence we find the ground expressed as prepositional phrases\is{prepositional phrases} (PP), objects\is{objects} (O), and as objects or prepositional phrases in serial verb constructions (SVCs):
...
\ea%952
    \label{ex:key:952}
    \gll A    \textstylePichiexamplebold{kɔmɔ́t}    \textstylePichiexamplebold{colegio},  (...)\\
...
\ea%953
    \label{ex:key:953}
    \gll A    de  \textstylePichiexamplebold{kɔmɔ́t}    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{tɔ́n}    náw    náw.\\
...
\ea%955
    \label{ex:key:955}
    \gll Wi  kɔmɔ́t  dé    wi  kán  \textstylePichiexamplebold{gó}  \textstylePichiexamplebold{fɔ,}  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{Akebeville}.\\
...
All other verbs in \tabref{tab:key:8.5} whose goals may be expressed as a PP, an SVC, and an O exhibit the same pattern with respect to ground marking. This applies to locomotion verbs, such as wáka ‘walk’, rɔ́n ‘run’, or pás ‘pass (by)’, to the caused location verb pút ‘put’, or the caused motion verbs ték ‘take’, bríng ‘bring’, and kɛ́r ‘carry; take’. The following three examples featuring the verb kɛ́r once more present the PP \REF{ex:key:957}, the object \REF{ex:key:958} and the SVC alternatives \REF{ex:key:959}. Again the PP option is the most common one. Note that the goal object hospital ‘hospital’ in \REF{ex:key:958} is positioned to the right of the patient object di pikín ‘the child’: 


\ea%957
    \label{ex:key:957}
    \gll Di  cemento,  estaba  dicho  que    na  fɔ  kɛ́r=an
directamente  \textstylePichiexamplebold{na}  {\textstylePichiexamplebold{Ela} \textstylePichiexamplebold{Nguema}}.\\
...
\ea%960
    \label{ex:key:960}
    \gll E    \textstylePichiexamplebold{fɔdɔ́n}  di  \textstylePichiexamplebold{béd}.\\
...
\ea%961
    \label{ex:key:961}
    \gll Di  bolí  \textstylePichiexamplebold{fɔdɔ́n}  \textstylePichiexamplebold{frɔn}    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{tébul}.\\
...
\ea%962
    \label{ex:key:962}
    \gll Di  húman,  e    de  \textstylePichiexamplebold{júmp}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{wínda}.\\
...
\ea%963
    \label{ex:key:963}
    \gll E    stíl  butú  yét  wé  e    de  \textstylePichiexamplebold{klém}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{chía}.\\
...
\ea%964
    \label{ex:key:964}
    \gll Miguel  Ángel  de  \textstylePichiexamplebold{júmp}  \textstylePichiexamplebold{pantáp}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{béd}.\\
...
\ea%965
    \label{ex:key:965}
    \gll Nóto  ‘e    \textstylePichiexamplebold{klém}  \textstylePichiexamplebold{pantáp}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{chía}.’\\
...
The “propulsion verbs\is{propulsion verbs}” (\citealt{Longacre1996}:200ff.) \textit{híb} ‘throw’ and \textit{flíng} ‘fling’ are caused-motion verbs without a direction component in their meaning. Here, the ground is preferably expressed as a PP or an equivalent locative adverbial\is{locative adverbials} as in the following examples: 


\ea%966
    \label{ex:key:966}
    \gll Dɛn  \textstylePichiexamplebold{híb}=an    \textstylePichiexamplebold{dɔ́n}.\\
...
\ea%967
    \label{ex:key:967}
    \gll A    \textstylePichiexamplebold{flíng}=an    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{solwatá}.\\
...
\ea%970
    \label{ex:key:970}
    \gll Di  pambɔ́d  de  \textstylePichiexamplebold{fláy}  \textstylePichiexamplebold{ɔntɔ́p}  di  stík.\\
...
\ea%971
    \label{ex:key:971}
    \gll A    nó  nó    wétin  mék    Anto  \textstylePichiexamplebold{púl}
Reina  náw    \textstylePichiexamplebold{nía}    Tokobé.\\
...
\ea%973
    \label{ex:key:973}
    \gll Dɛn  \textstylePichiexamplebold{pús}    di  motó  \textstylePichiexamplebold{na} garaje.\\
...
\ea%974
    \label{ex:key:974}
    \gll Di  soldado  \textstylePichiexamplebold{sút}    \textstylePichiexamplebold{bifó}    di  hós.\\
...
\ea%975
    \label{ex:key:975}
    \gll Di  bolí  \textstylePichiexamplebold{fɔdɔ́n}  \textstylePichiexamplebold{frɔn}    di  tébul.\\
\textsc{def}  pen  fall    from  \textsc{def}  table\\
...
\ea%976
    \label{ex:key:976}
    \gll E    kán  \textstylePichiexamplebold{fɔdɔ́n}  \textstylePichiexamplebold{sóté}    yá.\\
\textsc{3sg.sbj}  \textsc{pfv}  fall    until  here\\
...
\ea%977
    \label{ex:key:977}
    \gll Dɛn  bin  de  \textstylePichiexamplebold{rɔ́n}  \textstylePichiexamplebold{gó}  \textstylePichiexamplebold{na} ɔspítul  la  una  de  la  noche.\\
...
\ea%979
    \label{ex:key:979}
    \gll Olinga  \textstylePichiexamplebold{kɔmɔ́t}    \textstylePichiexamplebold{frɔn}    bɔtɔ́n.\\
...
\ea%980
    \label{ex:key:980}
    \gll E    kɔ́l  \textstylePichiexamplebold{frɔn}    \textstylePichiexamplebold{na} plataforma,  e    kɔ́l  dɔ́n    yá.\\
...
\ea%981
    \label{ex:key:981}
    \gll (...)  mék  e    fít  de  rích    ɔ́l  sáy  \textstylePichiexamplebold{sóté}    \textstylePichiexamplebold{na} Riaba.\\
...
\ea%982
    \label{ex:key:982}
    \gll (...)  e    \textstylePichiexamplebold{recibe}  wán  regalo  \textstylePichiexamplebold{fɔ} in    mamá.\\
...
\ea%983
    \label{ex:key:983}
    \gll A    bin  báy  wán  motó  \textstylePichiexamplebold{fɔ} mi    mása.\\
...
\ea%984
    \label{ex:key:984}
    \gll Mi    mamá  bin  \textstylePichiexamplebold{dás}        mí    sɔn    regalo.\\
...
\ea%985
    \label{ex:key:985}
    \gll A    bin  báy  \textstylePichiexamplebold{wán} mi    másta \textstylePichiexamplebold{in} \textstylePichiexamplebold{motó}\textstylePichiexamplebold{\textmd{.}}\\
\textsc{1sg.sbj}  \textsc{pst}  buy  one    \textsc{1sg.poss}  boss    \textsc{3sg.poss}  car\\

\glt ‘I bought one of my boss’s cars.’ [ro05ee 057]
\z

The manner-of-motion verb \textit{pás} ‘pass (by)’ is employed to express motion-past a ground. The ground is normally expressed as a PP introduced by a locative preposition\is{locative prepositions} \REF{ex:key:986} or locative noun\index{} \REF{ex:key:987}: 


\ea%986
    \label{ex:key:986}
    \gll \'{I}n    bin  \textstylePichiexamplebold{pás}  \textstylePichiexamplebold{na} mi    hós.\\
...
\ea%987
    \label{ex:key:987}
    \gll Di  motó  \textstylePichiexamplebold{pás}  \textstylePichiexamplebold{ɔntɔ́p}  di  rayt-hán.\\
...
\ea%988
    \label{ex:key:988}
    \gll Di  pikín  \textstylePichiexamplebold{fɔdɔ́n}  \textstylePichiexamplebold{frɔn}    \textstylePichiexamplebold{ɔ́p}  di  \textstylePichiexamplenumberZchnZchn{stík.}\\
\textsc{def}  child  fall    from  up  \textsc{def}  tree\\

\glt ‘The child fell from up in the tree.’ [dj05be 201]
\z

In \REF{ex:key:989}, the figure (\textit{wì} ‘\textsc{1pl}’) instigates a motion-from (denoted by \textit{kɔmɔ́t} ‘go out’) out of the specific part (the anterior location \textit{bifó} ‘before’) of the ground (the source \textit{chɔ́ch} ‘church’): 


\ea%989
    \label{ex:key:989}
    \gll Wi  \textstylePichiexamplebold{kɔmɔ́t}  \textstylePichiexamplebold{bifó}    di  chɔ́ch.\\
...
\ea%990
    \label{ex:key:990}
    \gll Chico,  a    wánt  \textstylePichiexamplebold{fláy}  \textstylePichiexamplebold{gó}  \textstylePichiexamplebold{ínsay}  {Ela  Nguema}  náw    só.\\
...
The sentence \REF{ex:key:994} exhibits a complex spatial relation featuring the figure \textit{e} ‘\textsc{3sg.sbj}’ that has carried out a motion-past (i.e. \textit{pás} ‘pass by’) the proximity (i.e. \textit{kɔ́na} ‘next to’) of the ground \textit{chía} ‘chair’. The clause is followed by the secondary predicate \textit{dé wáka} ‘\textsc{ipfv} walk’ which provides information about the\is{} manner of movement. The secondary predicate is in turn modified by the compound adverbial \textit{rɔn-sáy} ‘backwards’:\index{secondary predicates}



\ea%994
    \label{ex:key:994}
    \gll E    pás \textstylePichiexamplebold{kɔ́na} chía de \textstylePichiexamplebold{wáka}  \textstylePichiexamplebold{rɔn-sáy}.\\
\textsc{3sg.sbj}  pass    next.to  chair  \textsc{ipfv}  walk  wrong.\textsc{cpd}{}-side\\

\glt ‘She passed by next to (a) chair walking backwards.’ [au07se 051]\is{adverbial phrases“ r}
\z
...
In Pichi, the two equal halves of the day are split into dé ‘day’ and nɛ́t ‘night’. The conventionalised associative constructions mɔ́nin tɛ́n ‘morning time’ = ‘morning’, sán tɛ́n ‘sun time’ = ‘midday; noon’ \REF{ex:key:995}, ívin tɛ́n ‘evening time’ = ‘afternoon; evening’, míndul nɛ́t ‘middle night’ = ‘midnight’ \REF{ex:key:996} denote the central points of the twenty-four hour day:[FFF9?]
...
\ea%999
    \label{ex:key:999}
    \gll E    kán    wé  di  \textstylePichiexamplebold{mɔ́nin}  de  \textstylePichiexamplebold{brék}.\\
...
\ea%1000
    \label{ex:key:1000}
    \gll E    kán    \textstylePichiexamplebold{madrugada}.\\
\textsc{3sg.sbj}  come  dawn\\

\glt ‘She came (at) dawn.’ [dj05ce 050]
\z

When telling the time of day, Spanish lexical items are fit into a conventionalised code-mixed construction, which does not have an exact equivalent in Spanish (cf. also \sectref{sec:13.3.1} on codemixing). There is no other generally accepted way of telling the time:


\ea%1001
    \label{ex:key:1001}
    \gll So  yu  wánt  dé    dé    las    cuatro,  wi  dɔ́n  \textstylePichiexamplebold{dé} 
\textstylePichiexamplebold{las}    \textstylePichiexamplebold{tres}    \textstylePichiexamplebold{y}  \textstylePichiexamplebold{veinte}.\\
...
The Pichi day names mɔ́nde ‘Monday’, tyúsde ‘Tuesday’, wɛ́nsde ‘Wednesday’, tɔ́sde ‘Thursday’, fráyde ‘Friday’, satidé ‘Saturday’, and sɔ́nde ‘Sunday’ are (falling) out of use. Instead, the vast majority of speakers employ the corresponding Spanish day names lunes, martes, miércoles, jueves, viernes, sábado, and domingo at all times. The code-mixed sentences in \REF{ex:key:1002} reflect typical usage. 
...
\ea{
    \gll
\'{U}s=dé  yu  de  gó,  \textstylePichiexamplebold{viernes}?\\
  \textsc{q}=day  \textsc{2sg}  \textsc{ipfv}  go  Friday\\

\glt   ‘Which day are you going, (on) Friday?’ [fr07se 166]
}\ex{
\gll
Una    gó  na  di  sén    avión,  \textstylePichiexamplebold{sábado}!\\
...
\ea%1004
    \label{ex:key:1004}
    \gll \textstylePichiexamplebold{El}  \textstylePichiexamplebold{diez}  \textstylePichiexamplebold{de}  \textstylePichiexamplebold{agosto},  bay  gɔ́d  in    páwa,  a    go  pás  na  yá.\\
...
The two seasons of the year may be designated by the compounds[FFF9?] ren-sísin ‘rain.cpd-season’ = ‘rainy season’ \REF{ex:key:1005} and dray-sísin ‘dry.cpd-season’ = ‘dry season’. An alternative designation for the rainy season is the phrasal expression tɛ́n fɔ rén \REF{ex:key:1006}: 


\ea%1005
    \label{ex:key:1005}
    \gll Dís  dé  dɛn  \textstylePichiexamplebold{ren-sísin}    go  bigín.\\
...
\ea%1007
    \label{ex:key:1007}
    \gll Wí    de  kɔ́l  yá    só    \textstylePichiexamplebold{amatán}    dán,    lɛk  sé 
...
\end{tabularx}
\end{table}
A relation between event time and a point of reference in the present, future, and past can be established by combining an element from \tabref{tab:key:8.6} with absolute time reference (i.e. time points like las dos ‘two o’clock’ and sán tɛ́n ‘(after)noon’ or calendric units like viernes ‘Friday’) with the appropriate TMA marking. Compare \REF{ex:key:995}, \REF{ex:key:1001}, and \REF{ex:key:1002} above. 
...
\ea%1008
    \label{ex:key:1008}
    \gll \textstylePichiexamplebold{Náw}    a    dɔ́n  sí  di  tín    wé  yu  níd.\\
...
\ea%1009
    \label{ex:key:1009}
    \gll E    sé    \textstylePichiexamplebold{ɔ́l}  \textstylePichiexamplebold{tidé}    e    bin  de  kɔ́l  yú,
yu  nó  ték    teléfono.\\
...
\ea%1010
    \label{ex:key:1010}
    \gll \textstylePichiexamplebold{Tumára}    a    go  sí  mi    mamá.\\
...
\ea%1011
    \label{ex:key:1011}
    \gll \textstylePichiexamplebold{\'{A}pás}  \textstylePichiexamplebold{tumɔ́ro}    a    go  sí  mi    mamá\\
after  tomorrow  \textsc{1sg.sbj}  \textsc{pot}  see  \textsc{1sg.poss}  mother\\

\glt ‘The day-after-tomorrow, I’ll see my mother.’ [ye05ce 046]
\z

The temporal noun yɛ́stadé ‘yesterday’ relates event time to a reference point one day back into the past \REF{ex:key:1012}. The temporal preposition ápás ‘after’ also combines with yɛ́stadé ‘yesterday’ in the collocation ápás yɛ́stadé ‘the day before yesterday’ \REF{ex:key:1013}: 
...
The temporal nouns tumɔ́ro/tumára and yɛ́stadé express relative time reference in the same way as tidé/tudé above. Depending on context, they may therefore also be translated as ‘one day after event time’ and ‘one day before event time’, respectively. Examples \REF{ex:key:1011} and \REF{ex:key:1013} above also show that the preposition ápás ‘after’ may be used to indicate both a posterior and an anterior temporal relation. \'{A}pás may therefore be combined with tumɔ́ro ‘tomorrow’ as well as yɛ́stadé ‘yesterday’. The “spatial frame of reference” \citep[24]{Levinson2003} of temporal posteriority is characterised by a mirror-like “reflection” (\citealt{BenderBannardo2005}:222) of the speaker’s vantage point into both directions of the time stream.[FFF9?]


Temporal deixis involving time units other than two days in either direction from event time is achieved through a variety of means. The quantifier[FFF9?] nɛ́ks ‘next’ may modify the Pichi nouns wík ‘week’, mún ‘month’, and hía ‘year’ and thereby remove the reference point from event time into the future by one unit. Compare (\REF{ex:key:1014}) and also note the use of the spatial and temporal preposition sóté ‘until; up to’ which expresses extent: 
...
The quantifier lás ‘last’ mirrors the time reference of nɛ́ks ‘next’. Lás ‘last’ pushes a reference point into the past by one unit from event time as in \REF{ex:key:1015}–\REF{ex:key:1016}. Note the presence of the definite article di ‘def’ in \REF{ex:key:1015}: [FFF9?]


\ea%1015
    \label{ex:key:1015}
    \gll Boyé  kɔmɔ́t  na  tɔ́n    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{lás} \textstylePichiexamplebold{mún}.\\
...
\ea%1016
    \label{ex:key:1016}
    \gll Ɛf  e    nó  bin  gó  \textstylePichiexamplebold{lás} \textstylePichiexamplebold{hía},    e    bin  fɔ    dé
wet    wí    na  yá    so.\\
...
The collocation lɔ́n tɛ́n ‘long time ago’ is also inherently relational. Rather than expressing duration (i.e. *for a long time), its meaning includes an unspecified reference point in the past:
...
The collocation las-nɛ́t ‘last.cpd-night’ = ‘last night’ is a compound \REF{ex:key:1018}. The lexicalisation of this collocation distinguishes it from other time expressions featuring lás ‘last’ (cf. e.g. lás hía ‘last year’ in \REF{ex:key:1016}), which are not usually subjected to the tonal derivation characteristic of compounding[FFF9?]: 
...
Spatial expressions are, however, used to encode temporal relations if the temporal expression in the clause is not inherently time deictic. This may apply to temporal location as in \REF{ex:key:1019}, where the locative noun\index{}\textit{ ínsay} ‘inside’ fulfills this function. 


\ea%1019
    \label{ex:key:1019}
    \gll A    de  wét  sé    mék  a    gó  \textstylePichiexamplebold{ínsay}  tú  dé.\\
...
An equally common way of expressing duration for a specified period is by means of the verb kɛ́r ‘carry; take; last’. The “figure” enduring in time is expressed as the subject of the clause and may be inanimate \REF{ex:key:1024} or animate \REF{ex:key:1025}, while the specified time period is the object of kɛ́r: 
...
Aside from that, elements that express motion through space are put to use for establishing temporal relations of duration. Firstly, the allative motion\index{}{}-to preposition/clause linker \textit{sóté} ‘up to; until’ also expresses temporal duration-to \REF{ex:key:1026}. 
...
\ea%1028
    \label{ex:key:1028}
    \gll A    chɔ́p  frijoles  \textstylePichiexamplebold{sóté}    \textstylePichiexamplebold{a}    \textstylePichiexamplebold{táya}.\\
...
\ea%1029
    \label{ex:key:1029}
    \gll A    chɔ́p  \textstylePichiexamplebold{sóté}    \textstylePichiexamplebold{táya}.\\
...
\ea%1031
    \label{ex:key:1031}
    \gll \textstylePichiexamplebold{Frɔn}  las    doce,  \textstylePichiexamplebold{sóté}    e    \textstylePichiexamplebold{gó}  las    seis,
na  ‘gúd    ívin’.\\
...
\ea%1032
    \label{ex:key:1032}
    \gll Wi  dé    yá    \textstylePichiexamplebold{síns}    las    dos.\\
\textsc{1pl}  \textsc{be.loc}  here    since  the.\textsc{pl}  two\\

\glt ‘We’re here since two o’clock.’ [ab07fn 242]
\z

The transfer of spatial concepts into the temporal domain is also reflected in the kind of verbs employed. Location in the future features the ablative motion verb\is{motion verbs} \textit{kán} ‘come’, that of past location and duration the motion verb \textit{pás} ‘pass (by)’ - hence time is conceived as moving and the reference point as fixed:


\ea%1033
    \label{ex:key:1033}
    \gll A    de  lɛ́f    na  Lubá  sóté    di  wík
\textstylePichiexamplebold{wé}  \textstylePichiexamplebold{e}    \textstylePichiexamplebold{de}  \textstylePichiexamplebold{kán}.\\
...
\textstylePichiexamplebold{wé}  \textstylePichiexamplebold{e}    \textstylePichiexamplebold{bin}  \textstylePichiexamplebold{pás}.\\
...
\ea%1036
    \label{ex:key:1036}
    \gll E    dɔ́n  \textstylePichiexamplebold{sté},  a    tínk    sé    e    dɔ́n  \textstylePichiexamplebold{sté}
...
The quantifier[FFF9?] ɛ́ni ‘every’ expresses iteration of the time unit it refers to \REF{ex:key:1037}. Time units are generally conceived as countable, ɛ́ni is semantically compatible with any time unit including units of the clock \REF{ex:key:1038}:
