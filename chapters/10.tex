...
\draw[loosely dotted] (-2,10.7) -- (2,10.7) -- (2,0.9) -- (-2,0.9) -- (-2,6.5) -- (-4,6.5) -- (-4,8.5) -- (-2,8.5) -- (-2,10.7);
\draw (-2.4,13.4) -- (2.4,13.4) -- (2.4,11) -- (5,11) -- (5,9.1) -- (2.4,9.1) -- (2.4,6.3) -- (3.7,6.3) -- (3.7,4.6) -- (2.4,4.6) -- (2.4,3.3) -- (-2.4,3.3) -- (-2.4,13.4);
\draw[dashed] (-1.6,12.8) -- (1.6,12.8) -- (1.6,8.6) -- (-1.6,8.6) -- (-1.6,12.8);

\node[minimum width=1.2cm] at (3.5,1.5) (fɔ) {\textit{fɔ}}; \draw[dashed] (fɔ.south west) -- (fɔ.south east);
\node[minimum width=1.2cm,fill=black!20] at (4.5,1.5) {\textit{mék}};
\node[minimum width=1.2cm] at (3.5,0.5) (we) {\textit{wé}}; \draw[loosely dotted] (we.south west) -- (we.south east);
...
The class of manipulative complement-taking verbs also includes the verbs \textit{mék} ‘make, cause to’ \REF{ex:key:1399} and \textit{lɛ́f} ‘leave, permit’ in their respective functions as causative and permissive-causative verbs (cf. \sectref{sec:9.4.4}):{\fff}
