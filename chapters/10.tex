...
\ea%1355
    \label{ex:key:1355}
    \gll Yu  gó  yu  pé,  siete  mil      yu  baja,  \textstylePichiexamplebold{áfta}    yu  fínis    yu  sube,
\textstylePichiexamplebold{wé}  yu  de  pák    mɔ́    siete  mil,      \textstylePichiexamplebold{wé}  yu  sube.\\
...
\ea%1356
    \label{ex:key:1356}
    \gll \MakeUppercase{A}   nó  sabí    ús=tín  bin  kán  pás,    \textstylePichiexamplebold{áfta}    e    gó  
na  hospital.\\
...
The adverb áfta may also introduce the then-clause of reality conditionals in which the if-clause is introduced by lɛ́k ‘like’ \REF{ex:key:1357}:{\fff}


\ea%1357
    \label{ex:key:1357}
    \gll \textstylePichiexamplebold{Lɛk}  náw,  \textstylePichiexamplebold{lɛk}  Boyé  só    na  mi    mán,  \textstylePichiexamplebold{áfta}    mi    sísta  
...
\ea%1358
    \label{ex:key:1358}
    \gll Ɛf  yu  sí  sé,    sɔn    sáy  di  plés    klín,    \textstylePichiexamplebold{áfta}    dɛn  de  dú  
...
The phrasal adverbial dán tɛ́n ‘at that time’ also relates a situation to a preceding one. In \REF{ex:key:1359}(b), dán tɛ́n indicates a temporal relation of simultaneity with the preceding clause (a):
...
\label{fig:key:10.1}
\begin{tikzpicture}
\node (svc) {Serial verb construction};
\node (purpose) [below=of svc] {Purpose};
\node (complement) [below=of purpose] {Complement};
\node (time) [below=of complement] {Time};
\node (reality) [below=of time] {Reality};
\node (conditional) [below=of reality] {Conditional};
\node (manner) [below=of conditional] {Manner};
\node (circumstance) [below=of manner] {Circumstance};
\node (concessive) [below=of circumstance] {Concessive};
\node (quotative) [right=of complement] {Quotative};
\node (naming) [right=of quotative] {Naming};
\node (relative) [left=of reality] {Relative};
\node (cause) [right=of manner] {Cause};
\end{tikzpicture} 
\end{figure}
...
\ea%1361
    \label{ex:key:1361}
    \gll Só  e    gó  na  \textstylePichiexamplebold{bús,}    e    sé    e    de
gó  kíl  bíf.\\
...
The clause linker \textit{wé} ‘\textsc{sub}’ can, amongst its other uses, link coordinate clauses. The preposition \textit{wet} ‘with’ may only conjoin \textsc{NPs} (cf. \sectref{sec:5.5}), hence an important function of \textit{wé} is to serve as a clausal connective that can be translated as ‘and (then)’. The formal differentiation between \textsc{NP} and clausal coordination in Pichi corresponds to an areal (West) African pattern (\citealt{Mithun1988}:349–353). 
...
\gll
\textstylePichiexamplebold{Wé}\textstylePichiexamplespaceZchn{} wi  kán  kán    na  tɔ́n,    \textbf{wé}  a    bigín  gó  skúl,  
...
The sequential and temporal meanings of \textit{wé} ‘\textsc{sub}’ in clauses like \REF{ex:key:1362}(b) above may extend into contiguous meanings such as adversative \REF{ex:key:1363}. The various related meanings of \textit{wé} in these contexts may blur beyond recognition the demarcation between the coordinate clauses described in this section and the adverbial clauses covered in \sectref{sec:10.7.1}.
...
\gll
\textstylePichiexamplebold{Wé}  yá    só,    frijoles  na  haricot  na  yá.\\
  \textsc{sub}  here    like.that  bean.\textsc{pl}  \textsc{foc}  bean  \textsc{loc}  here\\
\glt   ‘While here, frijoles is haricot here.’ [ed03sp 120]
}\z\z

The quotative marker \textit{sé} ‘\textsc{quot}’ also functions as a sequential connective and clause coordinator in ways very similar to \textit{wé} ‘\textsc{sub}’ when it signals inner speech or “internal awareness” (\citealt{Güldemann2008}:422ff.) and thereby often occurs without an overt subject\is{subject omission} as in \REF{ex:key:1364}:
...
\gll
Sé    mɔ́nin  tɛ́n    a    go  gó,  a    báy,
  a    ték  tú  peso    (...)\\
  \textsc{quot}    morning  time    \textsc{1sg.sbj}  \textsc{pot}  go  \textsc{1sg.sbj}  buy
  \textsc{1sg.sbj}  take  two  peso\\
\glt 
  ‘So in the morning, I would go and buy (it), I would take two pesos 
   (...)’ [ed03sp 083]
}\z\z
...
\ea%1365
    \label{ex:key:1365}
    \gll E    nák  di  tébul  \textstylePichiexamplebold{an}  di  stáyl  wé  e    nák  di  tébul  strɔ́n,
e    kán  sék    di  plét    \textstylePichiexamplebold{an}  di  plét    kán  brók.\\
...
\ea%1367
    \label{ex:key:1367}
    \gll E    \textstylePichiexamplebold{kin}  \textstylePichiexamplebold{sé}    ‘kán    wi  gó  na  Barca  wi  gó  dríng.’\\
...
\ea[*]{
\gll
Mék  a    \textstylePichiexamplebold{sé}    \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{wɔ́d}.\\
   \textsc{sbjv}    \textsc{1sg.sbj}  \textsc{quot}    one    word\\
\glt   *Let me say one word. [to07fn 219]
}\ex[]{
\gll
A    \textstylePichiexamplebold{tɔ́k}    \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{wɔ́d}.\\
  \textsc{1sg.sbj}  talk    one    word\\
\glt   ‘I said one word.’ [to07fn 220]
}\z\z

Beyond that, adverbials do not usually modify \textit{sé} ‘\textsc{quot}’ \REF{ex:key:1369}(a). Adverbials only appear as quoted complements indexed by \textit{sé} (b). Again, there is no restriction on adverbial modification of the speech verb \textit{tɔ́k} ‘talk; say’ (c): 
...
\ea[*]{
\gll
A    sé=an    \textstylePichiexamplebold{kwík}.\\
    \textsc{1sg.sbj}  \textsc{quot}=\textsc{3sg.obj}  quickly\\
\glt   *I said it quickly.’ [to07fn 221]
}\ex[]{
\gll
A    sé    ‘\textstylePichiexamplebold{kwík}’.\\
  \textsc{1sg.sbj}  \textsc{quot}    quickly\\
\glt   ‘I said “quickly”.’ [to07fn 222]
}\ex[]{
\gll
A    tɔ́k=an    \textstylePichiexamplebold{kwík}\\
  \textsc{1sg.sbj}  talk=\textsc{3sg.obj}  quickly\\
\glt   ‘I said it quickly.’ [to07fn 223]
}\z\z

Secondly, \textit{sé} ‘\textsc{quot}’ is not normally encountered as a verb in any type of MVC. Hence below, the speech verb \textit{tɔ́k} ‘talk; say’ appears as verbal complement to the modal verb \textit{fít} ‘can’. The appearance of \textit{sé} in this position is not attested. 
...
\textstylePichiexamplebold{sé}   pɔ́sin  de  kúk    plantí  dé’.\\
...
The recurrent use of quotative clauses introduced by \textit{sé} ‘\textsc{quot}’ with or without a preceding subject in order to render direct and inner speech is a conspicuous feature of longer stretches of narrative discourse. Direct speech\is{direct speech} in Pichi rarely serves the sole aim of giving neutral reports of utterances. One of its crucial functions is the creation of an atmosphere of vivacity and authenticity that builds up tension and draws listeners into the narrative. Compare (\REF{ex:key:1371})(a)–(e), in which speaker (ed) recalls his difficulty in distinguishing a transsexual man from a woman: 
...
\ea{
    \gll
\textstylePichiexamplebold{E}   \textstylePichiexamplebold{go}  \textstylePichiexamplebold{sé}    e    de  fíɛ,  e    nó  go  gí
...
\gll
\textstylePichiexamplebold{Sé}    ín    nó  wánt  in    abuelo    skrách=an.\\
  \textsc{quot}    \textsc{3sg.indp}  \textsc{neg}  want  \textsc{3sg.poss}  grandfather  scratch=\textsc{3sg.obj}\\
\glt 
  ‘(He’d) say he [\textsc{emp}] doesn’t want his grandfather to scratch him.’ \textsc{Or} 
...
\textstylePichiexamplebold{dɛn}  \textstylePichiexamplebold{sé} dɛn  de  kán    ték=an.\\
...
\ea%1374
    \label{ex:key:1374}
    \gll E    nó  sabí    tɔ́k  ni    Panyá,  \textstylePichiexamplebold{e}    \textstylePichiexamplebold{sé} e    wánt
...
\ea%1375
    \label{ex:key:1375}
    \gll Tidé    e    kán    \textstylePichiexamplebold{e}    sé,    ‘\textstylePichiexamplebold{a}    tínk    sé
...
A further facet of the quotative function is the use of \textit{sé} in a naming construction which serves to identify a nominal element by name and introduce members of a list (cf. \citealt{Güldemann2008}:398ff.). The named or listed items appear as nominal objects\is{objects} of \textit{sé}. 


\ea%1376
    \label{ex:key:1376}
    \gll Krío  mamá  dɛn  wé  dɛn  de  tɔ́k  Píchi  dɛn  kin  \textstylePichiexamplebold{tɔ́k}  \textstylePichiexamplebold{sé}    \textstylePichiexamplebold{grín}.\\
...
\glt [as opposed to ‘verd’ like younger people] [dj05ce 257]
\z
...
mi    mán    go  \textstylePichiexamplebold{kɔ́l}  \textstylePichiexamplebold{sé}    \textstylePichiexamplebold{suegro}.\\
...
\ea%1380
    \label{ex:key:1380}
    \gll Di  pikín  ɔ́l  \textstylePichiexamplebold{sé}    \textstylePichiexamplebold{na} mi    yón   
...
Some verbs are listed twice under two types of clause linkage where the functions of complement clauses differ correspondingly. For example, \textit{wánt} usually appears without an overt complementiser (${\emptyset}$) in prospective aspect constructions. However, \textit{wánt} takes ${\emptyset}$ and \textit{de} \textsc{‘ipfv’} complements in same-subject (desire) modal auxiliary constructions, and must take \textit{mék} \textsc{‘sbjv’} with different-subject complements. Likewise, the general subordinator \textit{wé} \textsc{‘sub’} is not listed in the table, since its function as a complementiser is marginal. \tabref{tab:key:10.2} does not capture many other distributional complexities of complementisers and idiosyncracies of complementation, including negation in complement constructions. Details are provided in the corresponding sections of this chapter. 
...
The aspectual and modal verbs bigín ‘begin’, wánt/wɔ́nt ‘want; be about to’, fít ‘can’, and gɛ́fɔ ‘have to’ feature complements introduced by the zero strategy or complement verbs preceded by the imperfective marker de ‘ipfv’. Bigín is particularly likely to occur with de ‘ipfv’ when used as an ingressive auxiliary (cf. \sectref{sec:6.4.1} for examples). The use of the imperfective marker de emphasises the continuous nature of the situation dennoted by the verb. Compare the following constructions:{\fff}
...
\ea%1381
    \label{ex:key:1381}
        ...
        \textstylePichiglossZchn{} Yú  \textstylePichiexamplebold{wɔ́nt  de} gó?\\
...
\ea%1382
    \label{ex:key:1382}
\gll
Yu  \textstylePichiexamplebold{fít}  \textstylePichiexamplebold{de} bɔ́n\textstylePichiexamplebold{}     yu  pikín  dɛn\textstylePichitranslationZchn{  (...)’}\\
...
\textstylePichiexamplebold{tráy}    \textstylePichiexamplebold{fɔ} \textstylePichiexamplenumberZchnZchn{tínap}    yet.\\
...
As a complementiser, fɔ introduces the complements of aspectual and modal verbs that may not occur without an overt complementiser. One of these verbs is lɛ́f ‘leave; stop to’ \REF{ex:key:1386}, a verb that expresses the aspectual notion of cessation: 
...
\ea%1388
    \label{ex:key:1388}
    \gll Di  chɔ́p  \textstylePichiexamplebold{ísi}    \textstylePichiexamplebold{fɔ} chɔ́p.\\
...
\textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{mék}   yu  lán    Panyá.\\
...
The use of subjunctive complement clauses is, however, required with weak deontic verbs whenever the main and complement clauses do not have a subject in common. Compare (\REF{ex:key:1385}) above with \REF{ex:key:1393} below. Both sentences feature the main verb \textit{tráy} ‘try’:


\ea%1393
    \label{ex:key:1393}
    \gll (...)  \textstylePichiexamplebold{a}   go  \textstylePichiexamplebold{tráy}    \textstylePichiexamplebold{mék}   \textstylePichiexamplebold{e}    \textstylePichiexamplebold{báy} mí    dán    káyn
gafas  por  dios.\\
...
A subjunctive complement is also necessary if the complement verb is negated. This is so because non-finite verbs – including those that appear in fɔ-complements – are not normally negated in Pichi. Compare the negated complement clause introduced by mék ‘sbjv’ in \REF{ex:key:1394} with the affirmative complement clause introduced by fɔ ‘prep’ in \REF{ex:key:1390} above. Both sentences involve the main verb mɛ́mba ‘remember’:
...
\ea%1396
    \label{ex:key:1396}
    \gll Wé  yu  de  dríng,  e    dé \textstylePichiexamplebold{fáyn}  \textstylePichiexamplebold{sé}    \textstylePichiexamplebold{mék}   nó  chák.\\
...
\ea%1397
    \label{ex:key:1397}
    \gll \MakeUppercase{A}   \textstylePichiexamplebold{fɔ́s}=an    \textstylePichiexamplebold{mék}    e    lúk    mí.\\
...
\ea%1398
    \label{ex:key:1398}
    \gll \MakeUppercase{A}   \textstylePichiexamplebold{tún}=an    \textstylePichiexamplebold{sé}    \textstylePichiexamplebold{mék}   e    báy    mí    motó.\\
...
The class of manipulative complement-taking verbs also includes the verbs mék ‘make; cause to’ \REF{ex:key:1399} and lɛ́f ‘leave; permit’ in their respective functions as causative and permissive-causative verbs (cf. \sectref{sec:9.4.4}):{\fff}


\ea%1399
    \label{ex:key:1399}
    \gll E    \textstylePichiexamplebold{mék}    \textstylePichiexamplebold{mék}    in    húman  dríng  di  cerveza.\\
...
\ea%1400
    \label{ex:key:1400}
    \gll E    nák  di  plét    pan  di  tébul  bikɔs  e    \textstylePichiexamplebold{wánt}
\textstylePichiexamplebold{mék}    di  plét    brók.\\
...
Speech verbs employed as verbs of ordering and manipulation always take subjunctive complements. Examples of such indirect imperatives{\fff} are provided in the following two sentences involving the verbs tɛ́l ‘tell (to)’ \REF{ex:key:1401} and bɛ́g ‘ask to’ \REF{ex:key:1402}: {\fff}
...
In a few instances in the data, the complements of strong deontic verbs are not introduced by mék ‘sbjv’; the subjunctive marker is absent. I give two examples featuring the main verbs lɛ́f ‘leave; permit’ \REF{ex:key:1403} and wánt ‘want’ \REF{ex:key:1404}: 
...
\ea%1404
    \label{ex:key:1404}
    \gll Sé    ín    nó  \textstylePichiexamplebold{wánt}  \textstylePichiexamplebold{in}    \textstylePichiexamplebold{abuelo}    \textstylePichiexamplebold{skrách}\textstylePichiexamplebold{\textmd{=an}}.\\
\textsc{quot}    \textsc{3sg.indp}  \textsc{neg}  want  \textsc{3sg.poss}  grandfather  scratch=\textsc{3sg.obj}\\
...
This shows that the reduction of TMA marking, or “deranking” (\citealt{Stassen1985}: 76–86; cf. also \citealt{Cristofaro2003}) of the subjunctive subordinate clause is just as much a diagnostic of subjunctive mood as is the presence of the modal complementiser \textit{mék} ‘\textsc{sbjv}’. \is{subjunctive mood}
...
\ea%1406
    \label{ex:key:1406}
    \gll Nɔ́  a    \textstylePichiexamplebold{tínk}    \textstylePichiexamplebold{sé}    realmente  yu  níd    pikín.\\
...
\ea%1407
    \label{ex:key:1407}
    \gll Yu  jɔ́s  \textstylePichiexamplebold{hía}    \textstylePichiexamplebold{sé}    pɔ́sin  dɛn  bin  de  tɔ́k,  bɔt  yu  nó  listin.\\
...
\ea%1408
    \label{ex:key:1408}
    \gll \MakeUppercase{A}   de  \textstylePichiexamplebold{hía}    ín    \textstylePichiexamplebold{sé}    e    de  nák  di  gitá    ɔ 
a    de  \textstylePichiexamplebold{hía}    ín    \textstylePichiexamplebold{lɛk}  \textstylePichiexamplebold{háw}    e    de  nák  di  gita. \\
...
\ea%1411
    \label{ex:key:1411}
    \gll E    \textstylePichiexamplebold{fáyn}  sé    \textstylePichiexamplebold{mék}   e    kán    \textstylePichiexamplebold{tumɔ́ro}.\\
...
\ea%1412
    \label{ex:key:1412}
    \gll E    dɔ́n  sté,    a    tínk    sé    e    dɔ́n  \textstylePichiexamplebold{sté}
...
\ea%1414
    \label{ex:key:1414}
    \gll Mék    yú    nó  \textstylePichiexamplebold{fíl}  \textstylePichiexamplebold{sɔ́ri}    wé  a    nó  gí  yú    nó  nátín.\\
...
\ea%1415
    \label{ex:key:1415}
    \gll A    de  \textstylePichiexamplebold{fíl}  \textstylePichiexamplebold{sɔ́ri}    \textstylePichiexamplebold{sé}    e    de  kíl  di  fɔl.\\
...
\ea%1416
    \label{ex:key:1416}
    \gll \textstylePichiexamplebold{Tɛnk}  \textstylePichiexamplebold{gɔ́d}  \textbf{wé}  yu  dɔ́n  kán!\\
...
Relative clauses always follow the head \textsc{NP} that they refer to. The head \textsc{NP} and its relative clause are often separated by quantifier\is{quantifiers}s \REF{ex:key:1422}, as well as topic and focus particles \REF{ex:key:1423}. The examples in this section and the following ones also show that TMA and person marking in relative clauses is “balanced” \citep{Stassen1985}; hence it is not reduced and identical to that of simple declarative clauses:



\ea%1422
    \label{ex:key:1422}
    \gll Somos  \textstylePichiexamplebold{tú}  \textstylePichiexamplebold{dásɔl}  [wé  wi  dé    láyf]    (...)\\
...
\ea%1425
    \label{ex:key:1425}
    \gll Porque  dán    tín    na  tín    \textstylePichiexamplebold{dɛn}    [wé  \textstylePichiexamplebold{dɛn}  dɔ́n  sté  
...
Pichi exhibits generous possibilities of relative clause formation (cf. \citealt{Keenan1985}:148). For example, the relativisation of a nominal that is part of a coordinate structure is permitted \REF{ex:key:1426}. Equally, a relative clause may contain a focused resumptive pronoun\is{resumptive pronouns} \REF{ex:key:1427}:
...
\textstylePichiexamplebold{ús=sáy}  dán  mán    dé].\\
...
Relative constructions are also made use of to express adverbial relations of time, location, and manner through the relativisation of generic nouns{\fff} like áwa ‘time; hour’, tɛ́n ‘time’ \REF{ex:key:1473}, dé ‘day’ \REF{ex:key:1474} and stáyl ‘manner; style (\sectref{sec:10.7.4}).
...
\ea%1430
    \label{ex:key:1430}
    \gll Ɛf  yu  chɔ́p  ɔ́l  \textstylePichiexamplebold{dís}  \textstylePichiexamplebold{chɔ́p}  [wé  \textstylePichiexamplebold{e}    nó  dɔ́n],  tumɔ́ro
yu  go  sík.\\
...
\ea%1431
    \label{ex:key:1431}
\gll
\textstylePichiexamplebold{Mí}    na  wán    húman  [wé  \textstylePichiexamplebold{a}   síryɔs].\\
...
\ea%1432
    \label{ex:key:1432}
    \gll Pero    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{gabonés}    [wé  de  tɔ́k  Bata]  wet    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{guineano}  
...
\ea%1433
    \label{ex:key:1433}
    \gll Mék    e    bít    yú,    mék    e    dú  yú  di  \textstylePichiexamplebold{dú}
[e    \textstylePichiexamplebold{wánt}]  (...)\\
...
\ea%1435
    \label{ex:key:1435}
    \gll Yu  sí  dán  \textstylePichiexamplebold{pikín}  dé    [wé  in    mamá  de  gí=an    chɔ́p]?\\
...
\ea%1436
    \label{ex:key:1436}
    \gll \MakeUppercase{A}   bin  sí  di  \textstylePichiexamplebold{pikín}  [wé  di  húman  bin  gí  chɔ́p  na  strít].\\
...
\ea%1437
    \label{ex:key:1437}
    \gll Di  \textstylePichiexamplebold{béd}  [\textbf{wé}  e    de  slíp    \textstylePichiexamplebold{pan}],  e    dé    na  di  rúm.\\
...
\ea%1438
    \label{ex:key:1438}
    \gll Dɛn  de  gó  wet    dán    \textstylePichiexamplebold{gɔ́n}  [\textbf{wé}  dɛn  de  kíl  bíf]      ɔ  pistola.\\
...
Similarly, the \textit{wé-}clause in \REF{ex:key:1439} induces a locative, that in \REF{ex:key:1440}(b) an instrumental interpretation. It is also of interest that \REF{ex:key:1440} is an example for the use of \textit{fɔ} as an introducer of a noun complement that is very similar in function to the preceding relative clause (cf. \sectref{sec:10.5.8}): 


\ea%1439
    \label{ex:key:1439}
    \gll A    kán  kɔmɔ́t  na  dán  \textstylePichiexamplebold{hós}    [\textbf{wé}    a    bin  dé].\\
...
Dán  tín    [\textbf{wé}  dɛn  de  mék    súp],  fɔ  mék    fufú.\\
...
\ea%1443
    \label{ex:key:1443}
    \gll A    de  gó  nía    di  \textstylePichiexamplebold{sáy}  [Paquita  \textstylePichiexamplebold{sidɔ́n}].\\
...
sɔn    smɔ́l  \textstylePichiexamplebold{pépa}  [\textstylePichiexamplenumberZchnZchn{dɛn}    de  \textstylePichiexamplebold{pút}=an    cacahuete].\\
...
\ea%1445
    \label{ex:key:1445}
    \gll Bikɔs  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{isla} dé    [wé  e    fíba    sé
petroleo  dé    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{dís}  \textstylePichiexamplebold{isla}].\\
...
In sentence \REF{ex:key:1446} below, the direct object blák gɛ́l dɛn ‘black girls’ is resumed through another full NP, namely the demonstrative pronominal dá wán ‘that (one)’:
...
\glt ‘I say black women have a beauty which white women do not 
...
\ea%1447
    \label{ex:key:1447}
\gll
(...)  dɛn  de  kɔmɔ́t    na  wán    \textstylePichiexamplebold{pueblo}  [wé    \textstylePichiexamplebold{in}    \textstylePichiexamplebold{ném}  na
...
\ea%1448
    \label{ex:key:1448}
    \gll Dán  \textstylePichiexamplebold{húman}  [wé  a    só    yú],    \textstylePichiexamplebold{in}      \textstylePichiexamplebold{motó}  dé    na  strít.\\
...
\ea%1449
    \label{ex:key:1449}
    \gll \MakeUppercase{A}   ték    di  stík    \textstylePichiexamplebold{in}    \textstylePichiexamplebold{kandá}  [wé  a    sí  dé],
a    rós=an.\\
...
\ea%1451
    \label{ex:key:1451}
    \gll Dɛn  nó  nó    [\textstylePichiexamplebold{údat}  \textstylePichiexamplebold{hambɔ́g}=an].\\
...
\ea%1452
    \label{ex:key:1452}
    \gll Mí    nó  sabí    [\textstylePichiexamplebold{ús=mán}  dɛn  \textstylePichiexamplebold{kíl}],    a    nɔ́ba  hía
dán    torí    sɛ́f.\\
...
The corresponding question words also introduce the free variants of relative clauses with generic head nouns like tɛ́n ‘time’ and sáy ‘side’ which function as adverbial clauses of time and place. Compare \REF{ex:key:1453}. 
...
\ea%1454
    \label{ex:key:1454}
    \gll Bɔt  mí    wánt  sabí    [\textstylePichiexamplebold{háw}  dán    tín    dé].\\
...
\ea%1455
    \label{ex:key:1455}
    \gll Mí    nó  áks=an    [\textstylePichiexamplebold{háw}  \textstylePichiexamplebold{mɔ́ch}  e    wɔ́nt].\\
...
\ea%1456
    \label{ex:key:1456}
    \gll Sé    yu  wánt  \textstylePichiexamplebold{sabí}    \textstylePichiexamplebold{ɛf}  rén    de  fɔ́l,  nɔ́?\\
...
Time & \textstyleTablePichiZchn{bifó} ‘before’ 
 ...
 \textstyleTablePichiZchn{lɛk háw} ‘as soon as’ & \textstyleTablePichiZchn{wé} ‘\textsc{sub}’ & di tɛ́n wé 
...
Conditional & \textstyleTablePichiZchn{ɛf/ if} ‘if’,

 lɛ́k (sé) ‘like’ & \textstyleTablePichiZchn{wé} ‘\textsc{sub}’, 

 \textstyleTablePichiZchn{sé} ‘\textsc{quot}’ & Juxtaposition & \\
Concessive & ɛf/ if — sɛ́f ‘even if’, aunque ‘although’, adɔnkɛ́ — wáns ‘even if’ & \textstyleTablePichiZchn{wé} ‘\textsc{sub}’,
...
\ea%1460
    \label{ex:key:1460}
    \gll \textbf{Wé}  e    \textstylePichiexamplebold{kin}  kɔmɔ́t    wók    a    \textstylePichiexamplebold{kin}  mék=an    só,
lɛk  háw    mún    fínis.\\
...
\ea%1461
    \label{ex:key:1461}
    \gll \textbf{Wé}  a    \textstylePichiexamplebold{rích}    na  hós    dé,    a    \textstylePichiexamplebold{sé}  
...
\ea%1462
    \label{ex:key:1462}
    \gll A    go  firma  \textbf{wé}  a  go  \textstylePichiexamplebold{dɔ́n}  chɔ́p.\\
...
\ea%1463
    \label{ex:key:1463}
    \gll Dɛn  púl    di  motó  na  garaje    \textbf{wé}  \textstylePichiexamplebold{dɛn}  \textstylePichiexamplebold{de}  \textstylePichiexamplebold{pús}=an.\\
...
\textstylePichiexamplebold{sísta}  \textstylePichiexamplebold{dɛn}  \textstylePichiexamplebold{sabí},  in    go  had.\\
...
The relation between the first clause in \REF{ex:key:1465}(a) and the clause introduced by \textit{wé} is best interpreted as adversative. This is illustrated by the follow-up clause in \REF{ex:key:1465}(b):


\ea%1465
    \label{ex:key:1465}
\ea{
    \gll Yu  nó  bin  dé    na  mákit,  wé  a    tɛ́l  yú    sé  
...
Finally, in \REF{ex:key:1466}(b), we find two wholly independent clauses separated by an intonation break, with the second one being introduced by \textit{wé}. The \textit{wé-}clause is contrasted with the implicitly understood concessive proposition in squared brackets. Clause \REF{ex:key:1466}(b) may be interpreted as being in a causal relationship to clause (a):
...
\textstylePichiexamplebold{Wé}  yu  pikín,  yu  nó  aconseja    ín    frɔn    doce  años.\\
...
\textstylePichiexamplebold{Sé}    in    mamá  go  dráyb=an  fɔ́s.\\
...
\ea%1469
    \label{ex:key:1469}
    \gll Dɛn  púl    di  motó  na  garaje    \textstylePichiexamplebold{sé}    \textstylePichiexamplebold{dɛn}  \textstylePichiexamplebold{de}  \textstylePichiexamplebold{pús}=an.\\
...
\ea%1470
    \label{ex:key:1470}
    \gll E    dú  di  ejercicio    \textstylePichiexamplebold{sé}    \textstylePichiexamplebold{e}    \textstylePichiexamplebold{táya}.\\
...
\ea%1471
    \label{ex:key:1471}
    \gll ‘A    hól    wán    motó’  na  \textstylePichiexamplebold{lɛk}  \textstylePichiexamplebold{sé}    yu  de  dráyb
wé  yu  de  wók.\\
...
Relative clause{\fff}s featuring the generic head nouns áwa ‘time, tɛ́n ‘time’, and dé ‘day’ function as time clauses. The nature of the temporal relation between the main and the relative clause situations is determined by lexical and clausal aspect marking:



\ea%1472
    \label{ex:key:1472}
    \gll Di  húman  kán    na  hós    di  \textstylePichiexamplebold{áwa}    [wé  a    de  kúk].\\
...
\ea%1474
    \label{ex:key:1474}
    \gll \textstylePichiexamplebold{Di}  \textstylePichiexamplebold{dé}  [wé  a    nó  wánt  gí  yú    quinientos]
...
\ea%1475
    \label{ex:key:1475}
    \gll Tumɔ́ro,    \textstylePichiexamplebold{lɛk}  \textstylePichiexamplebold{háw}    yu  tɔ́k  wet    Buehú,  yu  kɔ́l  mí,    (…)\\
...
\ea%1476
    \label{ex:key:1476}
    \gll \textstylePichiexamplebold{Bifó}    a    kin  gráp,  a    de  sí  bíg  bíg  fáya.\\
...
\ea%1480
    \label{ex:key:1480}
    \gll \MakeUppercase{A}   bin  chɔ́p  di  plantí  di  \textstylePichiexamplebold{stáyl}  [wé  pɔ́sin  dɛn
fɔ  Malábo  dɛn  de  chɔ́p=an]\\
\textsc{1sg.sbj} \textsc{pst} \textstylePichitranslationZchn{  eat} \textsc{def} \textstylePichitranslationZchn{  plantain} \textsc{def} \textstylePichitranslationZchn{  style} \textsc{sub} \textstylePichitranslationZchn{  person} \textsc{pl} 
...
\ea%1481
    \label{ex:key:1481}
    \gll Mí    chɔ́p  di  plantí  \textstylePichiexamplebold{lɛk}  \textstylePichiexamplebold{háw}    Malabo-pípul      dɛn  de  chɔ́p=an.\\
...
\textstylePichiexamplebold{lɛk}  \textstylePichiexamplebold{háw}   e    bin  dé    jamás.\\
...
Manner clauses introduced by lɛk háw ‘like how’ are also often employed to denote the perceived situation of a main clause verb of sensory perception like hía ‘hear’ \REF{ex:key:1483}, sí ‘see’, lúk ‘look’, smɛ́l ‘smell’ \REF{ex:key:1484}, and fíl ‘feel’. Such clauses vacillate between readings denoting manner and temporal overlap:


\ea%1483
    \label{ex:key:1483}
    \gll A    de  hía  ín    \textstylePichiexamplebold{lɛk}  \textstylePichiexamplebold{háw}    e    de  nák  di  gita.\\
\textsc{1sg.sbj}  \textsc{ipfv}  hear  \textsc{3sg.indp}  like  how    \textsc{3sg.sbj}  \textsc{ipfv}  hit  \textsc{def}  guitar\\
...
\ea%1487
    \label{ex:key:1487}
    \gll \textstylePichiexamplebold{Lɛk}  \textstylePichiexamplebold{háw}   e    \textstylePichiexamplebold{pút}  dán  mɔní  na  mi    hán,    nó  wét    mɔ́!\\
...
\ea%1488
    \label{ex:key:1488}
    \gll E    nák  di  tébul  an  di  \textstylePichiexamplebold{stáyl} [wé\textstylePichiexamplebold{}   e    \textstylePichiexamplebold{nák}  di  tébul
...
di  chía,  di  \textstylePichiexamplebold{sáy}  [wé    dɛn  sidɔ́n]. \\
...
\ea%1490
    \label{ex:key:1490}
    \gll Yu  nó  nó    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{plés}    [wé    a    sidɔ́n]?\\
...
\ea%1491
    \label{ex:key:1491}
    \gll \MakeUppercase{A}   dɔ́n    tú  \textstylePichiexamplebold{ól}  \textstylePichiexamplebold{fɔ} máred.\\
...
\ea%1494
    \label{ex:key:1494}
    \gll Mi    papá  bin  \textstylePichiexamplebold{kán}    yá    \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{kán}    wók.\\
...
\ea%1495
    \label{ex:key:1495}
    \gll Layk  háw    dɛn    go  pút  yú    na  tébul  \textstylePichiexamplebold{yu}  dɔ́n  de  rɔ́tín,
...
\ea%1496
    \label{ex:key:1496}
    \gll Na  ín    \textstylePichiexamplebold{dɛn}  táy=an    \textstylePichiexamplebold{mék}    \textstylePichiexamplebold{e}   nó  kɔmɔ́t.\\
...
\ea%1497
    \label{ex:key:1497}
    \gll \textstylePichiexamplebold{A}   go  gó  lúk=an    fɔ  wán    vecino    \textstylePichiexamplebold{mék}    \textstylePichiexamplebold{a}   
lúk    las    damas.\\
...
\ea%1501
    \label{ex:key:1501}
    \gll A    wáka  wet=an    \textstylePichiexamplebold{sé}    ‘tidé    a    go  gó  vive    ín.’\\
...
\ea%1502
    \label{ex:key:1502}
    \gll So  e    go  na  bús    \textstylePichiexamplebold{e}    \textstylePichiexamplebold{sé}    e    de  gó  kíl  bíf.\\
...
\ea%1503
    \label{ex:key:1503}
    \gll (...)  e    \textstylePichiexamplebold{sút}=an    \textstylePichiexamplebold{sé}    e    \textstylePichiexamplebold{dɔ́n}  \textstylePichiexamplebold{wɔ́nt}  gó  ték=an,
...
\ea%1505
    \label{ex:key:1505}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{bikɔs}  e    bɔ́n      pikín,  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{tín} 
mék    e    dáy.\\
...
\ea%1507
    \label{ex:key:1507}
    \gll \textstylePichiexamplebold{Como}  e    sabí    sé    dán  tín    dé    na  mi    hát  (…)\\
...
\glt   ‘That would be fine.’ [fr03ft 172]
}\ex{\gll
Porque  mi    sɛ́f,  fɔ́s  tɛ́n    a    bin  de  sidɔ́n
  dásɔl  wet    húman  dɛn.\\
...
The preposition \textit{fɔséka} \textit{\textup{(and its occasional free variant} }\textit{fɔséko}\textit{)} ‘due to; for the sake of’ takes nominal, not clausal, complements (cf. eg. \REF{ex:key:1063}). However, when \textit{fɔséka} is followed by the quotative marker\is{quotative marker} and complementiser \textit{sé} ‘\textsc{quot}’, the resulting collocation may introduce a cause clause like the other linkers treated in this section \REF{ex:key:1509}:
...
\ea%1513
    \label{ex:key:1513}
    \gll ¡Haga  cola    \textstylePichiexamplebold{hasta} \textstylePichiexamplebold{que}  \textstylePichiexamplebold{llegue}    el  cajero!\\
...
\ea%1516
    \label{ex:key:1516}
    \gll \textstylePichiexamplebold{\'{O}nli}    \textstylePichiexamplebold{bikɔs}  yu  de  tɔ́k  só,    yu  de  salút  só,
yu  de  ánsa    só.\\
...
\ea%1518
    \label{ex:key:1518}
    \gll \textstylePichiexamplebold{Frɔn}    wé  a  bí  pikín  a    bin  wánt  kɔmɔ́t
na  dís  kɔ́ntri.\\
...
\tabref{tab:key:10.5} summarises the most common ways of expressing conditional relations in Pichi. It features the three functionally identical \textsc{if-}clause introducers \textit{ɛf}, \textit{ɛfɛ,} and \textit{if}, all of which mean ‘if’ as well the various types of TMA marking attested in the \textsc{if-} and \textsc{then-}clauses. I comment on the relative frequency of the different constructions below:
...
\ea%1521
    \label{ex:key:1521}
    \gll \textstylePichiexamplebold{Lɛk}  \textstylePichiexamplebold{sé}    yu  de    dríng  nɔ́,  dán    pɔ́sin  wé   dé    yandá,  
...
\ea%1522
    \label{ex:key:1522}
    \gll \textstylePichiexamplebold{Ɛf}  yu  bin  bigín  lás  wík,    \textstylePichiexamplebold{lɛk}  yu  dɔ́n  fínis    di  wók.\\
...
\ea%1523
    \label{ex:key:1523}
    \gll Pero    \textstylePichiexamplebold{ɛf}  na  húman  na  bíg  húman  yu  mán  
nó  de  tɔ́n  bíg  mán.\\
...
\ea%1524
    \label{ex:key:1524}
    \gll Ɛf  yu  \textstylePichiexamplebold{chɔ́p}  ɔ́l  dís  chɔ́p  wé  e    nó  dɔ́n,
tumɔ́ro    yu  \textstylePichiexamplebold{go}  sík.\\
...
\ea%1528
    \label{ex:key:1528}
    \gll \textstylePichiexamplebold{If}  yu  nó  \textstylePichiexamplebold{de}    gí  mí    yu  fɔ́s  mán
...
\textstylePichiexamplebold{fɔ} gí=an    di  mɔní.\\
...
\ea%1530
    \label{ex:key:1530}
    \gll \textstylePichiexamplebold{Ɛf}  a    \textstylePichiexamplebold{bin}  nó    sé    e    nó  \textstylePichiexamplebold{go} fɔ́l 
a    \textstylePichiexamplebold{fɔ} bríng  ɔ́da    sús.\\
...
\ea%1531
    \label{ex:key:1531}
    \gll E    \textstylePichiexamplebold{bin}    \textstylePichiexamplebold{fɔ}   dé    fáyn.\\
\textsc{3sg.sbj}  \textsc{pst}    \textsc{cond}    \textsc{be.loc}  fine\\
...
\ea%1533
    \label{ex:key:1533}
    \gll A    \textstylePichiexamplebold{bin}  \textstylePichiexamplebold{fɔ} máred  a  los    veinti-uno  \textstylePichiexamplebold{ɛf}  Maura
in    papa  nó  \textstylePichiexamplebold{bin}  dáy.\\
...
Concessive meaning may be expressed by clauses introduced by wé ‘sub’ (cf. \REF{ex:key:1464}) and sé ‘quot’ (cf. \REF{ex:key:1470}). Alternatively, concessive meaning may be expressed through conditional clauses in conjunction with clausal focus by means of the focus particle sɛ́f ‘emp’, or by way of the Spanish-derived clause linker aunque ‘although’. In \REF{ex:key:1534}, the conditional relation is not signalled overtly. The presence of the focus particle sɛ́f ‘emp’ alone is sufficient to signal concession: 
...
\ea%1536
    \label{ex:key:1536}
    \gll \textstylePichiexamplebold{Aunque}    nóto  paludismo,  if  dɛn  gív  tratamiento  yu  nó  go  dáy.\\
...
The linker adɔnkɛ́ ‘no matter if’ also introduces concessive clauses. Adɔnkɛ́ is often part of a disjoint structure, namely adɔnkɛ́ — wáns, ‘even if — once’. The concessive clause is introduced by the first, and the main clause by the second element \REF{ex:key:1537}: 


\ea%1537
    \label{ex:key:1537}
    \gll (...)  adɔnkɛ́  e    nó  sí  yú    wán  hól    dé,  e    nó  bísin,\\
\textstylePichiexamplebold{wáns}  yu  bríng  di  pamáyn.
...
\ea%1538
    \label{ex:key:1538}
    \gll Bɔkú  motó  dɛn  dé    yá    \textstylePichiexamplebold{só,}    a    nó  nó    sé
