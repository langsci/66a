...
The adverb áfta may also introduce the then-clause of reality conditionals in which the if-clause is introduced by lɛ́k ‘like’ \REF{ex:key:1357}:[FFF9?]
...
The class of manipulative complement-taking verbs also includes the verbs mék ‘make; cause to’ \REF{ex:key:1399} and lɛ́f ‘leave; permit’ in their respective functions as causative and permissive-causative verbs (cf. \sectref{sec:9.4.4}):[FFF9?]
...
Speech verbs employed as verbs of ordering and manipulation always take subjunctive complements. Examples of such indirect imperatives[FFF9?] are provided in the following two sentences involving the verbs tɛ́l ‘tell (to)’ \REF{ex:key:1401} and bɛ́g ‘ask to’ \REF{ex:key:1402}: [FFF9?]
...
Relative constructions are also made use of to express adverbial relations of time, location, and manner through the relativisation of generic nouns[FFF9?] like áwa ‘time; hour’, tɛ́n ‘time’ \REF{ex:key:1473}, dé ‘day’ \REF{ex:key:1474} and stáyl ‘manner; style (\sectref{sec:10.7.4}).
