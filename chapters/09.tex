...
\ea%1039
    \label{ex:key:1039}
    \gll \textstylePichiexamplebold{Dɛn}  kéch=an,    \textstylePichiexamplebold{dɛn}  bít=an.\\
...
\ea%1041
    \label{ex:key:1041}
    \gll \textstylePichiexamplebold{Tɔ́sti}  kéch  mí.\\
...
\ea%1042
    \label{ex:key:1042}
    \gll \textstylePichiexamplebold{\'{I}n}    sidɔ́n  na  Ela Nguema.\\
...
\ea%1044
    \label{ex:key:1044}
    \gll \textstylePichiexamplebold{A}    kɔ́t.\\
\textsc{1sg.sbj}  cut\\
...
\ea%1045
    \label{ex:key:1045}
    \gll Wé  dɛn  \textstylePichiexamplebold{sút}    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{pɔ́sin}  di  pɔ́sin  kin  sék.\\
...
\ea%1046
    \label{ex:key:1046}
    \gll Gó  \textstylePichiexamplebold{púl}=an      dé.\\
...
\ea%1047
    \label{ex:key:1047}
    \gll Ɛf  yu  nó  \textstylePichiexamplebold{nák},    e    nó  fít  brók.\\
...
The goal\is{} and source\index{} of motion verbs\index{motion verbs} like \textit{gó} ‘go’ and \textit{kɔmɔ́t} ‘go/come out’ may also be expressed as objects, although prepositional phrases\is{prepositional phrases} are more common. Compare the goal object \textit{colegio} ‘college’ in \REF{ex:key:1048}:



\ea%1048
    \label{ex:key:1048}
    \gll So  wé  yu  \textstylePichiexamplebold{kɔmɔ́t}    \textstylePichiexamplebold{colegio}  (...)\\
...
\ea%1049
    \label{ex:key:1049}
    \gll Di  tín    de  \textstylePichiexamplebold{go}  \textstylePichiexamplebold{mí}    bad.\\
...
\ea%1050
    \label{ex:key:1050}
    \gll Dán    torí    bin  de  \textbf{swít}    mí    \textstylePichiexamplebold{wán}    \textbf{swít}.\\
...
\ea%1051
    \label{ex:key:1051}
    \gll Lúkɔt  \textstylePichiexamplebold{fɔ  tif-mán      dɛn}!\\
...
\ea%1052
    \label{ex:key:1052}
    \gll A    \textstylePichiexamplebold{bísin  dán    gál}.\\
...
\ea%1054
    \label{ex:key:1054}
    \gll Láyf    hád    pero  a    dɔ́n  \textstylePichiexamplebold{kɔ́stɔn}=an    só.\\
...
\ea%1055
    \label{ex:key:1055}
    \gll Wi  dɔ́n \textstylePichiexamplebold{  kɔ́stɔn}    \textstylePichiexamplebold{fɔr}=an\textstylePichiexamplebold{.}\\
...
\ea%1056
    \label{ex:key:1056}
    \gll A    dɔ́n  \textstylePichiexamplebold{kɔ́stɔn}    \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{trɔ́n}    \textstylePichiexamplebold{láyf}.\\
\textsc{1sg.sbj}  \textsc{prf}  be.used.to  with    \textsc{def}  strong  life\\

\glt ‘I’ve got used to a difficult life.’ [dj07ae 102]
\z

The preposition \textit{fɔ} ‘\textsc{prep}’ may also mark the stimulus of motion\is{} of some agent-induced motion verbs\index{motion verbs} like \textit{háyd} ‘hide (from)’ or \textit{rɔ́n} ‘run away (from)’ as in the following example (cf. \sectref{sec:8.1.5} for the use of \textit{fɔ} in marking locative source\index{} roles): 


\ea%1057
    \label{ex:key:1057}
    \gll E    \textstylePichiexamplebold{háyd}  \textstylePichiexamplebold{fɔ} in    kɔ́mpin.\\
\textsc{3sg.sbj}  hide    \textsc{prep}  \textsc{3sg.poss}  friend\\

\glt ‘He hid from his friend.’ [dj07re 040]
\z

Verbs other than the ones covered above invariably appear with stimulus objects rather than PPs. Compare lúk ‘look (at)’ in \REF{ex:key:1058}. Other verbs in this group are sí ‘see’, hía/yɛ́r ‘hear’ and listin ‘listen’:


\ea%1058
    \label{ex:key:1058}
    \gll A    \textstylePichiexamplebold{lúk}=an.\\
\textsc{1sg.sbj}  look=\textsc{3sg.obj}\\

\glt ‘I looked at him.’ [ab03ab 069]\is{stimulus}
\z

Prepositional phrases introduced by \textit{fɔ} ‘\textsc{prep}’ also denote the semantic roles of purpose\is{} \REF{ex:key:1059} and cause \REF{ex:key:1060}, the latter in combination with a body state\index{body states}: 
...
\ea
	\label{ex:key:1060}
	\gll  E    dáy  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{tɔ́sti}.\\
...
\ea%1061
    \label{ex:key:1061}
    \gll E    dáy  \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{tɔ́sti}.\\
...
\ea%1062
    \label{ex:key:1062}
    \gll E    dáy  \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{sɔfút}.\\
...
\ea%1063
    \label{ex:key:1063}
    \gll Na  \textstylePichiexamplebold{fɔséka}  \textstylePichiexamplebold{bɔ́n}     \textstylePichiexamplebold{pikín},  e    dáy.\\
...
\textstylePichiexamplebold{bikɔs}  \textstylePichiexamplebold{nátin}.\\
now  like.that  poor  girl  \textsc{3pl}  \textsc{prf}  burst  \textsc{3sg.poss}  head
due.to  nothing\\

\glt ‘Now the poor girl, her head has been burst open 
because of nothing.’ [ye05rr 004]\is{cause“ r}
\z

The role of instrument\index{} is expressed through \textit{wet} ‘with’ if instruments \REF{ex:key:1065}, material\index{}s \REF{ex:key:1066}, and functions \REF{ex:key:1067} are involved. Instruments and materials can also be expressed by argument-introducing SVCs involving \textit{ték} ‘take’ (cf. \sectref{sec:9.1.4}):


\ea%1065
    \label{ex:key:1065}
    \gll Dɛn  sút=an    \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{gɔ́n}  na  in    héd.\\
...
\ea%1067
    \label{ex:key:1067}
    \gll A    wáka  \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{fút}.\\
...
\ea%1070
    \label{ex:key:1070}
    \gll El  diez  de  agosto,  \textstylePichiexamplebold{bay}  \textstylePichiexamplebold{gɔ́d}  \textstylePichiexamplebold{in}    \textstylePichiexamplebold{páwa},  a    go  pás  na  yá.\\
the  ten  of  August  by  God  \textsc{3sg.poss}  power  \textsc{1sg.sbj}  \textsc{pot}  pass  \textsc{loc}  here\\

\glt ‘(On) the tenth of August, by the grace of God, I’ll pass by this place\textstyleannotationreference{.}’ [ab07fn 113]\index{}
\z

The preposition \textit{wet} ‘with’ introduces participants with a comitative role \REF{ex:key:1071}. A comitative role may also be expressed through an SVC involving \textit{fála} ‘follow’ if the accompanee is human (cf. e.g. \REF{ex:key:1573}). Comitative \textit{wet} ‘with’ may shade off into general circumstance \REF{ex:key:1072}\index{}: 
...
\ea%1072
    \label{ex:key:1072}
    \gll Yu  nó    dán  tín    \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{yun-bɔ́y}      nɔ́?\\
...
\ea%1073
    \label{ex:key:1073}
    \gll Dán  mán    de  wáka  \textstylePichiexamplebold{bitáwt}  \textstylePichiexamplebold{sús}\\
...
The use of a PP is only one of numerous means of expressing manner in Pichi \is{}(cf. e.g. \sectref{sec:7.7.2}), in which case the preposition \textit{wet} ‘with’ usually serves this purpose \REF{ex:key:1075}. An equative or similative\index{„similatives} participant is introduced by \textit{lɛk} ‘like’ \REF{ex:key:1076}:


\ea%1075
    \label{ex:key:1075}
    \gll Yu  nó  de  tɔ́k=an    \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{páwa}.\\
...
\ea%1076
    \label{ex:key:1076}
    \gll (…)  wi  fít  dé    \textstylePichiexamplebold{lɛk  kɔ́mpin}.\\
...
Serial verb constructions (SVC) are utilised to introduce syntactic objects\is{objects} denoting theme, the standard in comparative constructions, instrument\is{}s and material\index{}s, as well as the accompanee in comitative (cf. \textsc{\sectref{sec:11.2}).} The areally widespread SVC employing a verb meaning ‘give’ to mark a beneficiary or recipient\index{recipient} role does not exist in Pichi. Compare the following SVC, in which the (fronted) object of \textit{ték} ‘take’ denotes a material: 


\ea%1077
    \label{ex:key:1077}
    \gll Na  \textstylePichiexamplebold{ús=káyn}  tín    dɛn  \textstylePichiexamplebold{ték}    \textstylePichiexamplebold{mék}    dís,  digamos  \textstylePichiexamplebold{dí  bɔ́tul}?\\
...
On a whole, SVCs are not as frequent as other means of marking participants in Pichi – to the exception of the standard in comparison. The use of a comparative construction \is{comparative SVC}featuring the verb \textit{pás} ‘surpass’ is the ordinary way of introducing the standard object:


\ea%1078
    \label{ex:key:1078}
    \gll Na  dɛ́n  bin  de  transfiere  mɔní  mɔ́    na  Western  Union
\textstylePichiexamplebold{pás}  \textstylePichiexamplebold{guineano}  \textstylePichiexamplebold{dɛn}.\\
...
Pichi features a small number of intransitive verbs which do not occur with objects\is{objects}. Elicitation with 360 verbs in the corpus revealed the intransitive verbs listed in \tabref{tab:key:9.3} below. The group of dynamic intransitive verbs is made up of locomotion verbs as well as other body experiences, weather verbs, verbs of existence in time and space, and an inherently reciprocal\is{reciprocity} “verb of social interaction” \citep[201]{Levin1993}. All these verbs have in common that they involve experiencer\is{experiencer}\is{experiencer} and theme\is{theme} subject\is{subjects}s, hence actors that are affected by the situation denoted by the verb: 
...
\ea[*]{%1080
    \label{ex:key:1080}
    \gll Di  piloto  de  \textstylePichiexamplebold{fláy}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{avión}.\\
  \textsc{def}  pilot  \textsc{ipfv}  fly  \textsc{def}  plane\\
\glt *The pilot is flying the plane. [dj07ae 006]
}\z
...
\ea%1083
    \label{ex:key:1083}
    \gll A    wánt  \textstylePichiexamplebold{fláy}  \textstylePichiexamplebold{rích}    \textstylePichiexamplebold{na}  \textstylePichiexamplebold{tɔ́n}   náw    náw.\\
...
\ea%1084
    \label{ex:key:1084}
    \gll Dí  miércoles  a      de  \textstylePichiexamplebold{gó}  \textstylePichiexamplebold{Lubá}.\\
...
\ea%1085
    \label{ex:key:1085}
    \gll Di  tín    de  \textstylePichiexamplebold{gó}  \textstylePichiexamplebold{mí}    bád.\\
...
\ea%1086
    \label{ex:key:1086}
    \gll Dí  fáyn    klós    de  \textstylePichiexamplebold{gó}  \textstylePichiexamplebold{yú}.\\
...
\ea%1087
    \label{ex:key:1087}
    \gll (...)  e    de  \textstylePichiexamplebold{rɔ́n}  \textstylePichiexamplebold{mí}    kɔ́ntri  tín    dɛn.\\
...
\ea[*]{%1088
    \label{ex:key:1088}
    \gll \textstylePichiexamplebold{Lúkɔt}    tif-mán      dɛn!\\
 look.out  steal.\textsc{cpd}bɛc    \textsc{pl}\\
\glt *Watch out for thieves! [dj07ae 095]
}\z


\ea%1089
    \label{ex:key:1089}
    \gll \textstylePichiexamplebold{Lúkɔt}  \textstylePichiexamplebold{fɔ} tif-mán      dɛn!\\
look.out  \textsc{prep}  steal\textsc{.cpd}{}-man    \textsc{pl}\\

\glt ‘Watch out for thieves!’ [dj07ae 096]
\z

The verb fɛ́t ‘fight’ cannot take an object either \REF{ex:key:1090}. A comitative participant needs to be expressed as a prepositional phrase \REF{ex:key:1091} or within a coordinate structure \REF{ex:key:1092}:


\ea[*]{%1090
    \label{ex:key:1090}
    \gll Djunais  de  fɛ́t    Boyé.\\
 \textsc{name}  \textsc{ipfv}  fight  \textsc{name}\\
\glt *Djunais is fighting Boyé. [dj07ae 395]
}\z
...
\ea[*]{%1093
    \label{ex:key:1093}
    \gll A    \textstylePichiexamplebold{blánt}  Malábo.\\
 \textsc{1sg.sbj}  reside  Malabo\\
\glt *I reside in Malabo. [dj07ae 027]
}\z


\ea%1094
    \label{ex:key:1094}
    \gll A    \textstylePichiexamplebold{blánt}  \textstylePichiexamplebold{na} Malábo.\\
\textsc{1sg.sbj}  reside  \textsc{loc}  Malabo\\

\glt ‘I reside in Malabo.’ [dj07ae 026]
\z

Intransitive property items include gúd ‘be good’ \REF{ex:key:1095} and bɛ́ta/bɛ́tɛ ‘be very good; better’ \REF{ex:key:1096}. With both property items, a valency increasing causative construction is required in order to add a participant in addition to the subject \REF{ex:key:1097}[FFF9?]: 


\ea[*]{%1095
    \label{ex:key:1095}
    \gll Gɔ́d  go  \textstylePichiexamplebold{gúd}=an.\\
  God  \textsc{pot}  good=\textsc{3sg.obj}\\
\glt *God will make it good.’ [dj07ae 155]
}\z


\ea[*]{%1096
    \label{ex:key:1096}
    \gll Gɔ́d  go  bɛ́tar=an.\\
  God  \textsc{pot}  very.good=\textsc{3sg.obj}\\
\glt *God will better it [things].  [dj07ae 154]
}\z
...
\ea%1099
    \label{ex:key:1099}
    \gll Gɔ́d    go  \textstylePichiexamplebold{fáyn}=an.\\
...
\ea%1102
    \label{ex:key:1102}
    \gll Dásɔl  e    \textstylePichiexamplebold{láf}    \textstylePichiexamplebold{mí}.\\
only    \textsc{3sg.sbj}  laugh  \textsc{1sg.indp}\\

\glt ‘He just laughed at me.’ [dj07ae 108]
\z

There are no restrictions on the transitive use of body function verbs involving “effected objects[FFF9?]” \citep{Hopper1985}, objects that come into existence by the situation denoted by the verb. Compare swɛ́t ‘sweat’ featuring the effected object[FFF9?] wɔtá ‘water’ = ‘sweat’ \REF{ex:key:1103}. The same holds for experiential (or human propensity) verbs like jɛ́lɔs ‘envy; be jealous’, which may appear with a stimulus object \REF{ex:key:1104}: 
...
\ea%1105
    \label{ex:key:1105}
    \gll A    wánt  \textstylePichiexamplebold{blú}      \textstylePichiexamplebold{dí}  \textstylePichiexamplebold{motó}  mék    e    chénch  kɔ́la.\\
...
\ea%1107
    \label{ex:key:1107}
    \gll Di  gɔ́bna    \textstylePichiexamplebold{dɔ́n}  \textstylePichiexamplebold{día}        \textstylePichiexamplebold{di}  \textstylePichiexamplebold{petrol}.\\
...
\ea%1108
    \label{ex:key:1108}
    \gll Fíba    nó  \textstylePichiexamplebold{sube}  \textstylePichiexamplebold{ín}.\\
...
& \itshape kɔ́t & ‘cut’ &  & \itshape láyt & ‘be lit; tipsy’\\
& \itshape krás & ‘crash’ &  & \itshape rɛdí & ‘be ready’\\
& \itshape kúk & ‘cook’ &  & \itshape rɔ́tín & ‘be rotten’\\
...
\ea%1110
    \label{ex:key:1110}
    \gll Di  wach-mán    \textstylePichiexamplebold{chák}.\\
...
\ea%1111
    \label{ex:key:1111}
    \gll Dɛn    \textstylePichiexamplebold{chák}    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{wach-mán}    fɔ́s  fɔ  mék
dɛn  fít  gó  tíf.\\
...
\ea%1112
    \label{ex:key:1112}
    \gll Di  plantí  \textstylePichiexamplebold{dɔ́n}  \textstylePichiexamplebold{fráy}.\\
...
\ea%1113
    \label{ex:key:1113}
    \gll A    bigín  de  pica-píca,    wi  \textstylePichiexamplebold{fráy}  \textstylePichiexamplebold{patata},
wi  \textstylePichiexamplebold{fráy}  \textstylePichiexamplebold{plantí}.\\
...
\ea%1114
    \label{ex:key:1114}
    \gll Di  \textstylePichiexamplebold{kasára}  \textstylePichiexamplebold{lé}  míndul  tú  stík.\\
...
\ea%1115
    \label{ex:key:1115}
    \gll E    \textstylePichiexamplebold{lé}  di  \textstylePichiexamplebold{bɔ́tul}  pantáp  di  tébul,  e    \textstylePichiexamplebold{slíp}  
\textstylePichiexamplebold{di}  \textstylePichiexamplebold{bɔ́tul}  pantáp  di  tébul.\\
...
\ea%1116
    \label{ex:key:1116}
    \gll Dán    húman  \textstylePichiexamplebold{lɔ́n}    bád.\\
...
\ea%1117
    \label{ex:key:1117}
    \gll \MakeUppercase{A}   wánt  \textstylePichiexamplebold{lɔ́n}      di  \textstylePichiexamplebold{klós}.\\
...
\ea%1118
    \label{ex:key:1118}
    \gll Dí  klós    \textstylePichiexamplebold{smɔ́l}.\\
...
\ea%1119
    \label{ex:key:1119}
    \gll Sɔn    klós    dɛn  dé,    hɔt-wɔtá      \textstylePichiexamplebold{de}  \textstylePichiexamplebold{smɔ́l}=an.\\
...
\ea%1120
    \label{ex:key:1120}
    \gll Libreville  \textstylePichiexamplebold{fáyn}.\\
\textsc{place}    be.fine\\
...
\ea%1126
    \label{ex:key:1126}
    \gll \MakeUppercase{A}   \textstylePichiexamplebold{krés}.\\
...
\ea%1127
    \label{ex:key:1127}
    \gll Wé  di  mamá  dáy,    na  ín    \textstylePichiexamplebold{krés}    di  \textstylePichiexamplebold{pikín}.\\
...
\ea%1128
    \label{ex:key:1128}
    \gll E    \textstylePichiexamplebold{de}  \textstylePichiexamplebold{háyd}  \textstylePichiexamplebold{fɔr}=an.\\
...
\ea%1129
    \label{ex:key:1129}
    \gll E    \textstylePichiexamplebold{de}  \textstylePichiexamplebold{háyd}=an.\\
...
\ea%1131
    \label{ex:key:1131}
    \gll Dɛn-ɔ́l      \textstylePichiexamplebold{fínis}.\\
...
yu  nó  go  \textstylePichiexamplebold{fínis}  \textstylePichiexamplebold{dán}    \textstylePichiexamplebold{watá}.\\
...
\ea%1133
    \label{ex:key:1133}
    \gll \textstylePichiexamplebold{E}    \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{sé},    yu  sabí    sé    yá    só
\textstylePichiexamplebold{sɔn}    \textstylePichiexamplebold{wích}    \textstylePichiexamplebold{dé}    nɔ́.\\
...
\ea%1135
    \label{ex:key:1135}
    \gll \textstylePichiexamplebold{E}    \textstylePichiexamplebold{kán}  \textstylePichiexamplebold{bí}  \textstylePichiexamplebold{sé}    mi    abuela,    wé  a
bin  smɔ́l,  e    gó  ríba    (...)\\
...
\ea%1136
    \label{ex:key:1136}
    \gll \textstylePichiexamplebold{Di}  \textstylePichiexamplebold{tín    dé    sé},    mék    e    mék    rabia  wet    mí.\\
...
\ea%1138
    \label{ex:key:1138}
    \gll Na  só    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{tín}    \textstylePichiexamplebold{dé}.\\
...
\ea%1139
    \label{ex:key:1139}
    \gll Na  só    \textstylePichiexamplebold{e}    \textstylePichiexamplebold{dé}.\\
...
\ea%1141
    \label{ex:key:1141}
    \gll \textstylePichiexamplebold{E}    \textstylePichiexamplebold{fíba}    só.\\
...
\ea%1142
    \label{ex:key:1142}
    \gll \textstylePichiexamplebold{E}    \textstylePichiexamplebold{fíba}    \textstylePichiexamplebold{sé}    nóto  yú    wán    dɛn  tíf
na  dí  kwáta.\\
...
\ea%1144
    \label{ex:key:1144}
    \gll \textstylePichiexamplebold{E}    \textstylePichiexamplebold{dɔ́n}  \textstylePichiexamplebold{sté},    a    tínk    sé    e    dɔ́n  sté
...
\ea%1145
    \label{ex:key:1145}
    \gll \textstylePichiexamplebold{E}   \textstylePichiexamplebold{níd}    \textstylePichiexamplebold{sé}    mék    a    gó  dé    tumɔ́ro.\\
...
\ea%1146
    \label{ex:key:1146}
    \gll \textstylePichiexamplebold{E}    \textstylePichiexamplebold{hád}    fɔ  bíl    na  yá    bikɔs  sé    di  grɔ́n 
gɛ́t  bɔkú  sansán.\\
...
\ea%1147
    \label{ex:key:1147}
    \gll \textstylePichiexamplebold{E}    \textstylePichiexamplebold{fáyn} fɔ  dríng  smɔ́l-wán.\\
\textsc{3sg.sbj}  fine    \textsc{prep}  drink  small\textsc{{}-adv}\\

\glt ‘It’s good to drink moderately.’ [ma03hm 071]
\z

The two verbs \textit{falta} ‘lack’ (< Sp. \textit{faltar} ‘lack’) and \textit{sigue} ‘continue; follow’ (< Sp. \textit{seguir} ‘continue; follow’) are established loans of Spanish origin which have been borrowed\is{borrowing} together with their selectional properties. Like their Spanish etymons these two verbs require expletive subjects. Contrary to Spanish, subject pronouns are not normally dropped in Pichi. Examples \REF{ex:key:1148} and \REF{ex:key:1149} therefore feature the expletive pronoun \textit{e} \textsc{‘3sg.sbj’}:


\ea%1148
    \label{ex:key:1148}
    \gll \textstylePichiexamplebold{E}    \textstylePichiexamplebold{falta}  mɔní  fɔ  púl    saco    dɛn  dé    fɔ
kɛ́r=an    na  hós.\\
...
\ea%1150
    \label{ex:key:1150}
    \gll \textsc{E}    sé    \textstylePichiexamplebold{e}    nó  fít    \textstylePichiexamplebold{falta}.\\
...
\textstylePichiexamplebold{e}    \textstylePichiexamplebold{de}  \textstylePichiexamplebold{sigue}  mɔ́.\\
...
\ea%1152
    \label{ex:key:1152}
    \gll (...)  bɔt  \textstylePichiexamplebold{dɛn}  \textstylePichiexamplebold{yón}     fáyn,  \textstylePichiexamplebold{e}    fáyn    fɔ  sí.\\
...
\ea[*]{%1153
    \label{ex:key:1153}
    \gll Dán  sáy  \textstylePichiexamplebold{fáyn}  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{sí}.\\
 that  side  fine    \textsc{prep}  see\\
\glt *That place is nice to see. [eb07fn]
}\z
...
\ea[*]{%1155
    \label{ex:key:1155}
    \gll Boyé  fíba    gɛ́t  mɔní.\\
  \textsc{name}  seem  get  money\\
\glt *Boyé seems to have money. [dj07ae 254]
}\z
...
Existential constructions featuring expletive subjects and the verb gɛ́t ‘get; exist’ are covered in detail in section \sectref{sec:7.6.3}.
...
The verb gɛ́t is an inchoative-stative transitive verb, which occurs with a stative \REF{ex:key:1157}, and at other times, an inchoative reading \REF{ex:key:1158}. The verb also has various functions as an existential and modal verb and expresses possession[FFF9?] (cf. e.g. \REF{ex:key:1159} below):
...
Ordinary objects of gɛ́t may occur bare or be preceded by determiners depending on pragmatic circumstance. In \REF{ex:key:1159}, the non-specific noun bɔ́y ‘boy’ is preceded by the indefinite determiner wán. In contrast, non-specific objects of light verbs have a strong tendency to occur devoid of any definiteness[FFF9?] marking. In \REF{ex:key:1159}, the noun mán ‘man’ of the light verb construction gɛ́t mán ‘have a man/husband’ remains bare: 
...
Objects of gɛ́t may be pluralised with a post-posed dɛn \REF{ex:key:1160} and may occur with prenominal modifiers like bɔkú ‘much’ or the 1sg possessive pronoun mi \REF{ex:key:1160}. The verb gɛ́t may also take pronominal objects \REF{ex:key:1161}, or occur with no overt object at all where reference has been established earlier on \REF{ex:key:1162}:
...
We have seen that non-specific objects of light verbs tend to occur as bare nouns. Nonetheless, specific objects of gɛ́t in light verb constructions may occur with determiners if so required. Compare di fɔ́s bɛlɛ́ ‘first pregnancy’ in \REF{ex:key:1163}:
...
The NP di fɔ́s bɛlɛ́ the first pregnancy’ in \REF{ex:key:1163} above also shows that objects of light verbs are encountered with prenominal modifiers. Likewise, object NPs in light verb constructions may be placed under focus \REF{ex:key:1164}. Although there are not many instances of pronominalised light verb objects in the data, these also occur. In \REF{ex:key:1165}, the object pronoun =an substitutes for torí ‘story’:


\ea%1164
    \label{ex:key:1164}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{torí}    dɛn  de  \textstylePichiexamplebold{púl}.\\
...
\end{tabularx}
\end{table}
\tabref{tab:key:9.8} reveals that light verb constructions proper represent 33 per cent of the total number of occurrences of collocations involving gɛ́t and an object. Of all gɛ́t-constructions contained in the corpus, gɛ́t pikín ‘have children’ is the most frequent one and accounts for 16 per cent of the total of light verb constructions. An additional information of interest is that the total number of types (different constructions) of light verb construction amounts to eleven, seven of which occur only once each. In view of these facts, I assume that the functional load of gɛ́t as a light verb is only moderate.


Next to the borrowing\is{borrowing} of Spanish verbs, verb-noun collocations consisting of a Pichi verb and a Spanish noun are an important means of extending the lexicon. Code-mixed constructions allow speakers to tap into the nominal lexicon of Spanish in order to derive new “verbal” meanings. These constructions are characterised by a high degree of structural equivalence between Pichi and Spanish. Not only is the order of constituents in verb-noun collocations the same in both languages. The meanings of the light verbs employed in the respective languages are also highly compatible with each other. There is therefore a strong tendency towards convergence in code-mixed collocations. Accordingly, the verbs in these collocations may have the selectional characteristics of the Pichi verb in one instance, while in another, the Pichi verb may select its complement\is{„complements“} as if it were the synonymous Spanish verb (cf. \citealt{Muysken2000}:184ff.)



For instance, none of the nouns in the collocations gɛ́t rabia ‘be angry’ \REF{ex:key:1166}, gɛ́t novio ‘have a boyfriend’ \REF{ex:key:1167} and gí permiso ‘give permission’ \REF{ex:key:1168} are encountered with a determiner in the corpus. The meanings of the verbs and the distribution of nouns in these constructions are identical to those in the Spanish equivalents tener rabia ‘be angry’, tener novio ‘have a boyfriend’, and dar permiso ‘give permission’. 
...
\ea%1168
    \label{ex:key:1168}
    \gll If  di  fámbul  nó  \textstylePichiexamplebold{gí}  yú    \textstylePichiexamplebold{permiso}    (...)\\
...
\ea%1169
    \label{ex:key:1169}
    \gll E    de  \textstylePichiexamplebold{gí}  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{vuelta}  kwík\\
\textsc{3sg.sbj}  \textsc{ipfv}  give  one    round  quickly\\

\glt ‘She’s doing a round quickly.’ [dj05be 120]
\z

Other code-mixed collocations are further removed from the pole of light verb constructions. The collocation \textit{gí beca} ‘give a scholarship’ \REF{ex:key:1170}–\REF{ex:key:1171} occurs with or without determiners in accordance with the referential properties of the \textsc{NP}: 


\ea%1170
    \label{ex:key:1170}
    \gll Dɛn  bin  \textstylePichiexamplebold{gí}  mí    \textstylePichiexamplebold{beca}.\\
...
\ea%1171
    \label{ex:key:1171}
    \gll E    \textstylePichiexamplebold{gí}  mí    \textstylePichiexamplebold{di}  \textstylePichiexamplebold{beca}      a    gó.\\
...
In sum, we can observe that next to a few “proper” light verb constructions, Pichi makes use of less tightly integrated collocations featuring Pichi or Spanish nouns by means of ordinary phrasal syntax. These constructions are flexible, allow the insertion of functional elements and modifiers, as well as object substitution by pronouns.\is{light verb constructions}
...
Here follows an example with the verb \textit{wás} ‘wash (oneself)’ and its associative object \textit{wɔtá} ‘water’. The pragmatic context coerces a semantic role of instrument\index{} or means on the associative object: 



\ea%1172
    \label{ex:key:1172}
    \gll A    de  \textstylePichiexamplebold{wás}    \textstylePichiexamplebold{wɔtá}.\\
...
\tablevspace
\itshape invita & \itshape Guinness & ‘invite for a Guinness’ & Purpose\index{}\\
...
\end{tabularx}
\end{table}
Associative objects are assigned a content role\index{} by the labile change of state verbs \textit{fúlɔp} ‘fill up’ \REF{ex:key:1173} and \textit{pák} ‘pack; fill up’ \REF{ex:key:1174}: 


\ea%1173
    \label{ex:key:1173}
    \gll Na  China  motó  dɛn  \textstylePichiexamplebold{fúlɔp}  \textstylePichiexamplebold{pípul}.\\
...
\ea%1174
    \label{ex:key:1174}
    \gll ɔ́l  hía    \textstylePichiexamplebold{pák}    \textstylePichiexamplebold{polvo}.\\
all  here    pack  dust\\
...
\ea%1175
    \label{ex:key:1175}
    \gll Na  lɛk  sé    yu  \textstylePichiexamplebold{fúlɔp}  di  glás    \textstylePichiexamplebold{watá}?\\
...
\ea%1176
    \label{ex:key:1176}
    \gll E    \textstylePichiexamplebold{fúlɔp}  di  glás    \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{watá}.\\
\textsc{3sg.sbj}  fill    \textsc{def}  glass  with    water\\

\glt ‘He filled the glass with water.’ [dj07ae 067]
\z

Instrument\index{} is among the most common semantic roles expressed by associative objects \REF{ex:key:1177}. The instrument role may also be expressed by a \textit{wet}{}-prepositional phrase \REF{ex:key:1178}:
...
\ea[*]{%1179
    \label{ex:key:1179}
    \gll A    de  \textstylePichiexamplebold{kɔ́t}  di  tín    \textstylePichiexamplebold{sísɔs}.\\
 \textsc{1sg.sbj}  \textsc{ipfv}  cut  \textsc{def}  thing  scissors\\
\glt *I’m cutting the thing with a pair of scissors. [dj07ae 477]
}\z


\ea%1180
    \label{ex:key:1180}
    \gll \textstylePichiexamplebold{Kɔ́t}=an    \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{sísɔs}!\\
cut=\textsc{3sg.obj}  with    scissors\\

\glt ‘Cut it with a pair of scissors!’ [dj07ae 478]
\z

Sentences \REF{ex:key:1181} and \REF{ex:key:1182} provide examples for the use of associative objects with the semantic role of purpose\index{}. These may equally be expressed through a prepositional phrase introduced by the associative preposition \textit{fɔ} \REF{ex:key:1182}: 


\ea%1181
    \label{ex:key:1181}
    \gll Yu  de  \textstylePichiexamplebold{kapú}    \textstylePichiexamplebold{hós}.\\
...
\ea%1182
    \label{ex:key:1182}
    \gll Dɛn  de  \textstylePichiexamplebold{kapú}    \textstylePichiexamplebold{fɔ} di  \textstylePichiexamplebold{hós}.\\
...
\ea%1184
    \label{ex:key:1184}
    \gll Di  pikín  \textstylePichiexamplebold{fɔdɔ́n}  \textstylePichiexamplebold{frɔn}    \textstylePichiexamplebold{ɔ́p}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{stík},    frɔn    di  stík.\\
...
The semantic role of the objects of smɛ́l ‘smell’ can only be disambiguated by context. In \REF{ex:key:1185} the associative object chɔ́p ‘food’ denotes the source of the sensation, in \REF{ex:key:1186}, chɔ́p denotes the stimulus[FFF9?]: 
...
\ea%1187
    \label{ex:key:1187}
    \gll E    de  trén    yú    sé    yu  go  \textstylePichiexamplebold{kɔmɔ́t}    \textstylePichiexamplebold{pɔ́sin}.\\
...
\ea%1189
    \label{ex:key:1189}
    \gll E    de  \textstylePichiexamplebold{sík}  \textstylePichiexamplebold{fíba}.\\
...
\ea%1190
    \label{ex:key:1190}
    \gll (...)  dán  papá  de  \textstylePichiexamplebold{kráy}  in    \textstylePichiexamplebold{mɔní}.\\
...
e    bin  de  \textstylePichiexamplebold{sík}.’\\
...
\ea%1192
    \label{ex:key:1192}
    \gll \'{U}s=káyn  \textstylePichiexamplebold{sík}    e    de  \textstylePichiexamplebold{sík}? \\
\textsc{q}=kind  sickness  \textsc{3sg.sbj}  \textsc{ipfv}  be.sick\\

\glt ‘What kind of sickness does she have?’ [eb07fn 244]\is{adverbial phrases“ r}
\z
...
\ea%1193
    \label{ex:key:1193}
    \gll Wé  yu  kɔmɔ́t    \textstylePichiexamplebold{sík}    \textstylePichiexamplebold{dán}  \textstylePichiexamplebold{sík}    na  Panyá,  wé  yu  de  sík,
...
\ea%1194
    \label{ex:key:1194}
    \gll A    wánt  \textstylePichiexamplebold{tɔ́k}  \textstylePichiexamplebold{dán}  \textstylePichiexamplebold{smɔ́l}  \textstylePichiexamplebold{tɔ́k}    dé.\\
...
\ea%1195
    \label{ex:key:1195}
    \gll Dɛn  bin  \textstylePichiexamplebold{fáyn}  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{fáyn}.\\
...
There is good reason to assume that the fronted “verb” in predicate cleft constructions like the following one is in fact also a deverbal noun\is{predicate cleft}. One indication for this is that the verb is never fronted with predicate constituents like TMA markers. In this view, clefted verbs may also be seen as types of cognate objects: 


\ea%1198
    \label{ex:key:1198}
    \gll Na  \textstylePichiexamplebold{gó}  a    de  \textstylePichiexamplebold{gó}  ó!\\
...
\ea[*]{%1200
    \label{ex:key:1200}
    \gll A    go  gí    \textstylePichiexamplebold{una}=an    tumɔ́ro.\\
 \textsc{1sg.sbj}  \textsc{pot}  give    \textsc{2pl}=\textsc{3sg.obj}  tomorrow\\
\glt *I’ll give you [\textsc{pl}] it tomorrow. [ye07de 011]
}\z


\ea%1201
    \label{ex:key:1201}
    \gll A    go  gí  \textstylePichiexamplebold{unu}  tumɔ́ro.\\
...
\ea%1203
    \label{ex:key:1203}
    \gll Mi    mamá  dás        \textstylePichiexamplebold{mí}    \textstylePichiexamplebold{sɔn}   \textstylePichiexamplebold{regalo}.\\
...
\ea%1204
    \label{ex:key:1204}
    \gll Mi    mamá  dás        \textstylePichiexamplebold{sɔn}   \textstylePichiexamplebold{regalo}  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{mí}.\\
...
\ea%1205
    \label{ex:key:1205}
    \gll Dɛn  gí  di  \textstylePichiexamplebold{mɔní}    \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{mí}.\\
...
\ea%1206
    \label{ex:key:1206}
    \gll Dɛn    bin  gí    \textstylePichiexamplebold{mí}      \textstylePichiexamplebold{beca}.\\
\textsc{3pl}    \textsc{pst}  give    \textsc{1sg.indp}    scholarship.\\
...
\ea%1207
    \label{ex:key:1207}
    \gll Na  ín    e    de  kán    púl  \textstylePichiexamplebold{mí}    \textstylePichiexamplebold{dán}  \textstylePichiexamplebold{torí}.\\
...
The verb sɛ́n ‘send; throw’ denotes a situation in which both a transfer and a motion event[FFF9?] co-occur. When sɛ́n is used in a double-object construction, the primary object is always a recipient \REF{ex:key:1208}. 
...
Like with other transfer verbs, the recipient of sɛ́n may not be expressed as a prepositional phrase. Where we do find a prepositional phrase (usually introduced by fɔ ‘prep’), it can therefore only denote a beneficiary [FFF9?]or a goal[FFF9?] but not a recipient [FFF9?]\REF{ex:key:1209}:
...
*He has to send it to you.\is{recipient} 
\z
...
\ea%1210
    \label{ex:key:1210}
    \gll A    wánt  mék    yu  dú  \textstylePichiexamplebold{mí}    \textstylePichiexamplebold{sɔn}   \textstylePichiexamplebold{fébɔ}    mék
yu  wás    \textstylePichiexamplebold{mí}    \textstylePichiexamplebold{sɔn}   \textstylePichiexamplebold{klós}    \textstylePichiexamplebold{dɛn}.\\
...
\ea%1212
    \label{ex:key:1212}
    \gll Dɛn    tíf    \textstylePichiexamplebold{mí}    \textstylePichiexamplebold{mi}    \textstylePichiexamplebold{sús}.\\
...
\ea%1213
    \label{ex:key:1213}
    \gll \'{A}fta    primera  dama  báy=an    \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{motó}, (...)\\
...
\ea%1214
    \label{ex:key:1214}
    \gll \MakeUppercase{A}   bin  báy  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{motó}  \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{mi}    \textstylePichiexamplebold{mása}.\\
...
The second type of type 2 construction involves the caused location verb \textit{pút} ‘put’. Here, the primary object has the semantic role of goal,\is{goal} while the secondary object fulfills a theme\is{theme} role. In \REF{ex:key:1215}, the primary object of \textit{pút} is the goal object =an ‘\textsc{3sg.obj}’, while the secondary object \textit{saldo} ‘(mobile phone) credit’ is the theme\is{theme}. Sentence \REF{ex:key:1216} also features the goal object\textit{ =an} ‘\textsc{3sg.obj}’, while the theme object is \textit{cacahuete} ‘groundnut’:
...
dɛn  de  pút=\textbf{an}    \textstylePichiexamplebold{cacahuete}.\\
...
\ea%1217
    \label{ex:key:1217}
    \gll Dɛn  kin  pút=an    \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{glás}.\\
...
\ea%1218
    \label{ex:key:1218}
    \gll \MakeUppercase{A}   dɔ́n    \textstylePichiexamplebold{pút}  mi    búk    \textstylePichiexamplebold{ínsay}.\\
...
\ea%1219
    \label{ex:key:1219}
    \gll A    dɔ́n  pút  granát  \textstylePichiexamplebold{fɔr}=an\\
...
\ea%1220
    \label{ex:key:1220}
    \gll A    dɔ́n  pút  granát  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{ín}.\\
...
\ea%1221
    \label{ex:key:1221}
    \gll Yu  pút=an    \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{sardina}  ɔntɔ́p.\\
...
\ea%1222
    \label{ex:key:1222}
    \gll Na  lɛk  sé    yu  fúlɔp  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{glás}  \textstylePichiexamplebold{watá}?\\
...
\ea%1223
    \label{ex:key:1223}
    \gll E    fúlɔp  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{glás}    \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{watá}.\\
...
\ea%1226
    \label{ex:key:1226}
    \gll \MakeUppercase{A}   de  \textstylePichiexamplebold{sí}  mi    \textstylePichiexamplebold{skín}    na  lukinglás.\\
...
\ea%1227
    \label{ex:key:1227}
    \gll \MakeUppercase{A}   de  \textstylePichiexamplebold{kíl}  mi    \textstylePichiexamplebold{skín}    dé,    lɛk  háw    a    de  wók.\\
...
\ea%1228
    \label{ex:key:1228}
    \gll E    dɔ́n  \textstylePichiexamplebold{chák}    in    \textstylePichiexamplebold{héd}.\\
\textsc{3sg.sbj}  \textsc{prf}  get.drunk  \textsc{3sg.poss}  head\\

\glt ‘She is dead drunk.’ [lit. ‘She has got her head drunk.’] [ra07fn 026]
\z
...
\ea%1229
    \label{ex:key:1229}
    \gll Bɔt  fɔ  Bata    dɛn  de  ték/    dán    wán  sí  que  \textstylePichiexamplebold{dɛn}  \textstylePichiexamplebold{yón}   máred
...
Compare wɛ́r ‘dress (up)’ in an explicitly reflexive clause \REF{ex:key:1230} and a clause in which reflexivity remains unexpressed \REF{ex:key:1231}: 
...
Next to its use as a reflexive anaphor, the pronominal sɛ́f ‘self’ also serves as a reciprocal pronominal with plural referents. In sentence \REF{ex:key:1232}, the reciprocal NP is an object to the verb sláp ‘slap’, in \REF{ex:key:1233} to the locative noun bifó ‘before’:
...
\ea%1236
    \label{ex:key:1236}
    \gll Dɛn  lúk    \textstylePichiexamplebold{dɛn}  \textstylePichiexamplebold{yón}     fés.\\
\textsc{3pl} look \textsc{3pl}  own    face\\

\glt ‘They looked at each other’s faces.’ [eb07fn 313\textstylePichiexamplenumberZchnZchn{]}\is{reciprocity}
\z

Pichi also has inherently reciprocal verbs, many of which preferably do not occur with the anaphor sɛ́f (cf. \sectref{sec:9.4.3}).[FFF9?] 
...
\ea%1237
    \label{ex:key:1237}
    \gll Tináda      de  \textstylePichiexamplebold{bló}.\\
...
\ea%1238
    \label{ex:key:1238}
    \gll Brís  de  \textstylePichiexamplebold{bló}.\\
air  \textsc{ipfv}  blow\\
...
\ea%1239
    \label{ex:key:1239}
    \gll Di  sán  \textstylePichiexamplebold{bráyt}.\\
...
\ea%1240
    \label{ex:key:1240}
    \gll Di  ventilador  de  \textstylePichiexamplebold{bló}    \textstylePichiexamplebold{mí}.\\
...
\ea%1241
    \label{ex:key:1241}
    \gll Di  sán  \textstylePichiexamplebold{bráyt}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{dé}.\\
...
\ea%1242
    \label{ex:key:1242}
    \gll \textstylePichiexamplebold{Di}  \textstylePichiexamplebold{dé}    dák.\\
...
\ea%1243
    \label{ex:key:1243}
    \gll \textstylePichiexamplebold{Di}  \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{fɔ}  \textstylePichiexamplebold{tidé}    tú  hɔ́t,    tú  mɔ́ch  sán.\\
...
\ea%1244
    \label{ex:key:1244}
    \gll \textstylePichiexamplebold{Di}  \textstylePichiexamplebold{dé}    kól.\\
...
\ea%1245
    \label{ex:key:1245}
    \gll A    de  sí  di  dé  lɛkɛ  sé    \textstylePichiexamplebold{e}    wánt  \textstylePichiexamplebold{fɔ́l}.\\
...
The third type of construction involves existential clauses featuring the possessive and existential verb gɛ́t ‘get; exist’ or the locative-existential copula dé ‘be.loc’ (cf. \sectref{sec:7.6.3} for details on the syntax of these clauses). This construction is only attested in code-mixed utterances involving a Spanish atmospheric phenomenon: 
...
\ea%1248
    \label{ex:key:1248}
    \gll Dán  sáy,  \textstylePichiexamplebold{niebla}  \textstylePichiexamplebold{dé}    dé.\\
...
Body states are expressed in constructions involving transitive (cf. 1a–1c in \tabref{tab:key:9.11}) and intransitive (2a–2c) clauses. I summarise the constructions described in this section in \tabref{tab:key:9.11}. Details are provided below:
...
& \textstyleTablePichiZchn{slíp}\textit{} ‘sleep’ &  & x & x & x &  & \\
...
\end{tabularx}
\end{table}
Type 1 constructions in \tabref{tab:key:9.11} involve transitive clauses. In type 1a constructions, the affected body part\is{} is found in the subject\index{subjects} position, while the experiencer\is{experiencer} is in the object position. This construction is the preferred one for expressing pain and hurt. The verb is either of the dynamic experiential verbs \textit{hát} ‘hurt’ or \textit{pén} ‘pain’:
...
\ea%1251
    \label{ex:key:1251}
    \gll Mi    \textstylePichiexamplebold{tít}    de  \textstylePichiexamplebold{pén}    mí.\\
...
\ea%1252
    \label{ex:key:1252}
    \gll Smɔ́ltɛn    \textstylePichiexamplebold{slíp}    \textstylePichiexamplebold{kéch}=an.\\
...
\ea%1253
    \label{ex:key:1253}
    \gll Wán    \textstylePichiexamplebold{hángri}  \textstylePichiexamplebold{kéch}  mí    dé.\\
...
\ea%1254
    \label{ex:key:1254}
    \gll \textstylePichiexamplebold{Tɔ́sti}  \textstylePichiexamplebold{kéch}  mí.\\
thirst  catch  \textsc{1sg.indp}\\
...
\ea%1255
    \label{ex:key:1255}
    \gll A    de  \textstylePichiexamplebold{fíl}  \textstylePichiexamplebold{hángri},  A    de  \textstylePichiexamplebold{fíl}  \textstylePichiexamplebold{slíp}.\\
...
\ea%1256
    \label{ex:key:1256}
    \gll A    \textstylePichiexamplebold{fíl}  di  pikín  in    \textstylePichiexamplebold{pén}.\\
...
\ea%1257
    \label{ex:key:1257}
    \gll A    \textstylePichiexamplebold{sɔ́fa}    wán    \textstylePichiexamplebold{hángri}  na  dán  kɔ́ntri. \\
\textsc{1sg.sbj}  suffer  one    hunger  \textsc{loc}  that  country\\

\glt ‘I endured extraordinary hunger in that country.’ [dj07ae 121]
\z

Proof for the nominal status of the body state in the constructions above is provided by sentences \REF{ex:key:1257} and \REF{ex:key:1256}. In the latter example, we find a dislocated possessive construction\is{possessive constructions} in the object position of \textit{fíl}. In the former example, the indefinite determiner \textit{wán} ‘one; a’ precedes \textit{hángri} ‘hunger’, the object of \textit{sɔ́fa} ‘endure’.
...
\ea%1258
    \label{ex:key:1258}
    \gll A    de  \textstylePichiexamplebold{fíl}  tú  mɔ́ch  \textstylePichiexamplebold{hɔ́t}.\\
...
\ea%1259
    \label{ex:key:1259}
    \gll E    de  \textstylePichiexamplebold{fíl}  \textstylePichiexamplebold{gúd}    ɛf  e    dé    míndul  pípul.\\
...
\ea%1260
    \label{ex:key:1260}
    \gll A    \textstylePichiexamplebold{de}  \textstylePichiexamplebold{hángri}.\\
...
\ea%1261
    \label{ex:key:1261}
    \gll A    \textstylePichiexamplebold{de}  \textstylePichiexamplebold{tɔ́sti}.\\
...
\ea%1262
    \label{ex:key:1262}
    \gll Wán    dé  wán    pikín  bin  \textstylePichiexamplebold{de}  \textstylePichiexamplebold{sík}.\\
one    day  one    child  \textsc{pst}  \textsc{ipfv}  sick\\

\glt ‘One day, a certain child was sick.’ [ye03cd 071]
\z

In type 2b constructions, the body state verb is inchoative-stative. Compare táya ‘be tired’ \REF{ex:key:1263} wɛ́l ‘be well’ \REF{ex:key:1264}, bɛlfúl ‘be satiated’ \REF{ex:key:1265}, and hát ‘be hurt’ \REF{ex:key:1266}:


\ea%1263
    \label{ex:key:1263}
    \gll A    \textstylePichiexamplebold{táya}.\\
...
\ea%1265
    \label{ex:key:1265}
    \gll A    \textstylePichiexamplebold{bɛlfúl}.\\
...
\ea%1266
    \label{ex:key:1266}
    \gll Di  gál  \textstylePichiexamplebold{hát}.\\
\textsc{def}  girl  hurt\\

\glt ‘The girl is hurt.’ [dj05be 006]
\z

Type 2c constructions are intransitive copula clauses. The body state verb appears as an adjective complement\is{complements} to the locative-existential\is{„copula:locative-existential} copula \textit{dé} \textsc{‘be.loc’} \REF{ex:key:1267}. The property items \textit{gúd} ‘be well’, \textit{bád} ‘be bad’, and \textit{fáyn} ‘be fine’ appear in such predicate adjective constructions\textit{} when they express a transient body state rather than an (intrinsic) value (cf. \sectref{sec:7.6.5}):
...
\ea%1269
    \label{ex:key:1269}
    \gll A    \textstylePichiexamplebold{bɛlfúl}    \textstylePichiexamplebold{plantí}.\\
...
The following two sentences are uttered in sequence by the same speaker. Compare ambiguous function of \textit{sé} like \REF{ex:key:1271}(b), which is introduced by \textit{sé}, with (a) where \textit{sé} is firmly integrated into the sentence as a quotative marker:
...
\ea%1271
    \label{ex:key:1271}
\ea{
    \gll a.  E    tɛ́l=an    sé  ‘papá  mí    nɛ́va  chɔ́p
  mi    sénwe’.\\
...
\gll
\textstylePichiexamplebold{Sé}    chico,  dí  tín    nó  go  dú  mí.\\
...
In principle, objects need not be overtly expressed. In practice, highly transitive verbs are unlikely to appear without a patient object, even if the object is non-specific. The verb \textit{bló} ‘give a blow’ in \REF{ex:key:1272} denotes a situation which implies a high degree of volition and instigation by an agent. Equally, the situation involves no notion of affectedness of the agent (cf. Næss 2007):


\ea%1272
    \label{ex:key:1272}
    \gll A    \textstylePichiexamplebold{bló}      \textstylePichiexamplebold{dí}  \textstylePichiexamplebold{pikín}.\\
...
\ea%1274
    \label{ex:key:1274}
    \gll Mék    a    \textstylePichiexamplebold{bló}    \textstylePichiexamplebold{dí}  \textstylePichiexamplebold{pɔ́sin}  mék    e    fít  recupera.\\
...
\ea%1275
    \label{ex:key:1275}
    \gll (...)  yu  \textstylePichiexamplebold{híb}    \textstylePichiexamplebold{sɔn}   tín    fɔ  grɔ́n    (...)\\
...
\ea%1276
    \label{ex:key:1276}
    \gll (...)  na  ín    e    de  \textstylePichiexamplebold{nák}  \textstylePichiexamplebold{pɔ́sin}.\\
...
\ea%1277
    \label{ex:key:1277}
    \gll Bikɔs  yu  dɔ́n  \textstylePichiexamplebold{tɔ́k}  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{bád  tɔ́k},    e    sé
‘gɔ́d    háma  yu  mɔ́t!’\\
...
\ea%1278
    \label{ex:key:1278}
    \gll Sé    ‘a    bin  sí  bɔt  a    nó  fít  \textstylePichiexamplebold{tɔ́k}.’\\
...
\ea%1279
    \label{ex:key:1279}
    \gll E    de  \textstylePichiexamplebold{síng}    na  Píchi.\\
...
\ea%1280
    \label{ex:key:1280}
    \gll (...)  wé  yu  nó  nó    to  fíks  wán  klós,  to  \textstylePichiexamplebold{só}  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{klós}    (...)\\
...
\ea%1281
    \label{ex:key:1281}
    \gll Di  sastre  de    \textstylePichiexamplebold{só}.\\
...
\ea%1282
    \label{ex:key:1282}
    \gll E    kin  \textstylePichiexamplebold{kúk}    \textstylePichiexamplebold{súp}.\\
...
\ea%1283
    \label{ex:key:1283}
    \gll Di  húman  kán    na  hós    di  áwa    wé  a    de  \textstylePichiexamplebold{kúk}.\\
\textsc{def}  woman  come  \textsc{loc}  house  \textsc{def}  hour  \textsc{sub}  \textsc{1sg.sbj}  \textsc{ipfv}  cook\\

\glt ‘The woman came to the house at the time when I was cooking.’ [ro05de 022]\is{effected objects“ r}
\z
...
\ea%1285
    \label{ex:key:1285}
    \gll E    dɔ́n    \textstylePichiexamplebold{rích}.\\
...
\ea%1286
    \label{ex:key:1286}
    \gll Bueno,  a    de  \textstylePichiexamplebold{gó}  \textstylePichiexamplebold{mákit}  náw.\\
...
\ea%1287
    \label{ex:key:1287}
    \gll A    go  \textstylePichiexamplebold{gó}.\\
...
\ea%1288
    \label{ex:key:1288}
    \gll A    kán  \textstylePichiexamplebold{chɔ́p}.\\
...
\ea%1289
    \label{ex:key:1289}
    \gll Dí  pɔ́sin  \textstylePichiexamplebold{de}  \textstylePichiexamplebold{dríng},  na  chak-mán.\\
this  person  \textsc{ipfv}  drink  \textsc{foc}  drink\textsc{.cpd}{}-man\\

\glt ‘This person drinks, he’s a drunkard.’ [dj07ae 363]
\z

A final group of affected-agent verbs denote sensory perception, as well as mental and physical activities. Verbs belonging to this group that regularly occur without an overt non-specific object are \textit{lúk} ‘look’ and \textit{hía} ‘hear, understand’ and \textit{sabí}\textit{\textup{/}}\textit{nó} ‘know’ and \textit{sí} ‘see’. 
...
\ea%1291
    \label{ex:key:1291}
    \gll Yu  \textstylePichiexamplebold{sí}  \textstylePichiexamplebold{di}  \textstylePichiexamplebold{tín}?\\
\textsc{2sg}  see  \textsc{def}  thing\\

\glt ‘You see?’ [ur05fn 013]
\z

The cognition verb mɛ́mba often appears without an explicit object with its meaning of ‘remember’ \REF{ex:key:1292}:
...
However, when mɛ́mba occurs in a transitive clause, it is best translated as ‘think of’, both with a specific object \REF{ex:key:1293} and a non-specific one \REF{ex:key:1294}: 
...
\ea%1295
    \label{ex:key:1295}
    \gll Bɔt  wi  fít  de  \textstylePichiexamplebold{plé}  a    jám        yú     yu  fɔdɔ́n.\\
...
Pichi speakers may make use of the reflexive anaphor sɛ́f or a body part[FFF9?] noun in order to express reflexivity and recprocity (cf. \sectref{sec:9.3.5} and \sectref{sec:9.3.6}). There are also verbs that allow a reflexive interpretation but do not generally occur with a reflexive pronoun. Verbs whose reflexive pronouns usually remain unexpressed instantiate “middle voice” \citep{Kemmer1993} and denote situations that imply volition and instigation by the agent, involve physical action of the agent upon her/himself, or imply movement of the body.


The following examples involve the “body care” verbs wás ‘wash’ \REF{ex:key:1297}, báf ‘bathe’ \REF{ex:key:1298}, and wɛ́r ‘dress (up)’ \REF{ex:key:1231}. Note that wɛ́r takes an object in \REF{ex:key:1300} and still implies reflexivity:



\ea%1297
    \label{ex:key:1297}
    \gll Dɛn  de  kán    sé    dɛn  kán    \textstylePichiexamplebold{wás}.\\
...
\ea%1298
    \label{ex:key:1298}
    \gll Yu  dɔ́n  \textstylePichiexamplebold{báf}?\\
...
\ea%1301
    \label{ex:key:1301}
    \gll \textstylePichiexamplebold{Wás}    yu  \textstylePichiexamplebold{skín}!\\
wash  \textsc{2sg}  body\\
...
The basic posture verbs slíp ‘lie (down); sleep’, tínap ‘stand (up)’ and sidɔ́n ‘sit (down)’ are never encountered with a reflexive pronoun in the corpus (cf. \sectref{sec:8.1.3} for an extensive treatment). In contrast, verbs denoting less prototypical postures, e.g. líng ‘lean over’ and bɛ́n ‘bend (over)’ in \REF{ex:key:1303}–\REF{ex:key:1304}, as well as those denoting other types of body-related events, e.g. háyd ‘hide’ in \REF{ex:key:1305}–\REF{ex:key:1306} are found with or without reflexive pronouns:
...
\ea%1305
    \label{ex:key:1305}
    \gll A    kán  \textstylePichiexamplebold{háyd}  ínsay  hós.\\
...
\ea%1312
    \label{ex:key:1312}
    \gll Una    \textstylePichiexamplebold{slíp}?\\
\textsc{2pl}    sleep\\

\glt ‘You slept (with each other)?’ [fr03wt 028]
\z

Conversely, the inherently reciprocal verbs of social interaction mít ‘meet’ and mítɔp ‘meet’ do not normally occur with the anaphor sɛ́f \REF{ex:key:1313}–\REF{ex:key:1314}: 
...
\ea%1314
    \label{ex:key:1314}
    \gll \'{A}fta    wi  kán  \textstylePichiexamplebold{mít}    layk    wán  seis    años  después.\\
then  \textsc{1pl}  \textsc{pfv}  meet  like    one  six    years  afterwards\\

\glt ‘Then we met some six years later.’ [fr03ft 191]
\z

Nevertheless, like other inherently reciprocal verbs, mít and mítɔp may take part in a reciprocal alternation (cf. also fɛ́t ‘fight’ in \REF{ex:key:1090}ff.). The two participants may be expressed as coordinate subject[FFF9?]s in an intransitive clause while reciprocity is understood. Compare the transitive use of mít ‘meet’ in \REF{ex:key:1315}, with its intransitive use with two coordinate subjects in \REF{ex:key:1316}:


\ea%1315
    \label{ex:key:1315}
    \gll Pero    e    \textstylePichiexamplebold{mít}    \textstylePichiexamplebold{mi}    \textstylePichiexamplebold{gran-má}.\\
...
\ea%1316
    \label{ex:key:1316}
    \gll \textstylePichiexamplebold{Mí}    \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{Djunais}  wi  mítɔp.\\
...
\ea%1317
    \label{ex:key:1317}
    \gll \textstylePichiexamplebold{Djunais}  fíba      \textstylePichiexamplebold{Boyé}.\\
...
\ea%1318
    \label{ex:key:1318}
    \gll \textstylePichiexamplebold{Djunais}  \textstylePichiexamplebold{wet}    \textstylePichiexamplebold{Boyé}  dɛn  fíba.\\
...
\end{tabularx}
\end{table}
Causative and permissive constructions are formed with the two verbs mék ‘make’ and lɛ́f ‘leave; permit’. Examples \REF{ex:key:1319}–\REF{ex:key:1320} present their use in non-causative transitive clauses:


\ea%1319
    \label{ex:key:1319}
    \gll Yu  fít  \textstylePichiexamplebold{mék}    mí    wán    café?\\
...
Two types of causative constructions can be distinguished on formal grounds (cf. \citealt{Yakpo2012b}; 2017). The most common type of causative construction in Pichi inolves a “balanced” structure \citep{Cristofaro2003}. The causative event is expressed in two finite clauses and the causative verb and the verb-of-effect are linked in a relation of subordination\is{subordination}. \REF{ex:key:1321} below features the (inanimate) causer NP \textit{lotería} ‘lottery’, the causative main verb \textit{mék} ‘make’, the \textit{\textup{causee NP}}\textit{ mi mɔní} \textit{\textup{‘my money’,}}\textit{ and} the subordinate verb-of-effect \textit{bɔkú} ‘be much’. The subordinate status of the effect situation is evident through its appearance in a subjunctive clause introduced by the modal complementiser and subjunctive marker \textit{mék} ‘\textsc{sbjv}’:
...
\ea%1322
    \label{ex:key:1322}
    \gll A    go  \textstylePichiexamplebold{mék}=an      \textstylePichiexamplebold{gó}  tumɔ́ro.\\
\textsc{1sg.sbj}  \textsc{pot}  make=\textsc{3sg.obj}    go  tomorrow\\

\glt ‘I’ll make him go tomorrow.’ [to05fn 030]
\z

Both transitive and intransitive verbs may be causativised. Example \REF{ex:key:1323} features a causative construction with the intransitive verb of effect bɛ́lch ‘belch’ and \REF{ex:key:1324} one with the transitive verb wích ‘bewitch’. Like all complement clauses, the subjunctive clause in these constructions can optionally be introduced by the quotative marker sé ‘quot’ in addition to mék ‘sbjv’ \REF{ex:key:1324}:


\ea%1323
    \label{ex:key:1323}
    \gll A    níd    fɔ  drink  sɔn    tín    wé  de  \textstylePichiexamplebold{mék}
mék    a    bɛ́lch\\
...
\ea%1324
    \label{ex:key:1324}
    \gll Na  ín    mék    \textstylePichiexamplebold{sé}    \textstylePichiexamplebold{mék}    dɛn  wích=an.\\
...
\ea%1325
    \label{ex:key:1325}
    \gll A    \textstylePichiexamplebold{drɔ́ngor}=an,    a    \textstylePichiexamplebold{mék}    mék    e    \textstylePichiexamplebold{drɔ́ngo}.\\
...
The following example illustrates the causative use of the ditransitive transfer \textit{gí} ‘give’ in a double-object construction\is{double-object constructions}: 
...
\ea%1327
    \label{ex:key:1327}
    \gll Pút  di  watá  pero  \textstylePichiexamplebold{nó}  \textstylePichiexamplebold{mék}    mék    e    \textstylePichiexamplebold{fɔdɔ́n}  nado.\\
...
\ea%1330
    \label{ex:key:1330}
    \gll Wétin  \textstylePichiexamplebold{mék}    yu  nó  \textstylePichiexamplebold{de}  wók    tidé?\\
...
\ea%1331
    \label{ex:key:1331}
    \gll \'{U}s=sáy  yu  \textstylePichiexamplebold{wánt}  \textstylePichiexamplebold{mék}    di  smók  kɔmɔ́t?\\
...
The verb lɛ́f ‘leave; remain’ is also employed in the formation of resultative causatives[FFF9?]. Resultative causative constructions serve to causativise stative situations denoted by property items, as well as stative situatons denoted by the identity copulas na/nóto and bí and their complements in equative clauses[FFF9?]. Resultative causative constructions do not feature a subordinate clause. Instead, the effect situation is expressed as a resultative complement to the causative verb lɛ́f (cf. \sectref{sec:11.3} for resultative adjuncts in secondary predicate constructions).


Sentence \REF{ex:key:1334} features the property item yún ‘be young’. The resultative causative equivalent in \REF{ex:key:1335} features the causer e ‘3sg.sbj’ = ‘it’ (i.e. ‘the clothing’), the causee yú ‘2sg.indp’, which is an object to lɛ́f ‘leave’, as well as the resultative complement yún ‘young’. The verb lɛ́f in these constructions may either be used as an inchoative-stative verb, as in \REF{ex:key:1335}, or a dynamic verb, as in \REF{ex:key:1339} below, where lɛ́f is specified by de ‘ipfv’: 



\ea%1334
    \label{ex:key:1334}
    \gll Dís  húman  \textstylePichiexamplebold{yún}      yét.\\
...
Example \REF{ex:key:1336} presents a non-causative predication involving the inchoative-stative property item kɔrɛ́t ‘be correct’. The resultative causative counterpart in \REF{ex:key:1337} features the force[FFF9?] causer[FFF9?] gɔ́d ‘God’, the causative verb lɛ́f ‘leave’, and the resultative complement kɔrɛ́t ‘(be) correct’:
...
Sentence \REF{ex:key:1338} is an equative clause[FFF9?] featuring the identity copula/focus marker na ‘foc. The causative equivalent in \REF{ex:key:1339} once more features the resultative causative verb lɛ́f, as well as the compound noun and resultative complement yun-bɔ́y ‘young.cpd-boy’:
...
The verb pút ‘put’ is also used as a causative verb in a few instances in the corpus. In \REF{ex:key:1340} below, pút is employed like lɛ́f in \REF{ex:key:1335} and \REF{ex:key:1339} above in order to express the resultative causative equivalent of a non-causative equative clause[FFF9?]. The sentence contains the non-causative equative clause yu húman na bíg húman ‘your wife is an important woman’ and the causative equivalent pút yu sɛ́f bíg mán ‘make yourself an important man’:[FFF9?]



\ea%1340
    \label{ex:key:1340}
    \gll Ɛf  yu  húman  \textstylePichiexamplebold{na}  \textstylePichiexamplebold{bíg}  \textstylePichiexamplebold{húman},  e    hád    fɔ
pút     yu  sɛ́f  bíg  mán.\\
...
\ea%1342
    \label{ex:key:1342}
    \gll Esto    na  wán    ɔ́da    kɔ́ntri,  \textstylePichiexamplebold{dɛn}  go  púl    yú    inmediatamente,
\textstylePichiexamplebold{dɛn}  de  púl    yú    wók.\\
...
\ea%1343
    \label{ex:key:1343}
    \gll Di  \textstylePichiexamplebold{ród}    strét.\\
...
\ea%1344
    \label{ex:key:1344}
    \gll \textstylePichiexamplebold{Dɛn}    dɔ́n    strét    di  \textstylePichiexamplebold{ród}.\\
\textsc{3pl}    \textsc{prf}    straighten  \textsc{def}  road\\

\glt ‘The road has been straightened.’ [dj07ae 123]
\z

Impersonal \textit{dɛn} always refers to an unspecified group of animate, usually human agents. The lower the agent is on the animacy scale, and hence its capacity of volition and instigation, the less likely it is to be referred to by impersonal \textit{dɛn}. For example, \REF{ex:key:1345} sounds akward, since the backgrounded agent is construed as animate and human. A situation involving a non-human agent like \textit{snék} ‘snake’ is therefore more likely to be expressed through an ‘active’ clause with a foregrounded agent in subject position \REF{ex:key:1346}: \is{animacy}


\ea[?]{%1345
    \label{ex:key:1345}
    \gll Dɛn  bɛ́t=an    na  fám.\\
...
\ea%1347
    \label{ex:key:1347}
    \gll \textstylePichiexamplebold{Dɛn}  \textstylePichiexamplebold{pút}=an    mɔ́t    dɔ́n    fɔ  di  tébul.\\
...
\ea%1349
    \label{ex:key:1349}
    \gll \textstylePichiexamplebold{Dɛn}    go  hía    ín    bɔt  e    nó  só    dé    claro.\\
...
\ea%1350
    \label{ex:key:1350}
    \gll \textstylePichiexamplebold{Wi}  de  pús=an.\\
...
\ea%1351
    \label{ex:key:1351}
    \gll Na  lɛkɛ    \textstylePichiexamplebold{wí}    náw,  \textstylePichiexamplebold{wi}  de  tɔ́k  Panyá,  \textstylePichiexamplebold{wi}  go
...
\ea%1353
    \label{ex:key:1353}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{fɔ} tík=an      mɔ́.\\
...
\ea%1354
    \label{ex:key:1354}
    \gll \textstylePichiexamplebold{Na}  \textstylePichiexamplebold{to} inicia  ín.\\
