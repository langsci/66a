...
\ea%1695
    \label{ex:key:1695}
    \gll A    kɔmɔ́t  \textstylePichiexamplebold{\textit{colegio}}\textstylePichiexamplebold{\textmd{,}}    a    dé    \textstylePichiexamplebold{\textit{fuera}}  \textstylePichiexamplebold{\textit{con}}    \textstylePichiexamplebold{\textit{mi}}
...
\ea%1698
    \label{ex:key:1698}
    \gll \'{A}fta    una  báy  di  \textstylePichiexamplebold{\textit{bloques}}  \textstylePichiexamplebold{dɛn}  tumára.\\
...
\ea%1699
    \label{ex:key:1699}
    \gll A    \textit{ralla}    ín    wet    \textstylePichiexamplebold{\textit{rallador}}.\\
...
wi  báy  \textstylePichiexamplebold{\textit{sadín}},  wi  báy  \textstylePichiexamplebold{\textit{tomates}},    wi  \textit{desayuna}.\\
...
\ea%1702
    \label{ex:key:1702}
    \gll Na  \textstylePichiexamplebold{\textit{traducción}}  \textstylePichiexamplebold{\textit{directa}}  e    mék.\\
...
\ea%1703
    \label{ex:key:1703}
    \gll Ɛf  yu  bin  kán  bigín  \textstylePichiexamplebold{\textit{las}}  \textstylePichiexamplebold{\textit{semana}}  yu  bin  fɔ    dɔ́n  fínis    tidé.\\
...
\ea%1704
    \label{ex:key:1704}
    \gll Na  wán    \textstylePichiexamplebold{\textit{ɔnkúl}}   \textstylePichiexamplebold{\textit{directo}},  fɔ  mi    mamá  in    papá
in    fámbul  pát.\\
...
\ea%1705
    \label{ex:key:1705}
    \gll E    bríng  fís,  e    kúk    sɔn    \textstylePichiexamplebold{\textit{especial}}  \textstylePichiexamplebold{\textit{fís}}\textstylePichiexamplebold{\textmd{,}}
e    gí  mí    mék    a    chɔ́p.\\
...
\ea%1706
    \label{ex:key:1706}
    \gll Dí  wán    go  tɔ́n    \textstylePichiexamplebold{plába}  \textstylePichiexamplebold{\textit{serio}}.\\
...
\textstylePichiexamplebold{\textit{sentido}}    \textstylePichiexamplebold{\textit{fáyn}}. \\
...
The low ratio of Spanish verbs as opposed to nouns in the type and token count may be striking at first glance. However, this tendency may stem from the fact that a small number of high frequency Pichi verbs (e.g. mék ‘make’, gɛ́t ‘get, have’, gí ‘give’) participate in conventionalised verb-noun collocations, [FFF9?] in which a Pichi verb is followed by a Spanish noun (cf. \sectref{sec:9.3.1} for an extensive treatment). Some of these are gí permiso ‘give permission’, mék rabia ‘be annoyed’, gɛ́t novio/novia ‘have a boy/girlfriend’. The collocations also include calques from Spanish. Compare gí wán vuelta ‘give one round’ = ‘take a walk’ which is a one-to-one calque of Spanish dar una vuelta:


\ea%1708
    \label{ex:key:1708}
    \gll E    de  \textstylePichiexamplebold{gí}  \textstylePichiexamplebold{wán}    \textstylePichiexamplebold{\textit{vuelta}}  kwík.\\
\textsc{3sg.sbj}  \textsc{ipfv}  give  one    round  quickly\\

\glt ‘She’s taking a walk quickly.’ [dj05be 120]
\z

The admixture of Spanish verbs follows established rules. Spanish verbs are always inserted into Pichi clauses in a invariant form of the \textsc{3sg} person of the Spanish present tense\is{present tense} paradigm. This insertion rule is valid without exception across the three regular Spanish verb inflection classes. Due to its frequency, the \textsc{3sg} present tense form is also the default form found in most contact scenarios involving Spanish (\citealt{Clements2009}:20–21). Examples follow with \textit{controla} ‘control’ (<\textit{controlar}) in \REF{ex:key:1709}, \textit{entiende} ‘understand’ (<\textit{entender}) in \REF{ex:key:1710}, and \textit{sufre} ‘suffer’ (<\textit{sufrir}) in \REF{ex:key:1711}:


\ea%1709
    \label{ex:key:1709}
    \gll Frɔn    na  yá    só    dɛn  \textstylePichiexamplebold{kin}  \textstylePichiexamplebold{\textit{controla}}  di  húman.\\
...
\ea%1710
    \label{ex:key:1710}
    \gll Pɔ́sin  \textstylePichiexamplebold{go}  \textstylePichiexamplebold{\textit{entiende}}    bɔt  e    nó  dé    \textit{bien}.\\
...
\ea%1712
    \label{ex:key:1712}
    \gll \MakeUppercase{A}   bigín  de  \textstylePichiexamplebold{\textit{pica}}\textit{{}-}\textstylePichiexamplebold{\textit{píca}},    wi  fráy  \textit{patata},  wi  fráy  plantí.\\
...
\ea%1713
    \label{ex:key:1713}
    \gll Fíba    nó  \textstylePichiexamplebold{\textit{sube}}    \textstylePichiexamplebold{ín}.\\
...
\ea%1714
    \label{ex:key:1714}
    \gll \MakeUppercase{A}   go  \textstylePichiexamplebold{\textit{sigue}}    \textstylePichiexamplebold{chɔ́p}.\\
...
wí    e    \textstylePichiexamplebold{\textit{baja}}    mɔ́.\\
...
\ea%1716
    \label{ex:key:1716}
    \gll Wán    yáy  \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{\textit{blanco}}  e    nó  de  sí.\\
...
\ea%1717
    \label{ex:key:1717}
    \gll \MakeUppercase{A}   wánt  dé    \textstylePichiexamplebold{\textit{flipa}}\textit{{}-}\textstylePichiexamplebold{\textit{do}}      ɔ́l  áwa,    ɔ́l  áwa.\\
...
\ea%1718
    \label{ex:key:1718}
    \gll Sɔn    mamá  dɛn,    dɛn  \textstylePichiexamplebold{bád.}\\
...
\ea%1719
    \label{ex:key:1719}
    \gll ‘E    \textstylePichiexamplebold{dé}    \textstylePichiexamplebold{bad}’    min    sé    ‘e    de  sík’.\\
\textsc{3sg.sbj}  \textsc{be.loc}  bad    mean  \textsc{quot}    \textsc{3sg.sbj}  \textsc{ipfv}  be.sick\\

\glt ‘“E dé bad” means “he’s sick”.’ [ye07je 046]
\z

Spanish also exhibits a distinction based on time-stability with respect to property items. In contrast to Pichi, the distinction may, however, be applied to almost any adjective of the language. Examples \REF{ex:key:1720} and \REF{ex:key:1721} involve the \textsc{3sg} present form of the time-stable identity copula \textit{ser} and the \textsc{2sg} present of the non-time-stable locative-existential copula \textit{estar,} respectively. A comparison of the Pichi examples in \REF{ex:key:1718}–\REF{ex:key:1719} above with the two sentences below show the functional overlap of the relevant constructions in the two languages: 
...
\ea%1722
    \label{ex:key:1722}
    \gll Di  mán    \textstylePichiexamplebold{wáyt}.\\
\textsc{def}  man    be.white\\

\glt ‘The man is white.’ [ed05fn 077]
\z

Why is the time-stability distinction not maintained with predicatively used Spanish adjectives? An explanation is that the Pichi construction involving the copula \textit{dé} and an adjectival complement is more compatible with congruent lexicalisation than the use of Spanish adjectives as (inchoative-)stative verbs. With the former pattern, the phrasal syntax of adjectival predication remains identical in both languages. This allows speakers to graft such code-mixed constructions onto a common grammatical structure (cf. \citealt{MeechanPoplack1995}). Pichi–Spanish contact in the predicate adjective construction has therefore led to the generalisation of a structure which would otherwise be specialised to a handful of Pichi property items. The obligatory use of a copula in these mixed collocations may also be seen as a case of structural interference from Spanish where a copula verb \textit{must} be used in predicate adjective constructions.\is{adjectives} 
...
pút=an    na  pɔ́t  \textstylePichiexamplebold{\textit{aunque}}  wán    \textit{taza}  só.\\
...
\ea%1729
    \label{ex:key:1729}
    \gll \textstylePichiexamplebold{\textit{Mientras}}    yu  de  sí  sé  di  tín    de  \textit{transforma}  pɔ́sin
...
\ea%1730
    \label{ex:key:1730}
    \gll E    nó  sabí    tɔ́k  \textstylePichiexamplebold{\textit{ni}}    Panyá,  e    sé
...
\ea%1731
    \label{ex:key:1731}
    \gll \textstylePichiexamplebold{\textit{Ni}}    ín    \textstylePichiexamplebold{\textit{ni}}    in    brɔ́da  dɛn  \textstylePichiexamplebold{nó}  lán.\\
...
\ea%1734
    \label{ex:key:1734}
\langinfo{Spanish}{}{}\\
    \gll Me  faltan    \textstylePichiexamplebold{unos}  dos  mil      francos.\\
...
\ea%1736
    \label{ex:key:1736}
    \gll \textstylePichiexamplebold{\textit{Pero}  }  \textstylePichiexamplebold{\textit{chico}},  na  yu  pikín  in    láyf.\\
...
\ea%1737
    \label{ex:key:1737}
    \gll \textstylePichiexamplebold{\textit{Mierda}}  \textstylePichiexamplebold{\textit{mierda}},  ús=sáy  e    pás?\\
...
\ea%1743
    \label{ex:key:1743}
    \gll Son      \textstylePichiexamplebold{\textit{las}}    \textstylePichiexamplebold{\textit{cuatro}}  \textstylePichiexamplebold{\textit{y}}  \textstylePichiexamplebold{\textit{media.}}\\
...
\ea%1745
    \label{ex:key:1745}
    \gll \textit{Soy}    \textit{del}    \textit{veinticuatro},  a    bɔ́n    \textstylePichiexamplebold{nayntín}  \textstylePichiexamplebold{twɛnti}{}-\textstylePichiexamplebold{fó}.\\
...
Most speakers are not familiar with Pichi day names and employ the Spanish day nomenclature \REF{ex:key:1746}. Even older speakers rarely if ever use the corresponding Pichi day names mɔ́nde ‘Monday’, tyúsde ‘Tuesday’, wɛ́nsde ‘Wednesday’, tɔsde ‘Thursday’, frayde ‘Friday’, sátidé ‘Saturday’, and sɔ́nde ‘Sunday’ \REF{ex:key:1747}:


\ea%1746
    \label{ex:key:1746}
    \gll Dí  \textstylePichiexamplebold{\textit{miércoles}}  a    de  gó  Lubá.\\
...
\textit{Jueves}    na  \textstylePichiexamplebold{tyúsde}.\\
Thursday  \textsc{foc}  Tuesday\\
\glt   ‘Thursday is “tyúsde”.’ [ro05ee 125]
}\ex{\gll
\textstylePichiexamplebold{Frayde} na miércoles.\\
  friday  \textsc{foc}  wednesday\\
\glt   “Frayde” is Wednesday.’ [ro05ee 126]
}\z\z
...
\ea%1749
    \label{ex:key:1749}
    \gll Dís  dé  dɛn  \textstylePichiexamplebold{ren}{}-\textstylePichiexamplebold{sísin}    go  bigín.\\
...
\label{ex:key:1750}
\gll
  Wi  de  kɔ́l  yá    só    \textstylePichiexamplebold{amatán}    dán,    \textstylePichiexamplenumberZchnZchn{lɛkɛ  sé}
\textstylePichiexamplenumberZchnZchn{e} kin  dé    lɛkɛ  \textit{niebla}.\\
...
\end{tabularx}
\end{table}
Many West African languages, including basilectal Nigerian Pidgin \citep[286]{Faraclas1996} express colours and hues other than ‘black’ and ‘white’ through periphrasis, suprasegmentals and ideophones\is{ideophones}. We also find the expression of colours through periphrasis in Pichi, as in the following two examples: 
...
\ea%1753
    \label{ex:key:1753}
    \gll A    tínk    sé    na  \textstylePichiexamplebold{judías}  \textstylePichiexamplebold{blancas}  \textbf{o}  \textbf{no}  \textbf{sé}.\\
...
\ea%1754
    \label{ex:key:1754}
    \gll \textit{Entonces}    wán    \textstylePichiexamplebold{\textit{problema}}  \textstylePichiexamplebold{\textit{diplomático}}  kán  dé    entre
\textstylePichiexamplebold{\textit{Guinea}}  wet    \textstylePichiexamplebold{\textit{Gabón}}.\\
...
a    \textstylePichiexamplebold{\textit{registra}}  ín.\\
...
The Pichi lexemes \textit{skul} ‘school’\textit{, gɔ́bna} ‘government’ \REF{ex:key:1757}, and \textit{chɔ́ch} ‘church’ \REF{ex:key:1758} designate these institutions in their general sense and are favoured over their Spanish equivalents \textit{escuela, gobierno}\textit{,}\textit{} and\textit{ iglesia:}


\ea%1757
    \label{ex:key:1757}
    \gll E    de  gó  fɔ,  sɔn    \textstylePichiexamplebold{skúl}    wé  dé    fɔ  \textstylePichiexamplebold{gɔ́bna}.\\
...
\ea%1758
    \label{ex:key:1758}
    \gll E    sé  e    gó  \textstylePichiexamplebold{chɔ́ch}  fɔ,  fɔ  Marieta  na  {Ela Nguema},
na  \textstylePichiexamplebold{catedral}.\\
...
\ea%1759
    \label{ex:key:1759}
    \gll Wé,  yu  wánt  báy  \textstylePichiexamplebold{\textit{cuaderno}},    \textstylePichiexamplebold{\textit{bolí}}  ɔ́l  dán  tín    dɛn
na  wet    \textit{dólar}.\\
...
bifó    di  \textstylePichiexamplebold{\textit{matriz}},  so  di  \textstylePichiexamplebold{\textit{matriz}}  nó  kán  lɔ́k.\\
...
wé  na  fɔ  Opel,  yu  \textstylePichiexamplebold{\textit{intenta}}  bríng  Opel    in    yón   na
...
\ea%1763
    \label{ex:key:1763}
    \gll A    tínk    sé    dɛn  papá  na  mi    mamá  in    \textstylePichiexamplebold{\textit{primo}}.\\
...
(and) you would harvest egg-plants.’ [ab03ay 015]\is{code-mixing}
\z
